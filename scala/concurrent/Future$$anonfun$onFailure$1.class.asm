...
// declaration: scala/concurrent/Future$$anonfun$onFailure$1 extends scala.runtime.AbstractFunction1<scala.util.Try<T>, java.lang.Object> implements scala.Serializable
public final class scala/concurrent/Future$$anonfun$onFailure$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/concurrent/Future onFailure (Lscala/PartialFunction;Lscala/concurrent/ExecutionContext;)V
  // access flags 0x409
  ...
  // access flags 0x12
  private final Lscala/PartialFunction; pf$2
  ...
  public <init>(Lscala/concurrent/Future;Lscala/PartialFunction;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/concurrent/Future$$anonfun$onFailure$1.pf$2 : Lscala/PartialFunction;
    ALOAD 0
  ...
  public final apply(Lscala/util/Try;)Ljava/lang/Object;
    ...
    ASTORE 2
    ALOAD 0
    GETFIELD scala/concurrent/Future$$anonfun$onFailure$1.pf$2 : Lscala/PartialFunction;
    ALOAD 2
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/concurrent/Future$$anonfun$onFailure$1.apply (Lscala/util/Try;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
