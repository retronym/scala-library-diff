...
// declaration: scala/concurrent/Future$$anonfun$zip$1 extends scala.runtime.AbstractFunction1<scala.util.Try<T>, java.lang.Object> implements scala.Serializable
public final class scala/concurrent/Future$$anonfun$zip$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/concurrent/Future zip (Lscala/concurrent/Future;)Lscala/concurrent/Future;
  // access flags 0x11
  ...
  // access flags 0x12
  private final Lscala/concurrent/Future$InternalCallbackExecutor$; ec$1
  ...
  public <init>(Lscala/concurrent/Future;Lscala/concurrent/Future$InternalCallbackExecutor$;Lscala/concurrent/Promise;Lscala/concurrent/Future;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/concurrent/Future$$anonfun$zip$1.ec$1 : Lscala/concurrent/Future$InternalCallbackExecutor$;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/concurrent/Future$$anonfun$zip$1.p$7 : Lscala/concurrent/Promise;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/concurrent/Future$$anonfun$zip$1.that$1 : Lscala/concurrent/Future;
    ALOAD 0
  ...
  public final apply(Lscala/util/Try;)Ljava/lang/Object;
   ...
   L0
    ...
    ASTORE 3
    ALOAD 0
    GETFIELD scala/concurrent/Future$$anonfun$zip$1.that$1 : Lscala/concurrent/Future;
    NEW scala/concurrent/Future$$anonfun$zip$1$$anonfun$apply$7
    DUP
    ALOAD 0
    ALOAD 3
    INVOKESPECIAL scala/concurrent/Future$$anonfun$zip$1$$anonfun$apply$7.<init> (Lscala/concurrent/Future$$anonfun$zip$1;Lscala/util/Success;)V
    ALOAD 0
    GETFIELD scala/concurrent/Future$$anonfun$zip$1.ec$1 : Lscala/concurrent/Future$InternalCallbackExecutor$;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/concurrent/Future$$anonfun$zip$1.apply (Lscala/util/Try;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
