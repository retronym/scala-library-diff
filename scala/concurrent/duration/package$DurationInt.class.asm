...
// access flags 0x31
public final class scala/concurrent/duration/package$DurationInt implements scala/concurrent/duration/DurationConversions  {
  ...
  // access flags 0x12
  private final I scala$concurrent$duration$DurationInt$$n

  // access flags 0x1
  public <init>(I)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/concurrent/duration/package$DurationInt.scala$concurrent$duration$DurationInt$$n : I
    ALOAD 0
  ...
  public durationIn(Ljava/util/concurrent/TimeUnit;)Lscala/concurrent/duration/FiniteDuration;
    GETSTATIC scala/concurrent/duration/package$DurationInt$.MODULE$ : Lscala/concurrent/duration/package$DurationInt$;
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt.scala$concurrent$duration$DurationInt$$n ()I
    ALOAD 1
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt$.durationIn$extension (ILjava/util/concurrent/TimeUnit;)Lscala/concurrent/duration/FiniteDuration;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  public equals(Ljava/lang/Object;)Z
    ...
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt.scala$concurrent$duration$DurationInt$$n ()I
    ALOAD 1
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt$.equals$extension (ILjava/lang/Object;)Z
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  public hashCode()I
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt.scala$concurrent$duration$DurationInt$$n ()I
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationInt$.hashCode$extension (I)I
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  // access flags 0x1
  public scala$concurrent$duration$DurationInt$$n()I
    ALOAD 0
    GETFIELD scala/concurrent/duration/package$DurationInt.scala$concurrent$duration$DurationInt$$n : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
