...
// access flags 0x21
// signature Ljava/lang/Object;Lscala/math/Ordering<Lscala/concurrent/duration/Deadline;>;
// declaration: scala/concurrent/duration/Deadline$DeadlineIsOrdered$ implements scala.math.Ordering<scala.concurrent.duration.Deadline>
public class scala/concurrent/duration/Deadline$DeadlineIsOrdered$ implements scala/math/Ordering  {
  ...
  // access flags 0x19
  public final static Lscala/concurrent/duration/Deadline$DeadlineIsOrdered$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/concurrent/duration/Deadline$DeadlineIsOrdered$
    INVOKESPECIAL scala/concurrent/duration/Deadline$DeadlineIsOrdered$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/concurrent/duration/Deadline$DeadlineIsOrdered$.MODULE$ : Lscala/concurrent/duration/Deadline$DeadlineIsOrdered$;
    ALOAD 0
  ...
  // access flags 0x1
  public compare(Lscala/concurrent/duration/Deadline;Lscala/concurrent/duration/Deadline;)I
    ALOAD 1
    ALOAD 2
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    CHECKCAST scala/concurrent/duration/Deadline
    INVOKEVIRTUAL scala/concurrent/duration/Deadline$DeadlineIsOrdered$.compare (Lscala/concurrent/duration/Deadline;Lscala/concurrent/duration/Deadline;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TU;Lscala/concurrent/duration/Deadline;>;)Lscala/math/Ordering<TU;>;
  // declaration: scala.math.Ordering<U> on<U>(scala.Function1<U, scala.concurrent.duration.Deadline>)
  ...
  private readResolve()Ljava/lang/Object;
    GETSTATIC scala/concurrent/duration/Deadline$DeadlineIsOrdered$.MODULE$ : Lscala/concurrent/duration/Deadline$DeadlineIsOrdered$;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/math/Ordering<Lscala/concurrent/duration/Deadline;>;
  // declaration: scala.math.Ordering<scala.concurrent.duration.Deadline> reverse()
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/Deadline$DeadlineIsOrdered$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/concurrent/duration/Deadline$DeadlineIsOrdered$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
