...
// access flags 0x31
public final class scala/concurrent/duration/package$DurationLong implements scala/concurrent/duration/DurationConversions  {
  ...
  // access flags 0x12
  private final J scala$concurrent$duration$DurationLong$$n

  // access flags 0x1
  public <init>(J)V
    ALOAD 0
    LLOAD 1
    PUTFIELD scala/concurrent/duration/package$DurationLong.scala$concurrent$duration$DurationLong$$n : J
    ALOAD 0
  ...
  public durationIn(Ljava/util/concurrent/TimeUnit;)Lscala/concurrent/duration/FiniteDuration;
    GETSTATIC scala/concurrent/duration/package$DurationLong$.MODULE$ : Lscala/concurrent/duration/package$DurationLong$;
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong.scala$concurrent$duration$DurationLong$$n ()J
    ALOAD 1
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong$.durationIn$extension (JLjava/util/concurrent/TimeUnit;)Lscala/concurrent/duration/FiniteDuration;
    ARETURN
    MAXSTACK = 4
    MAXLOCALS = 2
  ...
  public equals(Ljava/lang/Object;)Z
    ...
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong.scala$concurrent$duration$DurationLong$$n ()J
    ALOAD 1
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong$.equals$extension (JLjava/lang/Object;)Z
    IRETURN
    MAXSTACK = 4
    MAXLOCALS = 2
  ...
  public hashCode()I
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong.scala$concurrent$duration$DurationLong$$n ()J
    INVOKEVIRTUAL scala/concurrent/duration/package$DurationLong$.hashCode$extension (J)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 1
  ...
  // access flags 0x1
  public scala$concurrent$duration$DurationLong$$n()J
    ALOAD 0
    GETFIELD scala/concurrent/duration/package$DurationLong.scala$concurrent$duration$DurationLong$$n : J
    LRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
