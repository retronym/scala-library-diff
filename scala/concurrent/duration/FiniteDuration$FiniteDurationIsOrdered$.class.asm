...
// access flags 0x21
// signature Ljava/lang/Object;Lscala/math/Ordering<Lscala/concurrent/duration/FiniteDuration;>;
// declaration: scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$ implements scala.math.Ordering<scala.concurrent.duration.FiniteDuration>
public class scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$ implements scala/math/Ordering  {
  ...
  // access flags 0x19
  public final static Lscala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$
    INVOKESPECIAL scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.MODULE$ : Lscala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$;
    ALOAD 0
  ...
  // access flags 0x1
  public compare(Lscala/concurrent/duration/FiniteDuration;Lscala/concurrent/duration/FiniteDuration;)I
    ALOAD 1
    ALOAD 2
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    CHECKCAST scala/concurrent/duration/FiniteDuration
    INVOKEVIRTUAL scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.compare (Lscala/concurrent/duration/FiniteDuration;Lscala/concurrent/duration/FiniteDuration;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TU;Lscala/concurrent/duration/FiniteDuration;>;)Lscala/math/Ordering<TU;>;
  // declaration: scala.math.Ordering<U> on<U>(scala.Function1<U, scala.concurrent.duration.FiniteDuration>)
  ...
  private readResolve()Ljava/lang/Object;
    GETSTATIC scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.MODULE$ : Lscala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/math/Ordering<Lscala/concurrent/duration/FiniteDuration;>;
  // declaration: scala.math.Ordering<scala.concurrent.duration.FiniteDuration> reverse()
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/concurrent/duration/FiniteDuration$FiniteDurationIsOrdered$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
