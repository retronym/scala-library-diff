...
// declaration: scala/Predef$$eq$colon$eq<From, To> implements scala.Function1<From, To>, scala.Serializable
public abstract class scala/Predef$$eq$colon$eq implements scala/Function1 scala/Serializable  {
