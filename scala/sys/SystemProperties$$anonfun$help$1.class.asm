...
// declaration: scala/sys/SystemProperties$$anonfun$help$1 extends scala.runtime.AbstractFunction0<java.lang.String> implements scala.Serializable
public final class scala/sys/SystemProperties$$anonfun$help$1 extends scala/runtime/AbstractFunction0  implements scala/Serializable  {
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/sys/SystemProperties$$anonfun$help$1.apply ()Ljava/lang/String;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
