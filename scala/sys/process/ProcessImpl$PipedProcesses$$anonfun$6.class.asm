...
// declaration: scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$6 extends scala.runtime.AbstractFunction0<java.lang.String> implements scala.Serializable
public final class scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$6 extends scala/runtime/AbstractFunction0  implements scala/Serializable  {
  ...
  public <init>(Lscala/sys/process/ProcessImpl$PipedProcesses;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$6.$outer : Lscala/sys/process/ProcessImpl$PipedProcesses;
    ALOAD 0
  ...
  public final apply()Ljava/lang/String;
    ALOAD 0
    GETFIELD scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$6.$outer : Lscala/sys/process/ProcessImpl$PipedProcesses;
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/sys/process/ProcessImpl$PipedProcesses$$anonfun$6.apply ()Ljava/lang/String;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
