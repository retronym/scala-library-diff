...
// declaration: scala/sys/process/BasicIO$$anonfun$toStdErr$1 extends scala.runtime.AbstractFunction1<java.io.InputStream, scala.runtime.BoxedUnit> implements scala.Serializable
public final class scala/sys/process/BasicIO$$anonfun$toStdErr$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/sys/process/BasicIO$$anonfun$toStdErr$1.apply (Ljava/io/InputStream;)V
