...
public class scala/sys/process/ProcessBuilderImpl$SequenceBuilder extends scala/sys/process/ProcessBuilderImpl$SequentialBuilder  {
  ...
  public <init>(Lscala/sys/process/ProcessBuilder$;Lscala/sys/process/ProcessBuilder;Lscala/sys/process/ProcessBuilder;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/sys/process/ProcessBuilderImpl$SequenceBuilder.first : Lscala/sys/process/ProcessBuilder;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/sys/process/ProcessBuilderImpl$SequenceBuilder.second : Lscala/sys/process/ProcessBuilder;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    ALOAD 3
  ...
  // access flags 0x1
  public createProcess(Lscala/sys/process/ProcessIO;)Lscala/sys/process/ProcessImpl$ProcessSequence;
    NEW scala/sys/process/ProcessImpl$ProcessSequence
    DUP
    GETSTATIC scala/sys/process/Process$.MODULE$ : Lscala/sys/process/Process$;
    ALOAD 0
    GETFIELD scala/sys/process/ProcessBuilderImpl$SequenceBuilder.first : Lscala/sys/process/ProcessBuilder;
    ALOAD 0
    GETFIELD scala/sys/process/ProcessBuilderImpl$SequenceBuilder.second : Lscala/sys/process/ProcessBuilder;
    ALOAD 1
    INVOKESPECIAL scala/sys/process/ProcessImpl$ProcessSequence.<init> (Lscala/sys/process/Process$;Lscala/sys/process/ProcessBuilder;Lscala/sys/process/ProcessBuilder;Lscala/sys/process/ProcessIO;)V
    ARETURN
    MAXSTACK = 6
    MAXLOCALS = 2
  ...
  public synthetic bridge createProcess(Lscala/sys/process/ProcessIO;)Lscala/sys/process/ProcessImpl$BasicProcess;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/sys/process/ProcessBuilderImpl$SequenceBuilder.createProcess (Lscala/sys/process/ProcessIO;)Lscala/sys/process/ProcessImpl$ProcessSequence;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1001
  public synthetic scala$sys$process$ProcessBuilderImpl$SequenceBuilder$$$outer()Lscala/sys/process/ProcessBuilder$;
    ALOAD 0
    GETFIELD scala/sys/process/ProcessBuilderImpl$SequenceBuilder.$outer : Lscala/sys/process/ProcessBuilder$;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
