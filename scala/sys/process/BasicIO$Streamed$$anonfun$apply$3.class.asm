...
// declaration: scala/sys/process/BasicIO$Streamed$$anonfun$apply$3 extends scala.runtime.AbstractFunction0<scala.collection.immutable.Stream<T>> implements scala.Serializable
public final class scala/sys/process/BasicIO$Streamed$$anonfun$apply$3 extends scala/runtime/AbstractFunction0  implements scala/Serializable  {
  ...
  public <init>(ZLjava/util/concurrent/LinkedBlockingQueue;)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/sys/process/BasicIO$Streamed$$anonfun$apply$3.nonzeroException$1 : Z
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/sys/process/BasicIO$Streamed$$anonfun$apply$3.q$1 : Ljava/util/concurrent/LinkedBlockingQueue;
    ALOAD 0
  ...
  public final apply()Lscala/collection/immutable/Stream;
    ...
    ALOAD 0
    GETFIELD scala/sys/process/BasicIO$Streamed$$anonfun$apply$3.nonzeroException$1 : Z
    ALOAD 0
    GETFIELD scala/sys/process/BasicIO$Streamed$$anonfun$apply$3.q$1 : Ljava/util/concurrent/LinkedBlockingQueue;
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/sys/process/BasicIO$Streamed$$anonfun$apply$3.apply ()Lscala/collection/immutable/Stream;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
