...
public final class scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2 extends scala/runtime/AbstractFunction0$mcV$sp  implements scala/Serializable  {
  ...
  public <init>(Lscala/sys/process/ProcessBuilderImpl$Simple;Lscala/sys/process/ProcessIO;Ljava/lang/Process;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2.io$2 : Lscala/sys/process/ProcessIO;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2.process$1 : Ljava/lang/Process;
    ALOAD 0
  ...
  public final apply()V
    ALOAD 0
    GETFIELD scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2.io$2 : Lscala/sys/process/ProcessIO;
    INVOKEVIRTUAL scala/sys/process/ProcessIO.writeInput ()Lscala/Function1;
    ALOAD 0
    GETFIELD scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2.process$1 : Ljava/lang/Process;
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/sys/process/ProcessBuilderImpl$Simple$$anonfun$2.apply ()V
