...
// declaration: scala/Tuple2$mcIZ$sp extends scala.Tuple2<java.lang.Object, java.lang.Object>
public class scala/Tuple2$mcIZ$sp extends scala/Tuple2  {
  ...
  public <init>(IZ)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/Tuple2$mcIZ$sp._1$mcI$sp : I
    ALOAD 0
    ILOAD 2
    PUTFIELD scala/Tuple2$mcIZ$sp._2$mcZ$sp : Z
    ALOAD 0
    ACONST_NULL
    ACONST_NULL
  ...
  public _1()I
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp._1$mcI$sp ()I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge _1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp._1 ()I
  ...
  public _1$mcI$sp()I
    ALOAD 0
    GETFIELD scala/Tuple2$mcIZ$sp._1$mcI$sp : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public _2()Z
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp._2$mcZ$sp ()Z
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge _2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp._2 ()Z
  ...
  public _2$mcZ$sp()Z
    ALOAD 0
    GETFIELD scala/Tuple2$mcIZ$sp._2$mcZ$sp : Z
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public copy$default$1()I
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp.copy$default$1$mcI$sp ()I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp.copy$default$1 ()I
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToInteger (I)Ljava/lang/Integer;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public copy$default$2()Z
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp.copy$default$2$mcZ$sp ()Z
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp.copy$default$2 ()Z
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToBoolean (Z)Ljava/lang/Boolean;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public swap()Lscala/Tuple2;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcIZ$sp.swap$mcIZ$sp ()Lscala/Tuple2;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
