...
// declaration: scala/Tuple2$mcCC$sp extends scala.Tuple2<java.lang.Object, java.lang.Object>
public class scala/Tuple2$mcCC$sp extends scala/Tuple2  {
  ...
  public <init>(CC)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/Tuple2$mcCC$sp._1$mcC$sp : C
    ALOAD 0
    ILOAD 2
    PUTFIELD scala/Tuple2$mcCC$sp._2$mcC$sp : C
    ALOAD 0
    ACONST_NULL
    ACONST_NULL
  ...
  public _1()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp._1$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge _1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp._1 ()C
  ...
  public _1$mcC$sp()C
    ALOAD 0
    GETFIELD scala/Tuple2$mcCC$sp._1$mcC$sp : C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public _2()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp._2$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge _2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp._2 ()C
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToCharacter (C)Ljava/lang/Character;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public _2$mcC$sp()C
    ALOAD 0
    GETFIELD scala/Tuple2$mcCC$sp._2$mcC$sp : C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public copy$default$1()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp.copy$default$1$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp.copy$default$1 ()C
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToCharacter (C)Ljava/lang/Character;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public copy$default$2()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp.copy$default$2$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp.copy$default$2 ()C
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToCharacter (C)Ljava/lang/Character;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public swap()Lscala/Tuple2;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCC$sp.swap$mcCC$sp ()Lscala/Tuple2;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
