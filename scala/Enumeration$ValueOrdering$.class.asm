...
// access flags 0x21
// signature Ljava/lang/Object;Lscala/math/Ordering<Lscala/Enumeration$Value;>;
// declaration: scala/Enumeration$ValueOrdering$ implements scala.math.Ordering<scala.Enumeration$Value>
public class scala/Enumeration$ValueOrdering$ implements scala/math/Ordering  {
  ...
  public <init>(Lscala/Enumeration;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/Enumeration$ValueOrdering$.$outer : Lscala/Enumeration;
    ALOAD 0
  ...
  // access flags 0x1
  public compare(Lscala/Enumeration$Value;Lscala/Enumeration$Value;)I
    ALOAD 1
    ALOAD 2
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    CHECKCAST scala/Enumeration$Value
    INVOKEVIRTUAL scala/Enumeration$ValueOrdering$.compare (Lscala/Enumeration$Value;Lscala/Enumeration$Value;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TU;Lscala/Enumeration$Value;>;)Lscala/math/Ordering<TU;>;
  // declaration: scala.math.Ordering<U> on<U>(scala.Function1<U, scala.Enumeration$Value>)
  ...
  private readResolve()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/Enumeration$ValueOrdering$.$outer : Lscala/Enumeration;
  ...
  // declaration: scala.math.Ordering<scala.Enumeration$Value> reverse()
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/Enumeration$ValueOrdering$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/Enumeration$ValueOrdering$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
