...
// declaration: scala/io/BufferedSource$BufferedLineIterator extends scala.collection.AbstractIterator<java.lang.String> implements scala.collection.Iterator<java.lang.String>
