...
// declaration: scala/collection/TraversableViewLike$DroppedWhile extends scala.collection.TraversableViewLike<A, Coll, This>.Transformed<A>
public abstract interface scala/collection/TraversableViewLike$DroppedWhile implements scala/collection/TraversableViewLike$Transformed  {
  ...
  // access flags 0x1401
  public abstract synthetic scala$collection$TraversableViewLike$DroppedWhile$$$outer()Lscala/collection/TraversableViewLike;
