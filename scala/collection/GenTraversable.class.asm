...
public abstract interface scala/collection/GenTraversable implements scala/collection/GenTraversableLike scala/collection/generic/GenericTraversableTemplate  {
  ...
  // access flags 0x401
  // signature ()Lscala/collection/generic/GenericCompanion<Lscala/collection/GenTraversable;>;
  // declaration: scala.collection.generic.GenericCompanion<scala.collection.GenTraversable> companion()
