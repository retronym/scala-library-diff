...
// declaration: scala/collection/SeqLike$$anon$3 extends scala.collection.AbstractSeq<B> implements scala.collection.IndexedSeq<B>
public final class scala/collection/SeqLike$$anon$3 extends scala/collection/AbstractSeq  implements scala/collection/IndexedSeq  {
  ...
  public <init>(IILscala/collection/IndexedSeq;)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/collection/SeqLike$$anon$3.n0$1 : I
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/SeqLike$$anon$3.x2$1 : Lscala/collection/IndexedSeq;
    ALOAD 0
    ...
    ILOAD 1
    ISUB
    PUTFIELD scala/collection/SeqLike$$anon$3.length : I
    RETURN
    MAXSTACK = 3
    MAXLOCALS = 4
  ...
  public apply(I)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/SeqLike$$anon$3.x2$1 : Lscala/collection/IndexedSeq;
    ALOAD 0
    GETFIELD scala/collection/SeqLike$$anon$3.n0$1 : I
    ILOAD 1
    IADD
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.apply (I)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge groupBy(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.groupBy (Lscala/Function1;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge isDefinedAt(Ljava/lang/Object;)Z
    ...
    ALOAD 1
    INVOKESTATIC scala/runtime/BoxesRunTime.unboxToInt (Ljava/lang/Object;)I
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.isDefinedAt (I)Z
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public length()I
    ALOAD 0
    GETFIELD scala/collection/SeqLike$$anon$3.length : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.seq ()Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge thisCollection()Lscala/collection/Traversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.thisCollection ()Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toCollection(Ljava/lang/Object;)Lscala/collection/Traversable;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.toCollection (Ljava/lang/Object;)Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge view(II)Lscala/collection/TraversableView;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.view (II)Lscala/collection/SeqView;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge view()Lscala/collection/TraversableView;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqLike$$anon$3.view ()Lscala/collection/SeqView;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
