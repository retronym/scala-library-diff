...
// declaration: scala/collection/MapLike$$anon$1 extends scala.collection.AbstractIterator<A>
public final class scala/collection/MapLike$$anon$1 extends scala/collection/AbstractIterator  {

  OUTERCLASS scala/collection/MapLike keysIterator ()Lscala/collection/Iterator;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/MapLike;)V
    ...
    PUTFIELD scala/collection/MapLike$$anon$1.iter : Lscala/collection/Iterator;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public hasNext()Z
    ALOAD 0
    INVOKESPECIAL scala/collection/MapLike$$anon$1.iter ()Lscala/collection/Iterator;
  ...
  private iter()Lscala/collection/Iterator;
    ALOAD 0
    GETFIELD scala/collection/MapLike$$anon$1.iter : Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
