...
// access flags 0x31
public final class scala/collection/JavaConversions$ implements scala/collection/convert/WrapAsScala scala/collection/convert/WrapAsJava  {


  // access flags 0x19
  public final static Lscala/collection/JavaConversions$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/collection/JavaConversions$
    INVOKESPECIAL scala/collection/JavaConversions$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/collection/JavaConversions$.MODULE$ : Lscala/collection/JavaConversions$;
    ALOAD 0
