...
// access flags 0x31
// signature Lscala/collection/SeqViewLike<TA;TColl;TThis;>.AbstractTransformed<TA;>;Lscala/collection/SeqViewLike<TA;TColl;TThis;>.TakenWhile;
// declaration: scala/collection/SeqViewLike$$anon$8 extends scala.collection.SeqViewLike<A, Coll, This>.AbstractTransformed<A> implements scala.collection.SeqViewLike<A, Coll, This>.TakenWhile
public final class scala/collection/SeqViewLike$$anon$8 extends scala/collection/SeqViewLike$AbstractTransformed  implements scala/collection/SeqViewLike$TakenWhile  {

  OUTERCLASS scala/collection/SeqViewLike newTakenWhile (Lscala/Function1;)Lscala/collection/SeqViewLike$Transformed;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/SeqViewLike;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/SeqViewLike$$anon$8.$outer : Lscala/collection/SeqViewLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/SeqViewLike$$anon$8.pred : Lscala/Function1;
    ALOAD 0
    ALOAD 1
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/SeqViewLike$$anon$8.apply (I)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public len()I
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$8.bitmap$0 : Z
    IFEQ L0
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$8.len : I
    GOTO L1
   L0
    ALOAD 0
    INVOKESPECIAL scala/collection/SeqViewLike$$anon$8.len$lzycompute ()I
   L1
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  private len$lzycompute()I
   ...
   L0
    ...
    PUTFIELD scala/collection/SeqViewLike$$anon$8.len : I
    ALOAD 0
    ICONST_1
    PUTFIELD scala/collection/SeqViewLike$$anon$8.bitmap$0 : Z
   L3
  ...
  public pred()Lscala/Function1;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$8.pred : Lscala/Function1;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic scala$collection$IterableViewLike$TakenWhile$$$outer()Lscala/collection/IterableViewLike;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$8.$outer : Lscala/collection/SeqViewLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
