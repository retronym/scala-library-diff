...
// declaration: scala/collection/TraversableViewLike$$anonfun$unzip3$1 extends scala.runtime.AbstractFunction1<A, A1> implements scala.Serializable
public final class scala/collection/TraversableViewLike$$anonfun$unzip3$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/TraversableViewLike;Lscala/Function1;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableViewLike$$anonfun$unzip3$1.asTriple$1 : Lscala/Function1;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/TraversableViewLike$$anonfun$unzip3$1.asTriple$1 : Lscala/Function1;
    ALOAD 1
