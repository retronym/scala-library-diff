...
// access flags 0x31
// signature Ljava/lang/Object;Lscala/collection/generic/CanBuildFrom<Lscala/collection/TraversableView<*+Lscala/collection/Traversable<*>;>;TA;Lscala/collection/SeqView<TA;Lscala/collection/Seq<*>;>;>;
// declaration: scala/collection/SeqView$$anon$1 implements scala.collection.generic.CanBuildFrom<scala.collection.TraversableView<?, ? extends scala.collection.Traversable<?>>, A, scala.collection.SeqView<A, scala.collection.Seq<?>>>
public final class scala/collection/SeqView$$anon$1 implements scala/collection/generic/CanBuildFrom  {

  OUTERCLASS scala/collection/SeqView$ canBuildFrom ()Lscala/collection/generic/CanBuildFrom;
  // access flags 0x11
  public final INNERCLASS scala/collection/SeqView$$anon$1 null null
  // access flags 0x9
  ...
  public synthetic bridge apply()Lscala/collection/mutable/Builder;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/SeqView$$anon$1.apply ()Lscala/collection/TraversableView$NoBuilder;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Lscala/collection/mutable/Builder;
    ...
    INVOKEVIRTUAL scala/collection/SeqView$$anon$1.apply (Lscala/collection/TraversableView;)Lscala/collection/TraversableView$NoBuilder;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
