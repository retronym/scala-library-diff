...
// declaration: scala/collection/TraversableOnce$$anonfun$foldRight$1 extends scala.runtime.AbstractFunction2<B, A, B> implements scala.Serializable
public final class scala/collection/TraversableOnce$$anonfun$foldRight$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {

  OUTERCLASS scala/collection/TraversableOnce foldRight (Ljava/lang/Object;Lscala/Function2;)Ljava/lang/Object;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/TraversableOnce;Lscala/Function2;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableOnce$$anonfun$foldRight$1.op$2 : Lscala/Function2;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/TraversableOnce$$anonfun$foldRight$1.op$2 : Lscala/Function2;
    ALOAD 2
    ALOAD 1
