...
public final class scala/collection/TraversableLike$$anonfun$filterImpl$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  OUTERCLASS scala/collection/TraversableLike filterImpl (Lscala/Function1;Z)Ljava/lang/Object;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/TraversableLike;Lscala/collection/mutable/Builder;Lscala/Function1;Z)V
    ALOAD 0
    ALOAD 2
