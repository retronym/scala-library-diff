...
// access flags 0x31
// signature Lscala/collection/SeqViewLike<TA;TColl;TThis;>.AbstractTransformed<Lscala/Tuple2<TA1;TB;>;>;Lscala/collection/SeqViewLike<TA;TColl;TThis;>.ZippedAll<TA1;TB;>;
// declaration: scala/collection/SeqViewLike$$anon$10 extends scala.collection.SeqViewLike<A, Coll, This>.AbstractTransformed<scala.Tuple2<A1, B>> implements scala.collection.SeqViewLike<A, Coll, This>.ZippedAll<A1, B>
public final class scala/collection/SeqViewLike$$anon$10 extends scala/collection/SeqViewLike$AbstractTransformed  implements scala/collection/SeqViewLike$ZippedAll  {

  OUTERCLASS scala/collection/SeqViewLike newZippedAll (Lscala/collection/GenIterable;Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/SeqViewLike$Transformed;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/SeqViewLike;Lscala/collection/GenIterable;Ljava/lang/Object;Ljava/lang/Object;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/SeqViewLike$$anon$10.$outer : Lscala/collection/SeqViewLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/SeqViewLike$$anon$10.other : Lscala/collection/GenIterable;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/SeqViewLike$$anon$10.thisElem : Ljava/lang/Object;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/SeqViewLike$$anon$10.thatElem : Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/SeqViewLike$$anon$10.apply (I)Lscala/Tuple2;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public other()Lscala/collection/GenIterable;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.other : Lscala/collection/GenIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic scala$collection$IterableViewLike$ZippedAll$$$outer()Lscala/collection/IterableViewLike;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.$outer : Lscala/collection/SeqViewLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public thatElem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.thatElem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public thatSeq()Lscala/collection/Seq;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.bitmap$0 : Z
    IFEQ L0
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.thatSeq : Lscala/collection/Seq;
    GOTO L1
   L0
    ALOAD 0
    INVOKESPECIAL scala/collection/SeqViewLike$$anon$10.thatSeq$lzycompute ()Lscala/collection/Seq;
   L1
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  private thatSeq$lzycompute()Lscala/collection/Seq;
   ...
   L0
    ...
    PUTFIELD scala/collection/SeqViewLike$$anon$10.thatSeq : Lscala/collection/Seq;
    ALOAD 0
    ICONST_1
    PUTFIELD scala/collection/SeqViewLike$$anon$10.bitmap$0 : Z
   L3
    ALOAD 0
    MONITOREXIT
   L1
  ...
  public thisElem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/SeqViewLike$$anon$10.thisElem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
