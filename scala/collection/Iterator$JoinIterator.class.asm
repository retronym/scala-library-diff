...
// declaration: scala/collection/Iterator$JoinIterator<A> implements scala.collection.Iterator<A>
public final class scala/collection/Iterator$JoinIterator implements scala/collection/Iterator  {
  ...
  private final Lscala/collection/Iterator; lhs

  // access flags 0x2
  // signature Lscala/collection/Iterator<TA;>;
  // declaration: scala.collection.Iterator<A>
  private Lscala/collection/Iterator; rhs

  // access flags 0x12
  // signature Lscala/Function0<Lscala/collection/GenTraversableOnce<TA;>;>;
  // declaration: scala.Function0<scala.collection.GenTraversableOnce<A>>
  private final Lscala/Function0; that
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function0<Lscala/collection/GenTraversableOnce<TB;>;>;)Lscala/collection/Iterator$ConcatIterator<TB;>;
  // declaration: scala.collection.Iterator$ConcatIterator<B> $plus$plus<B>(scala.Function0<scala.collection.GenTraversableOnce<B>>)
  public $plus$plus(Lscala/Function0;)Lscala/collection/Iterator$ConcatIterator;
    NEW scala/collection/Iterator$ConcatIterator
    DUP
    ALOAD 0
    GETSTATIC scala/package$.MODULE$ : Lscala/package$;
    INVOKEVIRTUAL scala/package$.Vector ()Lscala/collection/immutable/Vector$;
    GETSTATIC scala/Predef$.MODULE$ : Lscala/Predef$;
    ICONST_1
    ANEWARRAY scala/Function0
    DUP
    ICONST_0
    NEW scala/collection/Iterator$JoinIterator$$anonfun$$plus$plus$2
    DUP
    ALOAD 0
    ALOAD 1
    INVOKESPECIAL scala/collection/Iterator$JoinIterator$$anonfun$$plus$plus$2.<init> (Lscala/collection/Iterator$JoinIterator;Lscala/Function0;)V
    AASTORE
  ...
  // access flags 0x1041
  public synthetic bridge $plus$plus(Lscala/Function0;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.$plus$plus (Lscala/Function0;)Lscala/collection/Iterator$ConcatIterator;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature (Lscala/collection/Iterator<TA;>;Lscala/Function0<Lscala/collection/GenTraversableOnce<TA;>;>;)V
  // declaration: void <init>(scala.collection.Iterator<A>, scala.Function0<scala.collection.GenTraversableOnce<A>>)
  public <init>(Lscala/collection/Iterator;Lscala/Function0;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/Iterator$JoinIterator.lhs : Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/Iterator$JoinIterator.that : Lscala/Function0;
    ALOAD 0
  ...
  public hasNext()Z
    ALOAD 0
    GETFIELD scala/collection/Iterator$JoinIterator.lhs : Lscala/collection/Iterator;
    INVOKEINTERFACE scala/collection/Iterator.hasNext ()Z
    IFNE L0
    ALOAD 0
    INVOKESPECIAL scala/collection/Iterator$JoinIterator.rhs ()Lscala/collection/Iterator;
    INVOKEINTERFACE scala/collection/Iterator.hasNext ()Z
    IFEQ L1
   L0
    ICONST_1
  ...
  // access flags 0x2
  // signature ()Lscala/collection/Iterator<TA;>;
  // declaration: scala.collection.Iterator<A> rhs()
  private rhs()Lscala/collection/Iterator;
    ALOAD 0
    GETFIELD scala/collection/Iterator$JoinIterator.bitmap$0 : Z
    IFEQ L0
    ALOAD 0
    GETFIELD scala/collection/Iterator$JoinIterator.rhs : Lscala/collection/Iterator;
    GOTO L1
   L0
    ALOAD 0
    INVOKESPECIAL scala/collection/Iterator$JoinIterator.rhs$lzycompute ()Lscala/collection/Iterator;
   L1
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x2
  private rhs$lzycompute()Lscala/collection/Iterator;
   ...
   L0
    ...
    ALOAD 0
    ALOAD 0
    GETFIELD scala/collection/Iterator$JoinIterator.that : Lscala/Function0;
    ...
    PUTFIELD scala/collection/Iterator$JoinIterator.rhs : Lscala/collection/Iterator;
    ALOAD 0
    ICONST_1
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/Iterator$JoinIterator.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
