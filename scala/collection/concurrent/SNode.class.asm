...
// access flags 0x31
// signature <K:Ljava/lang/Object;V:Ljava/lang/Object;>Lscala/collection/concurrent/BasicNode;Lscala/collection/concurrent/KVNode<TK;TV;>;
// declaration: scala/collection/concurrent/SNode<K, V> extends scala.collection.concurrent.BasicNode implements scala.collection.concurrent.KVNode<K, V>
public final class scala/collection/concurrent/SNode extends scala/collection/concurrent/BasicNode  implements scala/collection/concurrent/KVNode  {
  ...
  public <init>(Ljava/lang/Object;Ljava/lang/Object;I)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/concurrent/SNode.k : Ljava/lang/Object;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/concurrent/SNode.v : Ljava/lang/Object;
    ALOAD 0
    ILOAD 3
    PUTFIELD scala/collection/concurrent/SNode.hc : I
    ALOAD 0
  ...
  // declaration: scala.collection.concurrent.SNode<K, V> copy()
  public final copy()Lscala/collection/concurrent/SNode;
  ...
  public final hc()I
    ALOAD 0
    GETFIELD scala/collection/concurrent/SNode.hc : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public final k()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/concurrent/SNode.k : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public final v()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/concurrent/SNode.v : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
