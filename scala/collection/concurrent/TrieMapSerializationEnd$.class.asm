...
// access flags 0x31
public final class scala/collection/concurrent/TrieMapSerializationEnd$ implements scala/Product scala/Serializable  {
  ...
  public static <clinit>()V
    ...
    INVOKESPECIAL scala/collection/concurrent/TrieMapSerializationEnd$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/collection/concurrent/TrieMapSerializationEnd$.MODULE$ : Lscala/collection/concurrent/TrieMapSerializationEnd$;
    ALOAD 0
  ...
  public canEqual(Ljava/lang/Object;)Z
    ALOAD 1
    INSTANCEOF scala/collection/concurrent/TrieMapSerializationEnd$
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 2
