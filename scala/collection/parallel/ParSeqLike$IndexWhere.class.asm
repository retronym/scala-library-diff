...
// access flags 0x21
// signature Ljava/lang/Object;Lscala/collection/parallel/ParSeqLike<TT;TRepr;TSequential;>.Accessor<Ljava/lang/Object;Lscala/collection/parallel/ParSeqLike<TT;TRepr;TSequential;>.IndexWhere;>;
// declaration: scala/collection/parallel/ParSeqLike$IndexWhere implements scala.collection.parallel.ParSeqLike<T, Repr, Sequential>.Accessor<java.lang.Object, scala.collection.parallel.ParSeqLike<T, Repr, Sequential>.IndexWhere>
public class scala/collection/parallel/ParSeqLike$IndexWhere implements scala/collection/parallel/ParSeqLike$Accessor  {
  ...
  // access flags 0x11
  public final INNERCLASS scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$5 null null
  // access flags 0x11
  ...
  public final Lscala/Function1; scala$collection$parallel$ParSeqLike$IndexWhere$$pred
  ...
  public <init>(Lscala/collection/parallel/ParSeqLike;Lscala/Function1;ILscala/collection/parallel/SeqSplitter;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.scala$collection$parallel$ParSeqLike$IndexWhere$$pred : Lscala/Function1;
    ALOAD 0
    ILOAD 3
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.from : I
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.pit : Lscala/collection/parallel/SeqSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.$outer : Lscala/collection/parallel/ParSeqLike;
    ALOAD 0
    ...
    ALOAD 0
    ICONST_M1
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.result : I
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 5
  ...
  public leaf(Lscala/Option;)V
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.from : I
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.pit ()Lscala/collection/parallel/SeqSplitter;
    ...
    INVOKEINTERFACE scala/collection/parallel/SeqSplitter.indexWhere (Lscala/Function1;)I
    ISTORE 2
    ILOAD 2
    ICONST_M1
    IF_ICMPEQ L0
    ...
    ILOAD 2
    IADD
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.result_$eq (I)V
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.pit ()Lscala/collection/parallel/SeqSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.from : I
  ...
  // declaration: void merge(scala.collection.parallel.ParSeqLike<T, Repr, Sequential>.IndexWhere)
  public merge(Lscala/collection/parallel/ParSeqLike$IndexWhere;)V
    ALOAD 0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.result ()I
    ICONST_M1
    IF_ICMPNE L0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.result ()I
  ...
  public synthetic bridge merge(Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    CHECKCAST scala/collection/parallel/ParSeqLike$IndexWhere
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.merge (Lscala/collection/parallel/ParSeqLike$IndexWhere;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$IndexWhere.newSubtask (Lscala/collection/parallel/IterableSplitter;)Lscala/runtime/Nothing$;
    ATHROW
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pit()Lscala/collection/parallel/SeqSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.pit : Lscala/collection/parallel/SeqSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public result()I
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.result : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParSeqLike$IndexWhere$$$outer()Lscala/collection/parallel/ParSeqLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.$outer : Lscala/collection/parallel/ParSeqLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/Task<Ljava/lang/Object;Lscala/collection/parallel/ParSeqLike<TT;TRepr;TSequential;>.IndexWhere;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.Task<java.lang.Object, scala.collection.parallel.ParSeqLike<T, Repr, Sequential>.IndexWhere>> split()
  public split()Lscala/collection/Seq;
    ...
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.from : I
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToInteger (I)Ljava/lang/Integer;
    NEW scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$4
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$4.<init> (Lscala/collection/parallel/ParSeqLike$IndexWhere;)V
    ...
    NEW scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$5
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$5.<init> (Lscala/collection/parallel/ParSeqLike$IndexWhere;)V
    INVOKEINTERFACE scala/collection/TraversableLike.withFilter (Lscala/Function1;)Lscala/collection/generic/FilterMonadic;
    NEW scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$6
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParSeqLike$IndexWhere$$anonfun$split$6.<init> (Lscala/collection/parallel/ParSeqLike$IndexWhere;)V
    GETSTATIC scala/collection/Seq$.MODULE$ : Lscala/collection/Seq$;
    INVOKEVIRTUAL scala/collection/Seq$.canBuildFrom ()Lscala/collection/generic/CanBuildFrom;
  ...
  public throwable()Ljava/lang/Throwable;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$IndexWhere.throwable : Ljava/lang/Throwable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public throwable_$eq(Ljava/lang/Throwable;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParSeqLike$IndexWhere.throwable : Ljava/lang/Throwable;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
