...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$splitAt$1 extends scala.runtime.AbstractFunction1<scala.Tuple2<scala.collection.parallel.Combiner<T, Repr>, scala.collection.parallel.Combiner<T, Repr>>, scala.Tuple2<Repr, Repr>> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$splitAt$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/parallel/ParIterableLike splitAt (I)Lscala/Tuple2;
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$splitAt$1.apply (Lscala/Tuple2;)Lscala/Tuple2;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
