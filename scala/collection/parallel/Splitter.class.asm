...
// access flags 0x601
// signature <T:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/Iterator<TT;>;
...
public abstract interface scala/collection/parallel/Splitter implements scala/collection/Iterator  {
  ...
  // declaration: scala.collection.Seq<scala.collection.parallel.Splitter<T>> split()
