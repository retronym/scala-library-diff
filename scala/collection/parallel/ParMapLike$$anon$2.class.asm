...
// access flags 0x31
// signature Ljava/lang/Object;Lscala/collection/parallel/ParMap<TK;TS;>;
// declaration: scala/collection/parallel/ParMapLike$$anon$2 implements scala.collection.parallel.ParMap<K, S>
public final class scala/collection/parallel/ParMapLike$$anon$2 implements scala/collection/parallel/ParMap  {

  OUTERCLASS scala/collection/parallel/ParMapLike mapValues (Lscala/Function1;)Lscala/collection/parallel/ParMap;
  // access flags 0x11
  ...
  // access flags 0x1012
  private final synthetic Lscala/collection/parallel/ParMapLike; $outer
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(TS;Lscala/Function2<Lscala/Tuple2<TK;TS;>;TS;TS;>;)TS;
  // declaration: S $colon$bslash<S>(S, scala.Function2<scala.Tuple2<K, S>, S, S>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(TS;Lscala/Function2<TS;Lscala/Tuple2<TK;TS;>;TS;>;)TS;
  // declaration: S $div$colon<S>(S, scala.Function2<S, scala.Tuple2<K, S>, S>)
  ...
  // access flags 0x1
  // signature (TK;)Lscala/collection/parallel/ParMap<TK;TS;>;
  // declaration: scala.collection.parallel.ParMap<K, S> $minus(K)
  public $minus(Ljava/lang/Object;)Lscala/collection/parallel/ParMap;
    GETSTATIC scala/collection/parallel/ParMap$.MODULE$ : Lscala/collection/parallel/ParMap$;
    GETSTATIC scala/collection/immutable/Nil$.MODULE$ : Lscala/collection/immutable/Nil$;
    INVOKEVIRTUAL scala/collection/parallel/ParMap$.apply (Lscala/collection/Seq;)Lscala/collection/GenMap;
    CHECKCAST scala/collection/parallel/ParIterableLike
    ALOAD 0
    GETSTATIC scala/collection/parallel/ParMap$.MODULE$ : Lscala/collection/parallel/ParMap$;
    INVOKEVIRTUAL scala/collection/parallel/ParMap$.canBuildFrom ()Lscala/collection/generic/CanCombineFrom;
    INVOKEINTERFACE scala/collection/parallel/ParIterableLike.$plus$plus (Lscala/collection/GenTraversableOnce;Lscala/collection/generic/CanBuildFrom;)Ljava/lang/Object;
    CHECKCAST scala/collection/GenMapLike
    ALOAD 1
    INVOKEINTERFACE scala/collection/GenMapLike.$minus (Ljava/lang/Object;)Ljava/lang/Object;
  ...
  public synthetic bridge $minus(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.$minus (Ljava/lang/Object;)Lscala/collection/parallel/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public $plus(Lscala/Tuple2;)Lscala/collection/parallel/ParMap;
    GETSTATIC scala/collection/parallel/ParMap$.MODULE$ : Lscala/collection/parallel/ParMap$;
    GETSTATIC scala/collection/immutable/Nil$.MODULE$ : Lscala/collection/immutable/Nil$;
    INVOKEVIRTUAL scala/collection/parallel/ParMap$.apply (Lscala/collection/Seq;)Lscala/collection/GenMap;
    CHECKCAST scala/collection/parallel/ParIterableLike
  ...
  public synthetic bridge $plus(Lscala/Tuple2;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.$plus (Lscala/Tuple2;)Lscala/collection/parallel/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <U:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenTraversableOnce<TU;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TU;TThat;>;)TThat;
  // declaration: That $plus$plus<U, That>(scala.collection.GenTraversableOnce<U>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, U, That>)
  ...
  public <init>(Lscala/collection/parallel/ParMapLike;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$2.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$2.f$4 : Lscala/Function1;
    ALOAD 0
  ...
  public ScanLeaf()Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanLeaf$module : Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
    IFNONNULL L0
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$2.ScanLeaf$lzycompute ()Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
    GOTO L1
   L0
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanLeaf$module : Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
  ...
  private ScanLeaf$lzycompute()Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
   ...
   L0
    ...
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanLeaf$module : Lscala/collection/parallel/ParIterableLike$ScanLeaf$;
   L3
  ...
  public ScanNode()Lscala/collection/parallel/ParIterableLike$ScanNode$;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanNode$module : Lscala/collection/parallel/ParIterableLike$ScanNode$;
    IFNONNULL L0
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$2.ScanNode$lzycompute ()Lscala/collection/parallel/ParIterableLike$ScanNode$;
    GOTO L1
   L0
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanNode$module : Lscala/collection/parallel/ParIterableLike$ScanNode$;
  ...
  private ScanNode$lzycompute()Lscala/collection/parallel/ParIterableLike$ScanNode$;
   ...
   L0
    ...
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$2.ScanNode$module : Lscala/collection/parallel/ParIterableLike$ScanNode$;
   L3
    GETSTATIC scala/runtime/BoxedUnit.UNIT : Lscala/runtime/BoxedUnit;
    POP
    ALOAD 0
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function0<TS;>;Lscala/Function2<TS;Lscala/Tuple2<TK;TS;>;TS;>;Lscala/Function2<TS;TS;TS;>;)TS;
  // declaration: S aggregate<S>(scala.Function0<S>, scala.Function2<S, scala.Tuple2<K, S>, S>, scala.Function2<S, S, S>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)Ljava/lang/Object;
  // declaration:  bf2seq<S, That>(scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/Tuple2<TK;TS;>;TS;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)TThat;
  // declaration: That collect<S, That>(scala.PartialFunction<scala.Tuple2<K, S>, S>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  public contains(Ljava/lang/Object;)Z
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 1
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)I
  // declaration: int count(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  public synthetic bridge drop(I)Ljava/lang/Object;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.drop (I)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge dropWhile(Lscala/Function1;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.dropWhile (Lscala/Function1;)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature ()Lscala/collection/parallel/ParMap<TK;TS;>;
  // declaration: scala.collection.parallel.ParMap<K, S> empty()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)Z
  // declaration: boolean exists(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  public synthetic bridge filter(Lscala/Function1;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.filter (Lscala/Function1;)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/parallel/ParMap<TK;TS;>;
  // declaration: scala.collection.parallel.ParMap<K, S> filterKeys(scala.Function1<K, java.lang.Object>)
  ...
  public synthetic bridge filterKeys(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.filterKeys (Lscala/Function1;)Lscala/collection/parallel/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge filterNot(Lscala/Function1;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.filterNot (Lscala/Function1;)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)Lscala/Option<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.Option<scala.Tuple2<K, S>> find(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;Lscala/collection/GenTraversableOnce<TS;>;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)TThat;
  // declaration: That flatMap<S, That>(scala.Function1<scala.Tuple2<K, S>, scala.collection.GenTraversableOnce<S>>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(TS;Lscala/Function2<TS;Lscala/Tuple2<TK;TS;>;TS;>;)TS;
  // declaration: S foldLeft<S>(S, scala.Function2<S, scala.Tuple2<K, S>, S>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(TS;Lscala/Function2<Lscala/Tuple2<TK;TS;>;TS;TS;>;)TS;
  // declaration: S foldRight<S>(S, scala.Function2<scala.Tuple2<K, S>, S, S>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)Z
  // declaration: boolean forall(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <Q:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;TQ;>;)V
  // declaration: void foreach<Q>(scala.Function1<scala.Tuple2<K, S>, Q>)
  public foreach(Lscala/Function1;)V
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.$outer : Lscala/collection/parallel/ParMapLike;
    NEW scala/collection/parallel/ParMapLike$$anon$2$$anonfun$foreach$6
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$2$$anonfun$foreach$6.<init> (Lscala/collection/parallel/ParMapLike$$anon$2;)V
    INVOKEINTERFACE scala/collection/parallel/ParMapLike.withFilter (Lscala/Function1;)Lscala/collection/parallel/ParIterable;
    NEW scala/collection/parallel/ParMapLike$$anon$2$$anonfun$foreach$7
    DUP
    ALOAD 0
    ALOAD 1
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$2$$anonfun$foreach$7.<init> (Lscala/collection/parallel/ParMapLike$$anon$2;Lscala/Function1;)V
  ...
  public synthetic bridge genericBuilder()Lscala/collection/mutable/Builder;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.genericBuilder ()Lscala/collection/parallel/Combiner;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (TK;)Lscala/Option<TS;>;
  // declaration: scala.Option<S> get(K)
  ...
  // access flags 0x1
  // signature <K:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;TK;>;)Lscala/collection/parallel/immutable/ParMap<TK;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.collection.parallel.immutable.ParMap<K, scala.collection.parallel.ParMap<K, S>> groupBy<K>(scala.Function1<scala.Tuple2<K, S>, K>)
  ...
  public synthetic bridge groupBy(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.groupBy (Lscala/Function1;)Lscala/collection/parallel/immutable/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature ()Lscala/Option<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.Option<scala.Tuple2<K, S>> headOption()
  ...
  public synthetic bridge init()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.init ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/Splitter<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.parallel.Splitter<scala.Tuple2<K, S>> iterator()
  ...
  public synthetic bridge iterator()Lscala/collection/Iterator;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.iterator ()Lscala/collection/parallel/Splitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge keySet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.keySet ()Lscala/collection/parallel/ParSet;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge keys()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.keys ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge keysIterator()Lscala/collection/Iterator;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.keysIterator ()Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/Option<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.Option<scala.Tuple2<K, S>> lastOption()
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;TS;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)TThat;
  // declaration: That map<S, That>(scala.Function1<scala.Tuple2<K, S>, S>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function1<TS;TS;>;)Lscala/collection/parallel/ParMap<TK;TS;>;
  // declaration: scala.collection.parallel.ParMap<K, S> mapValues<S>(scala.Function1<S, S>)
  ...
  public synthetic bridge mapValues(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.mapValues (Lscala/Function1;)Lscala/collection/parallel/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature ()Lscala/collection/mutable/Builder<Lscala/Tuple2<TK;TS;>;Lscala/collection/parallel/ParIterable<Lscala/Tuple2<TK;TS;>;>;>;
  // declaration: scala.collection.mutable.Builder<scala.Tuple2<K, S>, scala.collection.parallel.ParIterable<scala.Tuple2<K, S>>> newBuilder()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/Combiner<Lscala/Tuple2<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.collection.parallel.Combiner<scala.Tuple2<K, S>, scala.collection.parallel.ParMap<K, S>> newCombiner()
  ...
  public synthetic bridge par()Lscala/collection/Parallel;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.par ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/Combiner<Lscala/Tuple2<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.collection.parallel.Combiner<scala.Tuple2<K, S>, scala.collection.parallel.ParMap<K, S>> parCombiner()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.ParMap<K, S>, scala.collection.parallel.ParMap<K, S>> partition(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function2<TU;Lscala/Tuple2<TK;TS;>;TU;>;)TU;
  // declaration: U reduceLeft<U>(scala.Function2<U, scala.Tuple2<K, S>, U>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function2<TU;Lscala/Tuple2<TK;TS;>;TU;>;)Lscala/Option<TU;>;
  // declaration: scala.Option<U> reduceLeftOption<U>(scala.Function2<U, scala.Tuple2<K, S>, U>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function2<Lscala/Tuple2<TK;TS;>;TU;TU;>;)TU;
  // declaration: U reduceRight<U>(scala.Function2<scala.Tuple2<K, S>, U, U>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function2<Lscala/Tuple2<TK;TS;>;TU;TU;>;)Lscala/Option<TU;>;
  // declaration: scala.Option<U> reduceRightOption<U>(scala.Function2<scala.Tuple2<K, S>, U, U>)
  ...
  public synthetic bridge repr()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.repr ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public scala$collection$parallel$ParIterableLike$$_tasksupport()Lscala/collection/parallel/TaskSupport;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.scala$collection$parallel$ParIterableLike$$_tasksupport : Lscala/collection/parallel/TaskSupport;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  @Lscala/runtime/TraitSetter;() // invisible
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$2.scala$collection$parallel$ParIterableLike$$_tasksupport : Lscala/collection/parallel/TaskSupport;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <U:Ljava/lang/Object;That:Ljava/lang/Object;>(TU;Lscala/Function2<TU;TU;TU;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TU;TThat;>;)TThat;
  // declaration: That scan<U, That>(U, scala.Function2<U, U, U>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, U, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(TS;Lscala/Function2<TS;Lscala/Tuple2<TK;TS;>;TS;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)TThat;
  // declaration: That scanLeft<S, That>(S, scala.Function2<S, scala.Tuple2<K, S>, S>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(TS;Lscala/Function2<Lscala/Tuple2<TK;TS;>;TS;TS;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;TS;TThat;>;)TThat;
  // declaration: That scanRight<S, That>(S, scala.Function2<scala.Tuple2<K, S>, S, S>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, S, That>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Map<TK;TS;>;
  // declaration: scala.collection.Map<K, S> seq()
  public seq()Lscala/collection/Map;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.$outer : Lscala/collection/parallel/ParMapLike;
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.seq ()Lscala/collection/Map;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge slice(II)Ljava/lang/Object;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.slice (II)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TK;TS;>;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.ParMap<K, S>, scala.collection.parallel.ParMap<K, S>> span(scala.Function1<scala.Tuple2<K, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (I)Lscala/Tuple2<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.ParMap<K, S>, scala.collection.parallel.ParMap<K, S>> splitAt(int)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TK;TV;>;>.Mapped<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<K, V>>.Mapped<scala.Tuple2<K, S>> splitter()
  public splitter()Lscala/collection/parallel/IterableSplitter$Mapped;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$2.$outer : Lscala/collection/parallel/ParMapLike;
    INVOKEINTERFACE scala/collection/parallel/ParMapLike.splitter ()Lscala/collection/parallel/IterableSplitter;
    NEW scala/collection/parallel/ParMapLike$$anon$2$$anonfun$splitter$1
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$2$$anonfun$splitter$1.<init> (Lscala/collection/parallel/ParMapLike$$anon$2;)V
  ...
  public synthetic bridge splitter()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.splitter ()Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tail()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.tail ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge take(I)Ljava/lang/Object;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.take (I)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge takeWhile(Lscala/Function1;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.takeWhile (Lscala/Function1;)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <R:Ljava/lang/Object;Tp:Ljava/lang/Object;>(Lscala/collection/parallel/ParIterableLike<Lscala/Tuple2<TK;TS;>;Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/collection/Map<TK;TS;>;>.StrictSplitterCheckTask<TR;TTp;>;)Ljava/lang/Object;
  // declaration:  task2ops<R, Tp>(scala.collection.parallel.ParIterableLike<scala.Tuple2<K, S>, scala.collection.parallel.ParMap<K, S>, scala.collection.Map<K, S>>.StrictSplitterCheckTask<R, Tp>)
  ...
  // access flags 0x1
  // signature <Col:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<Lscala/runtime/Nothing$;Lscala/Tuple2<TK;TS;>;TCol;>;)TCol;
  // declaration: Col to<Col>(scala.collection.generic.CanBuildFrom<scala.runtime.Nothing$, scala.Tuple2<K, S>, Col>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/IndexedSeq<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.immutable.IndexedSeq<scala.Tuple2<K, S>> toIndexedSeq()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/ParIterable<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.parallel.ParIterable<scala.Tuple2<K, S>> toIterable()
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.toIterable ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<K, S>> toIterator()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/List<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.immutable.List<scala.Tuple2<K, S>> toList()
  ...
  // access flags 0x1
  // signature <K:Ljava/lang/Object;V:Ljava/lang/Object;>(Lscala/Predef$$less$colon$less<Lscala/Tuple2<TK;TS;>;Lscala/Tuple2<TK;TV;>;>;)Lscala/collection/parallel/immutable/ParMap<TK;TV;>;
  // declaration: scala.collection.parallel.immutable.ParMap<K, V> toMap<K, V>(scala.Predef$$less$colon$less<scala.Tuple2<K, S>, scala.Tuple2<K, V>>)
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/parallel/immutable/ParMap;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <K:Ljava/lang/Object;V:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function0<Lscala/collection/parallel/Combiner<Lscala/Tuple2<TK;TV;>;TThat;>;>;Lscala/Predef$$less$colon$less<Lscala/Tuple2<TK;TS;>;Lscala/Tuple2<TK;TV;>;>;)TThat;
  // declaration: That toParMap<K, V, That>(scala.Function0<scala.collection.parallel.Combiner<scala.Tuple2<K, V>, That>>, scala.Predef$$less$colon$less<scala.Tuple2<K, S>, scala.Tuple2<K, V>>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/ParSeq<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.parallel.ParSeq<scala.Tuple2<K, S>> toSeq()
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.toSeq ()Lscala/collection/parallel/ParSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.toSet ()Lscala/collection/parallel/immutable/ParSet;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/immutable/Stream<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.immutable.Stream<scala.Tuple2<K, S>> toStream()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/GenTraversable<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.GenTraversable<scala.Tuple2<K, S>> toTraversable()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/Vector<Lscala/Tuple2<TK;TS;>;>;
  // declaration: scala.collection.immutable.Vector<scala.Tuple2<K, S>> toVector()
  ...
  // access flags 0x1
  // signature <A1:Ljava/lang/Object;A2:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;Lscala/Tuple2<TA1;TA2;>;>;)Lscala/Tuple2<Lscala/collection/parallel/ParIterable<TA1;>;Lscala/collection/parallel/ParIterable<TA2;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.ParIterable<A1>, scala.collection.parallel.ParIterable<A2>> unzip<A1, A2>(scala.Function1<scala.Tuple2<K, S>, scala.Tuple2<A1, A2>>)
  ...
  // access flags 0x1
  // signature <A1:Ljava/lang/Object;A2:Ljava/lang/Object;A3:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TK;TS;>;Lscala/Tuple3<TA1;TA2;TA3;>;>;)Lscala/Tuple3<Lscala/collection/parallel/ParIterable<TA1;>;Lscala/collection/parallel/ParIterable<TA2;>;Lscala/collection/parallel/ParIterable<TA3;>;>;
  // declaration: scala.Tuple3<scala.collection.parallel.ParIterable<A1>, scala.collection.parallel.ParIterable<A2>, scala.collection.parallel.ParIterable<A3>> unzip3<A1, A2, A3>(scala.Function1<scala.Tuple2<K, S>, scala.Tuple3<A1, A2, A3>>)
  ...
  public synthetic bridge updated(Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/GenMap;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.updated (Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/parallel/ParMap;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3

  // access flags 0x1
  // signature ()Lscala/collection/parallel/ParIterable<TS;>;
  // declaration: scala.collection.parallel.ParIterable<S> values()
  ...
  public synthetic bridge values()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.values ()Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // declaration: scala.collection.parallel.IterableSplitter<S> valuesIterator()
  ...
  public synthetic bridge valuesIterator()Lscala/collection/Iterator;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$2.valuesIterator ()Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenIterable<TS;>;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/Tuple2<TU;TS;>;TThat;>;)TThat;
  // declaration: That zip<U, S, That>(scala.collection.GenIterable<S>, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, scala.Tuple2<U, S>, That>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;U:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenIterable<TS;>;TU;TS;Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/Tuple2<TU;TS;>;TThat;>;)TThat;
  // declaration: That zipAll<S, U, That>(scala.collection.GenIterable<S>, U, S, scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, scala.Tuple2<U, S>, That>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<Lscala/collection/parallel/ParMap<TK;TS;>;Lscala/Tuple2<TU;Ljava/lang/Object;>;TThat;>;)TThat;
  // declaration: That zipWithIndex<U, That>(scala.collection.generic.CanBuildFrom<scala.collection.parallel.ParMap<K, S>, scala.Tuple2<U, java.lang.Object>, That>)
