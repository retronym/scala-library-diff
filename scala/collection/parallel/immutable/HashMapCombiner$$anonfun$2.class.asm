...
// declaration: scala/collection/parallel/immutable/HashMapCombiner$$anonfun$2 extends scala.runtime.AbstractFunction1<scala.collection.mutable.UnrolledBuffer<scala.Tuple2<K, V>>, scala.collection.mutable.UnrolledBuffer$Unrolled<scala.Tuple2<K, V>>> implements scala.Serializable
public final class scala/collection/parallel/immutable/HashMapCombiner$$anonfun$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/immutable/HashMapCombiner$$anonfun$2.apply (Lscala/collection/mutable/UnrolledBuffer;)Lscala/collection/mutable/UnrolledBuffer$Unrolled;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
