...
// declaration: scala/collection/parallel/ParIterableLike$CopyToArray$$anonfun$split$23 extends scala.runtime.AbstractFunction1<scala.Tuple2<scala.collection.parallel.IterableSplitter<T>, java.lang.Object>, java.lang.Object> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$CopyToArray$$anonfun$split$23 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike$CopyToArray;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$CopyToArray$$anonfun$split$23.$outer : Lscala/collection/parallel/ParIterableLike$CopyToArray;
    ALOAD 0
  ...
  public final apply(Lscala/Tuple2;)Z
    ...
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$CopyToArray$$anonfun$split$23.$outer : Lscala/collection/parallel/ParIterableLike$CopyToArray;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$CopyToArray$$anonfun$split$23.apply (Lscala/Tuple2;)Z
