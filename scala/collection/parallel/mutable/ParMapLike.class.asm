...
// access flags 0x601
// signature <K:Ljava/lang/Object;V:Ljava/lang/Object;Repr::Lscala/collection/parallel/mutable/ParMapLike<TK;TV;TRepr;TSequential;>;:Lscala/collection/parallel/mutable/ParMap<TK;TV;>;Sequential::Lscala/collection/mutable/Map<TK;TV;>;:Lscala/collection/mutable/MapLike<TK;TV;TSequential;>;>Ljava/lang/Object;Lscala/collection/GenMapLike<TK;TV;TRepr;>;Lscala/collection/parallel/ParMapLike<TK;TV;TRepr;TSequential;>;Lscala/collection/generic/Growable<Lscala/Tuple2<TK;TV;>;>;Lscala/collection/generic/Shrinkable<TK;>;Lscala/collection/mutable/Cloneable<TRepr;>;
// declaration: scala/collection/parallel/mutable/ParMapLike<K, V, Repr extends scala.collection.parallel.mutable.ParMapLike<K, V, Repr, Sequential>, scala.collection.parallel.mutable.ParMap<K, V>, Sequential extends scala.collection.mutable.Map<K, V>, scala.collection.mutable.MapLike<K, V, Sequential>> extends scala.collection.GenMapLike<K, V, Repr>, scala.collection.parallel.ParMapLike<K, V, Repr, Sequential>, scala.collection.generic.Growable<scala.Tuple2<K, V>>, scala.collection.generic.Shrinkable<K>, scala.collection.mutable.Cloneable<Repr>
