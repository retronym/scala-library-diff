...
// declaration: scala/collection/parallel/mutable/ParHashMap$$anonfun$brokenInvariants$1 extends scala.runtime.AbstractFunction1<scala.collection.immutable.List<java.lang.String>, scala.collection.immutable.List<java.lang.String>> implements scala.Serializable
public final class scala/collection/parallel/mutable/ParHashMap$$anonfun$brokenInvariants$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/mutable/ParHashMap$$anonfun$brokenInvariants$1.apply (Lscala/collection/immutable/List;)Lscala/collection/immutable/List;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
