...
// access flags 0x601
// signature <T:Ljava/lang/Object;Repr::Lscala/collection/parallel/mutable/ParSetLike<TT;TRepr;TSequential;>;:Lscala/collection/parallel/mutable/ParSet<TT;>;Sequential::Lscala/collection/mutable/Set<TT;>;:Lscala/collection/mutable/SetLike<TT;TSequential;>;>Ljava/lang/Object;Lscala/collection/GenSetLike<TT;TRepr;>;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>;Lscala/collection/parallel/ParSetLike<TT;TRepr;TSequential;>;Lscala/collection/generic/Growable<TT;>;Lscala/collection/generic/Shrinkable<TT;>;Lscala/collection/mutable/Cloneable<TRepr;>;
// declaration: scala/collection/parallel/mutable/ParSetLike<T, Repr extends scala.collection.parallel.mutable.ParSetLike<T, Repr, Sequential>, scala.collection.parallel.mutable.ParSet<T>, Sequential extends scala.collection.mutable.Set<T>, scala.collection.mutable.SetLike<T, Sequential>> extends scala.collection.GenSetLike<T, Repr>, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>, scala.collection.parallel.ParSetLike<T, Repr, Sequential>, scala.collection.generic.Growable<T>, scala.collection.generic.Shrinkable<T>, scala.collection.mutable.Cloneable<Repr>
