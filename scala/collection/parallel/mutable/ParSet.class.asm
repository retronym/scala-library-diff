...
public abstract interface scala/collection/parallel/mutable/ParSet implements scala/collection/parallel/mutable/ParIterable scala/collection/parallel/ParSet scala/collection/parallel/mutable/ParSetLike  {
  ...
  // access flags 0x401
  // signature ()Lscala/collection/generic/GenericCompanion<Lscala/collection/parallel/mutable/ParSet;>;
  // declaration: scala.collection.generic.GenericCompanion<scala.collection.parallel.mutable.ParSet> companion()
  public abstract companion()Lscala/collection/generic/GenericCompanion;

  // access flags 0x401
  // signature ()Lscala/collection/parallel/mutable/ParSet<TT;>;
  // declaration: scala.collection.parallel.mutable.ParSet<T> empty()
  public abstract empty()Lscala/collection/parallel/mutable/ParSet;

  // access flags 0x401
  // signature ()Lscala/collection/mutable/Set<TT;>;
  // declaration: scala.collection.mutable.Set<T> seq()
  public abstract seq()Lscala/collection/mutable/Set;
}
