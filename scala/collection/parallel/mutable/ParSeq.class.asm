...
public abstract interface scala/collection/parallel/mutable/ParSeq implements scala/collection/parallel/mutable/ParIterable scala/collection/parallel/ParSeq  {
  ...
  // access flags 0x401
  // signature ()Lscala/collection/generic/GenericCompanion<Lscala/collection/parallel/mutable/ParSeq;>;
  // declaration: scala.collection.generic.GenericCompanion<scala.collection.parallel.mutable.ParSeq> companion()
  public abstract companion()Lscala/collection/generic/GenericCompanion;

  // access flags 0x401
  // signature ()Lscala/collection/mutable/Seq<TT;>;
  // declaration: scala.collection.mutable.Seq<T> seq()
