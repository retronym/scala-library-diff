...
// access flags 0x21
// signature <T:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/parallel/IterableSplitter<TT;>;
// declaration: scala/collection/parallel/BufferSplitter<T> implements scala.collection.parallel.IterableSplitter<T>
public class scala/collection/parallel/BufferSplitter implements scala/collection/parallel/IterableSplitter  {
  ...
  // declaration: scala.collection.mutable.ArrayBuffer<T>
  private final Lscala/collection/mutable/ArrayBuffer; scala$collection$parallel$BufferSplitter$$buffer

  // access flags 0x2
  private I scala$collection$parallel$BufferSplitter$$index

  // access flags 0x12
  private final I scala$collection$parallel$BufferSplitter$$until
  ...
  // access flags 0x1
  // signature (Lscala/collection/mutable/ArrayBuffer<TT;>;IILscala/collection/generic/Signalling;)V
  // declaration: void <init>(scala.collection.mutable.ArrayBuffer<T>, int, int, scala.collection.generic.Signalling)
  public <init>(Lscala/collection/mutable/ArrayBuffer;IILscala/collection/generic/Signalling;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$buffer : Lscala/collection/mutable/ArrayBuffer;
    ALOAD 0
    ILOAD 2
    PUTFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$index : I
    ALOAD 0
    ILOAD 3
    PUTFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$until : I
    ALOAD 0
    ...
    ALOAD 0
    ALOAD 4
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.signalDelegate_$eq (Lscala/collection/generic/Signalling;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 5
  ...
  public debugInformation()Ljava/lang/String;
    ALOAD 0
    NEW scala/collection/parallel/BufferSplitter$$anonfun$debugInformation$1
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/BufferSplitter$$anonfun$debugInformation$1.<init> (Lscala/collection/parallel/BufferSplitter;)V
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.buildString (Lscala/Function1;)Ljava/lang/String;
    ARETURN
    MAXSTACK = 4
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/BufferSplitter<TT;>;
  // declaration: scala.collection.parallel.BufferSplitter<T> dup()
  public dup()Lscala/collection/parallel/BufferSplitter;
  ...
  public synthetic bridge dup()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.dup ()Lscala/collection/parallel/BufferSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge map(Lscala/Function1;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.map (Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public next()Ljava/lang/Object;
    ...
    ICONST_1
    IADD
    INVOKESPECIAL scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$index_$eq (I)V
    ALOAD 1
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature ()Lscala/collection/mutable/ArrayBuffer<TT;>;
  // declaration: scala.collection.mutable.ArrayBuffer<T> scala$collection$parallel$BufferSplitter$$buffer()
  public scala$collection$parallel$BufferSplitter$$buffer()Lscala/collection/mutable/ArrayBuffer;
    ALOAD 0
    GETFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$buffer : Lscala/collection/mutable/ArrayBuffer;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  public scala$collection$parallel$BufferSplitter$$index()I
    ALOAD 0
    GETFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$index : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x2
  private scala$collection$parallel$BufferSplitter$$index_$eq(I)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$index : I
    RETURN
  ...
  // access flags 0x1
  public scala$collection$parallel$BufferSplitter$$until()I
    ALOAD 0
    GETFIELD scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$until : I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate()Lscala/collection/generic/Signalling;
    ALOAD 0
    GETFIELD scala/collection/parallel/BufferSplitter.signalDelegate : Lscala/collection/generic/Signalling;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge slice(II)Lscala/collection/Iterator;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.slice (II)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public split()Lscala/collection/Seq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.remaining ()I
    ICONST_1
    IF_ICMPLE L0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.scala$collection$parallel$BufferSplitter$$until ()I
    ...
    ICONST_2
    ANEWARRAY scala/collection/parallel/BufferSplitter
    DUP
    ICONST_0
    NEW scala/collection/parallel/BufferSplitter
    DUP
  ...
  public synthetic bridge take(I)Lscala/collection/Iterator;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.take (I)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/BufferSplitter.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
