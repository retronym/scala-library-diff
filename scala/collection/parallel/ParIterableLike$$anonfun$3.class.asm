...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$3 extends scala.runtime.AbstractFunction2<scala.collection.parallel.Combiner<U, That>, scala.collection.parallel.Combiner<U, That>, scala.collection.parallel.Combiner<U, That>> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$3 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    ALOAD 2
    CHECKCAST scala/collection/parallel/Combiner
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$3.apply (Lscala/collection/parallel/Combiner;Lscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
