...
// access flags 0x21
// signature Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Accessor<Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Exists;>;
// declaration: scala/collection/parallel/ParIterableLike$Exists implements scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Accessor<java.lang.Object, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Exists>
public class scala/collection/parallel/ParIterableLike$Exists implements scala/collection/parallel/ParIterableLike$Accessor  {
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike;Lscala/Function1;Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParIterableLike$Exists.pred : Lscala/Function1;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/parallel/ParIterableLike$Exists.pit : Lscala/collection/parallel/IterableSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Exists.$outer : Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    ...
    ALOAD 0
    ICONST_0
    PUTFIELD scala/collection/parallel/ParIterableLike$Exists.result : Z
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 4
  ...
  public leaf(Lscala/Option;)V
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.pit ()Lscala/collection/parallel/IterableSplitter;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.pit ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.pred : Lscala/Function1;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.exists (Lscala/Function1;)Z
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.result_$eq (Z)V
   L0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.result ()Z
    ICONST_1
    IF_ICMPNE L1
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.pit ()Lscala/collection/parallel/IterableSplitter;
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Exists;)V
  // declaration: void merge(scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Exists)
  public merge(Lscala/collection/parallel/ParIterableLike$Exists;)V
    ALOAD 0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.result ()Z
    IFNE L0
  ...
  public synthetic bridge merge(Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    CHECKCAST scala/collection/parallel/ParIterableLike$Exists
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.merge (Lscala/collection/parallel/ParIterableLike$Exists;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/IterableSplitter<TT;>;)Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Exists;
  // declaration: scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Exists newSubtask(scala.collection.parallel.IterableSplitter<T>)
  public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Exists;
    NEW scala/collection/parallel/ParIterableLike$Exists
    DUP
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.scala$collection$parallel$ParIterableLike$Exists$$$outer ()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.pred : Lscala/Function1;
    ALOAD 1
  ...
  public synthetic bridge newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Exists.newSubtask (Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Exists;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pit()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.pit : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public result()Z
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.result : Z
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParIterableLike$Exists$$$outer()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.$outer : Lscala/collection/parallel/ParIterableLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/Task<Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Exists;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.Task<java.lang.Object, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Exists>> split()
  ...
  public throwable()Ljava/lang/Throwable;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Exists.throwable : Ljava/lang/Throwable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public throwable_$eq(Ljava/lang/Throwable;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Exists.throwable : Ljava/lang/Throwable;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
