...
// access flags 0x31
// signature Ljava/lang/Object;Lscala/collection/parallel/IterableSplitter<TK;>;
// declaration: scala/collection/parallel/ParMapLike$$anon$3 implements scala.collection.parallel.IterableSplitter<K>
public final class scala/collection/parallel/ParMapLike$$anon$3 implements scala/collection/parallel/IterableSplitter  {

  OUTERCLASS scala/collection/parallel/ParMapLike$class scala$collection$parallel$ParMapLike$$keysIterator (Lscala/collection/parallel/ParMapLike;Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/IterableSplitter;
  // access flags 0x11
  ...
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<K, V>>
  private final Lscala/collection/parallel/IterableSplitter; iter

  // access flags 0x2
  private Lscala/collection/generic/Signalling; signalDelegate

  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TK;TB;TB;>;)TB;
  // declaration: B $colon$bslash<B>(B, scala.Function2<K, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TK;TB;>;)TB;
  // declaration: B $div$colon<B>(B, scala.Function2<B, K, B>)
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/ParMapLike;)V
  // declaration: void <init>(scala.collection.parallel.ParMapLike)
  public <init>(Lscala/collection/parallel/ParMapLike;Lscala/collection/parallel/IterableSplitter;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$3.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    ...
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$3.iter : Lscala/collection/parallel/IterableSplitter;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function0<TB;>;Lscala/Function2<TB;TK;TB;>;Lscala/Function2<TB;TB;TB;>;)TB;
  // declaration: B aggregate<B>(scala.Function0<B>, scala.Function2<B, K, B>, scala.Function2<B, B, B>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;PI::Lscala/collection/parallel/IterableSplitter<TU;>;>(TPI;)Lscala/collection/parallel/IterableSplitter<TK;>.Appended<TU;TPI;>;
  // declaration: scala.collection.parallel.IterableSplitter<K>.Appended<U, PI> appendParIterable<U, PI extends scala.collection.parallel.IterableSplitter<U>>(PI)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/BufferedIterator<TK;>;
  // declaration: scala.collection.BufferedIterator<K> buffered()
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<TK;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> collect<B>(scala.PartialFunction<K, B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/PartialFunction<TK;TS;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> collect2combiner<S, That>(scala.PartialFunction<K, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<TK;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> collectFirst<B>(scala.PartialFunction<K, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/GenTraversableOnce<TB;>;Lscala/Function2<TK;TB;Ljava/lang/Object;>;)Z
  // declaration: boolean corresponds<B>(scala.collection.GenTraversableOnce<B>, scala.Function2<K, B, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> drop(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> dropWhile(scala.Function1<K, java.lang.Object>)
  ...
  // declaration: scala.collection.parallel.IterableSplitter<K> dup()
  public dup()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$3.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$3.iter ()Lscala/collection/parallel/IterableSplitter;
  ...
  // access flags 0x1
  // signature ()Lscala/Tuple2<Lscala/collection/Iterator<TK;>;Lscala/collection/Iterator<TK;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<K>, scala.collection.Iterator<K>> duplicate()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> filter(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TK;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filter2combiner<U, This>(scala.Function1<K, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> filterNot(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TK;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filterNot2combiner<U, This>(scala.Function1<K, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TK;Lscala/collection/GenTraversableOnce<TB;>;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> flatMap<B>(scala.Function1<K, scala.collection.GenTraversableOnce<B>>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<TK;Lscala/collection/GenTraversableOnce<TS;>;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> flatmap2combiner<S, That>(scala.Function1<K, scala.collection.GenTraversableOnce<S>>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TK;TB;>;)TB;
  // declaration: B foldLeft<B>(B, scala.Function2<B, K, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TK;TB;TB;>;)TB;
  // declaration: B foldRight<B>(B, scala.Function2<K, B, B>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TK;TU;>;)V
  // declaration: void foreach<U>(scala.Function1<K, U>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(I)Lscala/collection/Iterator<TK;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<K>.GroupedIterator<B> grouped<B>(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)I
  // declaration: int indexWhere(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x2
  // signature ()Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TK;TV;>;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<K, V>> iter()
  private iter()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$3.iter : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function1<TK;TS;>;)Lscala/collection/parallel/IterableSplitter<TK;>.Mapped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<K>.Mapped<S> map<S>(scala.Function1<K, S>)
  ...
  public synthetic bridge map(Lscala/Function1;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.map (Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<TK;TS;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> map2combiner<S, That>(scala.Function1<K, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TK;TB;>;Lscala/math/Ordering<TB;>;)TK;
  // declaration: K maxBy<B>(scala.Function1<K, B>, scala.math.Ordering<B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TK;TB;>;Lscala/math/Ordering<TB;>;)TK;
  // declaration: K minBy<B>(scala.Function1<K, B>, scala.math.Ordering<B>)
  ...
  // access flags 0x1
  // signature <U:Lscala/collection/parallel/IterableSplitter<TK;>.Taken;>(TU;I)TU;
  // declaration: U newSliceInternal<U extends scala.collection.parallel.IterableSplitter<K>.Taken>(U, int)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TK;>.Taken;
  // declaration: scala.collection.parallel.IterableSplitter<K>.Taken newTaken(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<TK;>;Lscala/collection/Iterator<TK;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<K>, scala.collection.Iterator<K>> partition(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TK;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> partition2combiners<U, This>(scala.Function1<K, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;TK;TB;>;)TB;
  // declaration: B reduceLeft<B>(scala.Function2<B, K, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;TK;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceLeftOption<B>(scala.Function2<B, K, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TK;TB;TB;>;)TB;
  // declaration: B reduceRight<B>(scala.Function2<K, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TK;TB;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceRightOption<B>(scala.Function2<K, B, B>)
  ...
  // declaration: scala.collection.immutable.List<K> reversed()
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParMapLike$$anon$$$outer()Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$3.$outer : Lscala/collection/parallel/ParMapLike;
    ARETURN
    MAXSTACK = 1
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TK;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanLeft<B>(B, scala.Function2<B, K, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TK;TB;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanRight<B>(B, scala.Function2<K, B, B>)
  ...
  // declaration: scala.collection.Iterator<K> seq()
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate()Lscala/collection/generic/Signalling;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$3.signalDelegate : Lscala/collection/generic/Signalling;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate_$eq(Lscala/collection/generic/Signalling;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$3.signalDelegate : Lscala/collection/generic/Signalling;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/parallel/IterableSplitter<TK;>;
  // declaration: scala.collection.parallel.IterableSplitter<K> slice(int, int)
  ...
  public synthetic bridge slice(II)Lscala/collection/Iterator;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.slice (II)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(II)Lscala/collection/Iterator<TK;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<K>.GroupedIterator<B> sliding<B>(int, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<TK;>;Lscala/collection/Iterator<TK;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<K>, scala.collection.Iterator<K>> span(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TK;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> span2combiners<U, This>(scala.Function1<K, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TK;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<K>> split()
  public split()Lscala/collection/Seq;
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$3.iter ()Lscala/collection/parallel/IterableSplitter;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.split ()Lscala/collection/Seq;
    NEW scala/collection/parallel/ParMapLike$$anon$3$$anonfun$1
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$3$$anonfun$1.<init> (Lscala/collection/parallel/ParMapLike$$anon$3;)V
    ...
    ASTORE 1
    ALOAD 1
    NEW scala/collection/parallel/ParMapLike$$anon$3$$anonfun$split$1
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$3$$anonfun$split$1.<init> (Lscala/collection/parallel/ParMapLike$$anon$3;)V
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TK;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<K>> splitWithSignalling()
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TK;>;
  // declaration: scala.collection.parallel.IterableSplitter<K> take(int)
  ...
  public synthetic bridge take(I)Lscala/collection/Iterator;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.take (I)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> takeWhile(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TK;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Ljava/lang/Object;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, java.lang.Object> takeWhile2combiner<U, This>(scala.Function1<K, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // declaration: scala.collection.Iterable<K> toIterable()
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <T:Ljava/lang/Object;U:Ljava/lang/Object;>(Lscala/Predef$$less$colon$less<TK;Lscala/Tuple2<TT;TU;>;>;)Lscala/collection/immutable/Map<TT;TU;>;
  // declaration: scala.collection.immutable.Map<T, U> toMap<T, U>(scala.Predef$$less$colon$less<K, scala.Tuple2<T, U>>)
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature ()Lscala/collection/Seq<TK;>;
  // declaration: scala.collection.Seq<K> toSeq()
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Traversable<TK;>;
  // declaration: scala.collection.Traversable<K> toTraversable()
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$3.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TK;Ljava/lang/Object;>;)Lscala/collection/Iterator<TK;>;
  // declaration: scala.collection.Iterator<K> withFilter(scala.Function1<K, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/Iterator<TB;>;)Lscala/collection/Iterator<Lscala/Tuple2<TK;TB;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<K, B>> zip<B>(scala.collection.Iterator<B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;U:Ljava/lang/Object;R:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;TU;TR;)Lscala/collection/parallel/IterableSplitter<TK;>.ZippedAll<TU;TR;>;
  // declaration: scala.collection.parallel.IterableSplitter<K>.ZippedAll<U, R> zipAllParSeq<S, U, R>(scala.collection.parallel.SeqSplitter<S>, U, R)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;)Lscala/collection/parallel/IterableSplitter<TK;>.Zipped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<K>.Zipped<S> zipParSeq<S>(scala.collection.parallel.SeqSplitter<S>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<TK;Ljava/lang/Object;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<K, java.lang.Object>> zipWithIndex()
