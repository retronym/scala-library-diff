...
// declaration: scala/collection/parallel/ParSeqLike$$anonfun$reverseMap$2 extends scala.runtime.AbstractFunction1<scala.collection.parallel.Combiner<S, That>, That> implements scala.Serializable
public final class scala/collection/parallel/ParSeqLike$$anonfun$reverseMap$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$$anonfun$reverseMap$2.apply (Lscala/collection/parallel/Combiner;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
