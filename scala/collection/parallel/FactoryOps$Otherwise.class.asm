...
// declaration: scala/collection/parallel/FactoryOps$Otherwise<R>
public abstract interface scala/collection/parallel/FactoryOps$Otherwise {
  ...
  public abstract otherwise(Lscala/Function0;)Ljava/lang/Object;
}
