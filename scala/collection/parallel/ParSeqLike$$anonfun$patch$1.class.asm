...
// declaration: scala/collection/parallel/ParSeqLike$$anonfun$patch$1 extends scala.runtime.AbstractFunction2<scala.collection.parallel.Combiner<U, That>, scala.collection.parallel.Combiner<U, That>, scala.collection.parallel.Combiner<U, That>> implements scala.Serializable
public final class scala/collection/parallel/ParSeqLike$$anonfun$patch$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    ALOAD 2
    CHECKCAST scala/collection/parallel/Combiner
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$$anonfun$patch$1.apply (Lscala/collection/parallel/Combiner;Lscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
