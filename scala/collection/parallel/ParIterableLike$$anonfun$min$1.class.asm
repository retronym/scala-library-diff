...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$min$1 extends scala.runtime.AbstractFunction1<scala.Option<U>, U> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$min$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/parallel/ParIterableLike min (Lscala/math/Ordering;)Ljava/lang/Object;
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$min$1.apply (Lscala/Option;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
