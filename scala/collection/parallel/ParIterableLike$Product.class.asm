...
// access flags 0x21
// signature <U:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Accessor<TU;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Product<TU;>;>;
// declaration: scala/collection/parallel/ParIterableLike$Product<U> implements scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Accessor<U, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Product<U>>
public class scala/collection/parallel/ParIterableLike$Product implements scala/collection/parallel/ParIterableLike$Accessor  {
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike;Lscala/math/Numeric;Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParIterableLike$Product.num : Lscala/math/Numeric;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/parallel/ParIterableLike$Product.pit : Lscala/collection/parallel/IterableSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Product.$outer : Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    ...
    ALOAD 0
    ACONST_NULL
    PUTFIELD scala/collection/parallel/ParIterableLike$Product.result : Ljava/lang/Object;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 4
  ...
  public leaf(Lscala/Option;)V
    ALOAD 0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.pit ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.num : Lscala/math/Numeric;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.product (Lscala/math/Numeric;)Ljava/lang/Object;
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.result_$eq (Ljava/lang/Object;)V
    RETURN
    MAXSTACK = 3
    MAXLOCALS = 2

  // access flags 0x1
  // signature (Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Product<TU;>;)V
  // declaration: void merge(scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Product<U>)
  public merge(Lscala/collection/parallel/ParIterableLike$Product;)V
    ALOAD 0
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.num : Lscala/math/Numeric;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.result ()Ljava/lang/Object;
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.result ()Ljava/lang/Object;
  ...
  public synthetic bridge merge(Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    CHECKCAST scala/collection/parallel/ParIterableLike$Product
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.merge (Lscala/collection/parallel/ParIterableLike$Product;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/IterableSplitter<TT;>;)Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Product<TU;>;
  // declaration: scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Product<U> newSubtask(scala.collection.parallel.IterableSplitter<T>)
  public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Product;
    NEW scala/collection/parallel/ParIterableLike$Product
    DUP
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.scala$collection$parallel$ParIterableLike$Product$$$outer ()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.num : Lscala/math/Numeric;
    ALOAD 1
  ...
  public synthetic bridge newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Product.newSubtask (Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Product;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pit()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.pit : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public result()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.result : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParIterableLike$Product$$$outer()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.$outer : Lscala/collection/parallel/ParIterableLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/Task<TU;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Product<TU;>;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.Task<U, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Product<U>>> split()
  ...
  public throwable()Ljava/lang/Throwable;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Product.throwable : Ljava/lang/Throwable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public throwable_$eq(Ljava/lang/Throwable;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Product.throwable : Ljava/lang/Throwable;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
