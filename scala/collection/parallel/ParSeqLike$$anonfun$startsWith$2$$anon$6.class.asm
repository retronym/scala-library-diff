...
public final class scala/collection/parallel/ParSeqLike$$anonfun$startsWith$2$$anon$6 extends scala/collection/generic/DefaultSignalling  {
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/ParSeqLike<TT;TRepr;TSequential;>.$anonfun$startsWith$2;)V
  // declaration: void <init>(scala.collection.parallel.ParSeqLike<T, Repr, Sequential>.$anonfun$startsWith$2)
  public <init>(Lscala/collection/parallel/ParSeqLike$$anonfun$startsWith$2;)V
    ALOAD 0
