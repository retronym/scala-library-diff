...
// declaration: scala/collection/parallel/ParSeqLike$$anonfun$updated$1 extends scala.runtime.AbstractFunction0<scala.collection.parallel.Combiner<U, That>> implements scala.Serializable
public final class scala/collection/parallel/ParSeqLike$$anonfun$updated$1 extends scala/runtime/AbstractFunction0  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/parallel/ParSeqLike;Lscala/collection/generic/CanBuildFrom;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParSeqLike$$anonfun$updated$1.$outer : Lscala/collection/parallel/ParSeqLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParSeqLike$$anonfun$updated$1.bf$3 : Lscala/collection/generic/CanBuildFrom;
    ALOAD 0
  ...
  public final apply()Lscala/collection/parallel/Combiner;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$$anonfun$updated$1.$outer : Lscala/collection/parallel/ParSeqLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$$anonfun$updated$1.bf$3 : Lscala/collection/generic/CanBuildFrom;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$$anonfun$updated$1.$outer : Lscala/collection/parallel/ParSeqLike;
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParSeqLike$$anonfun$updated$1.apply ()Lscala/collection/parallel/Combiner;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
