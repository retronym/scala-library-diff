...
// declaration: scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3 extends scala.runtime.AbstractFunction1<scala.Tuple2<scala.collection.parallel.IterableSplitter<T>, java.lang.Object>, java.lang.Object> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike$Take;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3.$outer : Lscala/collection/parallel/ParIterableLike$Take;
    ALOAD 0
  ...
  public final apply(Lscala/Tuple2;)Z
    ...
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3.$outer : Lscala/collection/parallel/ParIterableLike$Take;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3.apply (Lscala/Tuple2;)Z
