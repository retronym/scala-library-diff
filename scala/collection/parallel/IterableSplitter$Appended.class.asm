...
// access flags 0x21
// signature <U:Ljava/lang/Object;PI::Lscala/collection/parallel/IterableSplitter<TU;>;>Ljava/lang/Object;Lscala/collection/parallel/IterableSplitter<TU;>;
// declaration: scala/collection/parallel/IterableSplitter$Appended<U, PI extends scala.collection.parallel.IterableSplitter<U>> implements scala.collection.parallel.IterableSplitter<U>
public class scala/collection/parallel/IterableSplitter$Appended implements scala/collection/parallel/IterableSplitter  {
  ...
  private Lscala/collection/parallel/IterableSplitter; curr
  ...
  // signature TPI;
  // declaration: PI
  private final Lscala/collection/parallel/IterableSplitter; that
  ...
  // declaration: void <init>(scala.collection.parallel.IterableSplitter<T>, PI)
  public <init>(Lscala/collection/parallel/IterableSplitter;Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/IterableSplitter$Appended.that : Lscala/collection/parallel/IterableSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/IterableSplitter$Appended.$outer : Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    ...
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.signalDelegate_$eq (Lscala/collection/generic/Signalling;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/IterableSplitter$Appended.curr : Lscala/collection/parallel/IterableSplitter;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/IterableSplitter<TU;>;
  // declaration: scala.collection.parallel.IterableSplitter<U> curr()
  public curr()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$Appended.curr : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature (Lscala/collection/parallel/IterableSplitter<TU;>;)V
  // declaration: void curr_$eq(scala.collection.parallel.IterableSplitter<U>)
  public curr_$eq(Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/IterableSplitter$Appended.curr : Lscala/collection/parallel/IterableSplitter;
    RETURN
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/IterableSplitter<TU;>;
  // declaration: scala.collection.parallel.IterableSplitter<U> dup()
  public dup()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.scala$collection$parallel$IterableSplitter$Appended$$$outer ()Lscala/collection/parallel/IterableSplitter;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.dup ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.that ()Lscala/collection/parallel/IterableSplitter;
  ...
  // access flags 0x1
  public firstNonEmpty()Z
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.curr ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.scala$collection$parallel$IterableSplitter$Appended$$$outer ()Lscala/collection/parallel/IterableSplitter;
    IF_ACMPNE L0
    ALOAD 0
  ...
  public hasNext()Z
   ...
   L0
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.that ()Lscala/collection/parallel/IterableSplitter;
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.curr_$eq (Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.curr ()Lscala/collection/parallel/IterableSplitter;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.hasNext ()Z
    GOTO L1
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function1<TU;TS;>;)Lscala/collection/parallel/IterableSplitter<TU;>.Mapped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<U>.Mapped<S> map<S>(scala.Function1<U, S>)
  ...
  public synthetic bridge map(Lscala/Function1;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.map (Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TU;>.Taken;
  // declaration: scala.collection.parallel.IterableSplitter<U>.Taken newTaken(int)
  ...
  public next()Ljava/lang/Object;
    ...
    IF_ACMPNE L0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.hasNext ()Z
    POP
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.curr ()Lscala/collection/parallel/IterableSplitter;
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$IterableSplitter$Appended$$$outer()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$Appended.$outer : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate()Lscala/collection/generic/Signalling;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$Appended.signalDelegate : Lscala/collection/generic/Signalling;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/parallel/IterableSplitter<TU;>;
  // declaration: scala.collection.parallel.IterableSplitter<U> slice(int, int)
  ...
  public synthetic bridge slice(II)Lscala/collection/Iterator;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.slice (II)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TU;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<U>> split()
  public split()Lscala/collection/Seq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.firstNonEmpty ()Z
    IFEQ L0
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TU;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<U>> splitWithSignalling()
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TU;>;
  // declaration: scala.collection.parallel.IterableSplitter<U> take(int)
  ...
  public synthetic bridge take(I)Lscala/collection/Iterator;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.take (I)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // signature ()TPI;
  // declaration: PI that()
  public that()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$Appended.that : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Appended.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;U:Ljava/lang/Object;R:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;TU;TR;)Lscala/collection/parallel/IterableSplitter<TU;>.ZippedAll<TU;TR;>;
  // declaration: scala.collection.parallel.IterableSplitter<U>.ZippedAll<U, R> zipAllParSeq<S, U, R>(scala.collection.parallel.SeqSplitter<S>, U, R)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;)Lscala/collection/parallel/IterableSplitter<TU;>.Zipped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<U>.Zipped<S> zipParSeq<S>(scala.collection.parallel.SeqSplitter<S>)
