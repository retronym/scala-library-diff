...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$span$1 extends scala.runtime.AbstractFunction1<scala.Tuple2<scala.collection.parallel.Combiner<T, Repr>, scala.collection.parallel.Combiner<T, Repr>>, scala.Tuple2<Repr, Repr>> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$span$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$span$1.apply (Lscala/Tuple2;)Lscala/Tuple2;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
