...
// access flags 0x21
// signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Transformer<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Take<TU;TThis;>;>;
// declaration: scala/collection/parallel/ParIterableLike$Take<U, This> implements scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Transformer<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Take<U, This>>
public class scala/collection/parallel/ParIterableLike$Take implements scala/collection/parallel/ParIterableLike$Transformer  {
  ...
  // access flags 0x11
  public final INNERCLASS scala/collection/parallel/ParIterableLike$Take$$anonfun$12 null null
  // access flags 0x11
  public final INNERCLASS scala/collection/parallel/ParIterableLike$Take$$anonfun$split$2 null null
  // access flags 0x11
  public final INNERCLASS scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3 null null
  // access flags 0x11
  ...
  public final Lscala/collection/parallel/CombinerFactory; scala$collection$parallel$ParIterableLike$Take$$cbf

  // access flags 0x11
  public final I scala$collection$parallel$ParIterableLike$Take$$n
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike;ILscala/collection/parallel/CombinerFactory;Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ILOAD 2
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.scala$collection$parallel$ParIterableLike$Take$$n : I
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.scala$collection$parallel$ParIterableLike$Take$$cbf : Lscala/collection/parallel/CombinerFactory;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.pit : Lscala/collection/parallel/IterableSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.$outer : Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    ...
    ALOAD 0
    ACONST_NULL
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.result : Lscala/collection/parallel/Combiner;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 5
  ...
  public leaf(Lscala/Option;)V
    ALOAD 0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.pit ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    ...
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.take2combiner (ILscala/collection/parallel/Combiner;)Lscala/collection/parallel/Combiner;
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.result_$eq (Lscala/collection/parallel/Combiner;)V
    RETURN
    MAXSTACK = 6
    MAXLOCALS = 2
  ...
  // declaration: void merge(scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Take<U, This>)
  public merge(Lscala/collection/parallel/ParIterableLike$Take;)V
    ALOAD 0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.result ()Lscala/collection/parallel/Combiner;
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.result ()Lscala/collection/parallel/Combiner;
  ...
  public synthetic bridge merge(Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    CHECKCAST scala/collection/parallel/ParIterableLike$Take
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.merge (Lscala/collection/parallel/ParIterableLike$Take;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Take.newSubtask (Lscala/collection/parallel/IterableSplitter;)Lscala/runtime/Nothing$;
    ATHROW
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pit()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Take.pit : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public result()Lscala/collection/parallel/Combiner;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Take.result : Lscala/collection/parallel/Combiner;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParIterableLike$Take$$$outer()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Take.$outer : Lscala/collection/parallel/ParIterableLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/Task<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Take<TU;TThis;>;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.Task<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Take<U, This>>> split()
  public split()Lscala/collection/Seq;
    ...
    NEW scala/collection/parallel/ParIterableLike$Take$$anonfun$12
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParIterableLike$Take$$anonfun$12.<init> (Lscala/collection/parallel/ParIterableLike$Take;)V
    ...
    NEW scala/collection/parallel/ParIterableLike$Take$$anonfun$split$2
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParIterableLike$Take$$anonfun$split$2.<init> (Lscala/collection/parallel/ParIterableLike$Take;)V
    INVOKEINTERFACE scala/collection/TraversableLike.withFilter (Lscala/Function1;)Lscala/collection/generic/FilterMonadic;
    NEW scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParIterableLike$Take$$anonfun$split$3.<init> (Lscala/collection/parallel/ParIterableLike$Take;)V
    ...
    NEW scala/collection/parallel/ParIterableLike$Take$$anonfun$split$4
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParIterableLike$Take$$anonfun$split$4.<init> (Lscala/collection/parallel/ParIterableLike$Take;)V
    GETSTATIC scala/collection/Seq$.MODULE$ : Lscala/collection/Seq$;
    INVOKEVIRTUAL scala/collection/Seq$.canBuildFrom ()Lscala/collection/generic/CanBuildFrom;
  ...
  public throwable()Ljava/lang/Throwable;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Take.throwable : Ljava/lang/Throwable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public throwable_$eq(Ljava/lang/Throwable;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Take.throwable : Ljava/lang/Throwable;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
