...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$take$1 extends scala.runtime.AbstractFunction1<scala.collection.parallel.Combiner<T, Repr>, Repr> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$take$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/parallel/ParIterableLike take (I)Lscala/collection/parallel/ParIterable;
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$take$1.apply (Lscala/collection/parallel/Combiner;)Lscala/collection/parallel/ParIterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
