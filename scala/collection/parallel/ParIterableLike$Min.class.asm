...
// access flags 0x21
// signature <U:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Accessor<Lscala/Option<TU;>;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Min<TU;>;>;
// declaration: scala/collection/parallel/ParIterableLike$Min<U> implements scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Accessor<scala.Option<U>, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Min<U>>
public class scala/collection/parallel/ParIterableLike$Min implements scala/collection/parallel/ParIterableLike$Accessor  {
  ...
  public <init>(Lscala/collection/parallel/ParIterableLike;Lscala/math/Ordering;Lscala/collection/parallel/IterableSplitter;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParIterableLike$Min.ord : Lscala/math/Ordering;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/parallel/ParIterableLike$Min.pit : Lscala/collection/parallel/IterableSplitter;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Min.$outer : Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    ...
    PUTFIELD scala/collection/parallel/ParIterableLike$Min.result : Lscala/Option;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 4
  ...
  public leaf(Lscala/Option;)V
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.pit ()Lscala/collection/parallel/IterableSplitter;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.pit ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.ord : Lscala/math/Ordering;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.min (Lscala/math/Ordering;)Ljava/lang/Object;
    INVOKESPECIAL scala/Some.<init> (Ljava/lang/Object;)V
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.result_$eq (Lscala/Option;)V
   L0
    RETURN
    MAXSTACK = 5
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Min<TU;>;)V
  // declaration: void merge(scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Min<U>)
  public merge(Lscala/collection/parallel/ParIterableLike$Min;)V
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.result ()Lscala/Option;
    GETSTATIC scala/None$.MODULE$ : Lscala/None$;
    ASTORE 2
    DUP
    IFNONNULL L0
  ...
  public synthetic bridge merge(Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    CHECKCAST scala/collection/parallel/ParIterableLike$Min
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.merge (Lscala/collection/parallel/ParIterableLike$Min;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/collection/parallel/IterableSplitter<TT;>;)Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Min<TU;>;
  // declaration: scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Min<U> newSubtask(scala.collection.parallel.IterableSplitter<T>)
  public newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Min;
    NEW scala/collection/parallel/ParIterableLike$Min
    DUP
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.scala$collection$parallel$ParIterableLike$Min$$$outer ()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.ord : Lscala/math/Ordering;
    ALOAD 1
  ...
  public synthetic bridge newSubtask(Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Accessor;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$Min.newSubtask (Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/ParIterableLike$Min;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pit()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.pit : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public result()Lscala/Option;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.result : Lscala/Option;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$ParIterableLike$Min$$$outer()Lscala/collection/parallel/ParIterableLike;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.$outer : Lscala/collection/parallel/ParIterableLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/Task<Lscala/Option<TU;>;Lscala/collection/parallel/ParIterableLike<TT;TRepr;TSequential;>.Min<TU;>;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.Task<scala.Option<U>, scala.collection.parallel.ParIterableLike<T, Repr, Sequential>.Min<U>>> split()
  ...
  public throwable()Ljava/lang/Throwable;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParIterableLike$Min.throwable : Ljava/lang/Throwable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public throwable_$eq(Ljava/lang/Throwable;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParIterableLike$Min.throwable : Ljava/lang/Throwable;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
