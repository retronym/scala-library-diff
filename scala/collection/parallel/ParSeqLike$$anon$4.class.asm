...
// access flags 0x31
public final class scala/collection/parallel/ParSeqLike$$anon$4 extends scala/collection/generic/DefaultSignalling  implements scala/collection/generic/AtomicIndexFlag  {

  OUTERCLASS scala/collection/parallel/ParSeqLike indexWhere (Lscala/Function1;I)I
  // access flags 0x11
  ...
  public scala$collection$generic$AtomicIndexFlag$$intflag()Ljava/util/concurrent/atomic/AtomicInteger;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParSeqLike$$anon$4.scala$collection$generic$AtomicIndexFlag$$intflag : Ljava/util/concurrent/atomic/AtomicInteger;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public scala$collection$generic$AtomicIndexFlag$_setter_$scala$collection$generic$AtomicIndexFlag$$intflag_$eq(Ljava/util/concurrent/atomic/AtomicInteger;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParSeqLike$$anon$4.scala$collection$generic$AtomicIndexFlag$$intflag : Ljava/util/concurrent/atomic/AtomicInteger;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
