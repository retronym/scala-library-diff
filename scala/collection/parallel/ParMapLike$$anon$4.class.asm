...
// access flags 0x31
// signature Ljava/lang/Object;Lscala/collection/parallel/IterableSplitter<TV;>;
...
public final class scala/collection/parallel/ParMapLike$$anon$4 implements scala/collection/parallel/IterableSplitter  {
  ...
  // access flags 0x11
  public final INNERCLASS scala/collection/parallel/ParMapLike$$anon$4$$anonfun$2 null null
  // access flags 0x11
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TV;TB;TB;>;)TB;
  // declaration: B $colon$bslash<B>(B, scala.Function2<V, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TV;TB;>;)TB;
  // declaration: B $div$colon<B>(B, scala.Function2<B, V, B>)
  ...
  public <init>(Lscala/collection/parallel/ParMapLike;Lscala/collection/parallel/IterableSplitter;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$4.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    ...
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$4.iter : Lscala/collection/parallel/IterableSplitter;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function0<TB;>;Lscala/Function2<TB;TV;TB;>;Lscala/Function2<TB;TB;TB;>;)TB;
  // declaration: B aggregate<B>(scala.Function0<B>, scala.Function2<B, V, B>, scala.Function2<B, B, B>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;PI::Lscala/collection/parallel/IterableSplitter<TU;>;>(TPI;)Lscala/collection/parallel/IterableSplitter<TV;>.Appended<TU;TPI;>;
  // declaration: scala.collection.parallel.IterableSplitter<V>.Appended<U, PI> appendParIterable<U, PI extends scala.collection.parallel.IterableSplitter<U>>(PI)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/BufferedIterator<TV;>;
  // declaration: scala.collection.BufferedIterator<V> buffered()
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<TV;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> collect<B>(scala.PartialFunction<V, B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/PartialFunction<TV;TS;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> collect2combiner<S, That>(scala.PartialFunction<V, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<TV;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> collectFirst<B>(scala.PartialFunction<V, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/GenTraversableOnce<TB;>;Lscala/Function2<TV;TB;Ljava/lang/Object;>;)Z
  // declaration: boolean corresponds<B>(scala.collection.GenTraversableOnce<B>, scala.Function2<V, B, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> drop(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> dropWhile(scala.Function1<V, java.lang.Object>)
  ...
  // declaration: scala.collection.parallel.IterableSplitter<V> dup()
  public dup()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$4.$outer : Lscala/collection/parallel/ParMapLike;
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$4.iter ()Lscala/collection/parallel/IterableSplitter;
  ...
  // access flags 0x1
  // signature ()Lscala/Tuple2<Lscala/collection/Iterator<TV;>;Lscala/collection/Iterator<TV;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<V>, scala.collection.Iterator<V>> duplicate()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> filter(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TV;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filter2combiner<U, This>(scala.Function1<V, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> filterNot(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TV;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filterNot2combiner<U, This>(scala.Function1<V, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TV;Lscala/collection/GenTraversableOnce<TB;>;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> flatMap<B>(scala.Function1<V, scala.collection.GenTraversableOnce<B>>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<TV;Lscala/collection/GenTraversableOnce<TS;>;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> flatmap2combiner<S, That>(scala.Function1<V, scala.collection.GenTraversableOnce<S>>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TV;TB;>;)TB;
  // declaration: B foldLeft<B>(B, scala.Function2<B, V, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TV;TB;TB;>;)TB;
  // declaration: B foldRight<B>(B, scala.Function2<V, B, B>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TV;TU;>;)V
  // declaration: void foreach<U>(scala.Function1<V, U>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(I)Lscala/collection/Iterator<TV;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<V>.GroupedIterator<B> grouped<B>(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)I
  // declaration: int indexWhere(scala.Function1<V, java.lang.Object>)
  ...
  private iter()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$4.iter : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function1<TV;TS;>;)Lscala/collection/parallel/IterableSplitter<TV;>.Mapped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<V>.Mapped<S> map<S>(scala.Function1<V, S>)
  ...
  public synthetic bridge map(Lscala/Function1;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.map (Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<TV;TS;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> map2combiner<S, That>(scala.Function1<V, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TV;TB;>;Lscala/math/Ordering<TB;>;)TV;
  // declaration: V maxBy<B>(scala.Function1<V, B>, scala.math.Ordering<B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<TV;TB;>;Lscala/math/Ordering<TB;>;)TV;
  // declaration: V minBy<B>(scala.Function1<V, B>, scala.math.Ordering<B>)
  ...
  // access flags 0x1
  // signature <U:Lscala/collection/parallel/IterableSplitter<TV;>.Taken;>(TU;I)TU;
  // declaration: U newSliceInternal<U extends scala.collection.parallel.IterableSplitter<V>.Taken>(U, int)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TV;>.Taken;
  // declaration: scala.collection.parallel.IterableSplitter<V>.Taken newTaken(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<TV;>;Lscala/collection/Iterator<TV;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<V>, scala.collection.Iterator<V>> partition(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TV;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> partition2combiners<U, This>(scala.Function1<V, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;TV;TB;>;)TB;
  // declaration: B reduceLeft<B>(scala.Function2<B, V, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;TV;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceLeftOption<B>(scala.Function2<B, V, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TV;TB;TB;>;)TB;
  // declaration: B reduceRight<B>(scala.Function2<V, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TV;TB;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceRightOption<B>(scala.Function2<V, B, B>)
  ...
  // declaration: scala.collection.immutable.List<V> reversed()
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TV;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanLeft<B>(B, scala.Function2<B, V, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TV;TB;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanRight<B>(B, scala.Function2<V, B, B>)
  ...
  // declaration: scala.collection.Iterator<V> seq()
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate()Lscala/collection/generic/Signalling;
    ALOAD 0
    GETFIELD scala/collection/parallel/ParMapLike$$anon$4.signalDelegate : Lscala/collection/generic/Signalling;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate_$eq(Lscala/collection/generic/Signalling;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/ParMapLike$$anon$4.signalDelegate : Lscala/collection/generic/Signalling;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/parallel/IterableSplitter<TV;>;
  // declaration: scala.collection.parallel.IterableSplitter<V> slice(int, int)
  ...
  public synthetic bridge slice(II)Lscala/collection/Iterator;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.slice (II)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(II)Lscala/collection/Iterator<TV;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<V>.GroupedIterator<B> sliding<B>(int, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<TV;>;Lscala/collection/Iterator<TV;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<V>, scala.collection.Iterator<V>> span(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TV;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> span2combiners<U, This>(scala.Function1<V, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TV;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<V>> split()
  public split()Lscala/collection/Seq;
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$4.iter ()Lscala/collection/parallel/IterableSplitter;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.split ()Lscala/collection/Seq;
    NEW scala/collection/parallel/ParMapLike$$anon$4$$anonfun$2
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$4$$anonfun$2.<init> (Lscala/collection/parallel/ParMapLike$$anon$4;)V
    ...
    ASTORE 1
    ALOAD 1
    NEW scala/collection/parallel/ParMapLike$$anon$4$$anonfun$split$2
    DUP
    ALOAD 0
    INVOKESPECIAL scala/collection/parallel/ParMapLike$$anon$4$$anonfun$split$2.<init> (Lscala/collection/parallel/ParMapLike$$anon$4;)V
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<TV;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<V>> splitWithSignalling()
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<TV;>;
  // declaration: scala.collection.parallel.IterableSplitter<V> take(int)
  ...
  public synthetic bridge take(I)Lscala/collection/Iterator;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.take (I)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> takeWhile(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<TV;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Ljava/lang/Object;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, java.lang.Object> takeWhile2combiner<U, This>(scala.Function1<V, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // declaration: scala.collection.Iterable<V> toIterable()
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <T:Ljava/lang/Object;U:Ljava/lang/Object;>(Lscala/Predef$$less$colon$less<TV;Lscala/Tuple2<TT;TU;>;>;)Lscala/collection/immutable/Map<TT;TU;>;
  // declaration: scala.collection.immutable.Map<T, U> toMap<T, U>(scala.Predef$$less$colon$less<V, scala.Tuple2<T, U>>)
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature ()Lscala/collection/Seq<TV;>;
  // declaration: scala.collection.Seq<V> toSeq()
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Traversable<TV;>;
  // declaration: scala.collection.Traversable<V> toTraversable()
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/ParMapLike$$anon$4.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (Lscala/Function1<TV;Ljava/lang/Object;>;)Lscala/collection/Iterator<TV;>;
  // declaration: scala.collection.Iterator<V> withFilter(scala.Function1<V, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/Iterator<TB;>;)Lscala/collection/Iterator<Lscala/Tuple2<TV;TB;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<V, B>> zip<B>(scala.collection.Iterator<B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;U:Ljava/lang/Object;R:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;TU;TR;)Lscala/collection/parallel/IterableSplitter<TV;>.ZippedAll<TU;TR;>;
  // declaration: scala.collection.parallel.IterableSplitter<V>.ZippedAll<U, R> zipAllParSeq<S, U, R>(scala.collection.parallel.SeqSplitter<S>, U, R)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;)Lscala/collection/parallel/IterableSplitter<TV;>.Zipped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<V>.Zipped<S> zipParSeq<S>(scala.collection.parallel.SeqSplitter<S>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<TV;Ljava/lang/Object;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<V, java.lang.Object>> zipWithIndex()
