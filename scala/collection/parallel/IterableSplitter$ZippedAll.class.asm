...
// access flags 0x21
// signature <U:Ljava/lang/Object;S:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;
// declaration: scala/collection/parallel/IterableSplitter$ZippedAll<U, S> implements scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>
public class scala/collection/parallel/IterableSplitter$ZippedAll implements scala/collection/parallel/IterableSplitter  {
  ...
  private final Lscala/collection/parallel/SeqSplitter; that
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;TB;>;)TB;
  // declaration: B $colon$bslash<B>(B, scala.Function2<scala.Tuple2<U, S>, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;)TB;
  // declaration: B $div$colon<B>(B, scala.Function2<B, scala.Tuple2<U, S>, B>)
  ...
  // declaration: void <init>(scala.collection.parallel.IterableSplitter<T>, scala.collection.parallel.SeqSplitter<S>, U, S)
  public <init>(Lscala/collection/parallel/IterableSplitter;Lscala/collection/parallel/SeqSplitter;Ljava/lang/Object;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/parallel/IterableSplitter$ZippedAll.that : Lscala/collection/parallel/SeqSplitter;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/parallel/IterableSplitter$ZippedAll.thiselem : Ljava/lang/Object;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/parallel/IterableSplitter$ZippedAll.thatelem : Ljava/lang/Object;
    ALOAD 1
    IFNONNULL L0
    ACONST_NULL
    ATHROW
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/parallel/IterableSplitter$ZippedAll.$outer : Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    ...
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.signalDelegate_$eq (Lscala/collection/generic/Signalling;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 5
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function0<TB;>;Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;Lscala/Function2<TB;TB;TB;>;)TB;
  // declaration: B aggregate<B>(scala.Function0<B>, scala.Function2<B, scala.Tuple2<U, S>, B>, scala.Function2<B, B, B>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;PI::Lscala/collection/parallel/IterableSplitter<TU;>;>(TPI;)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.Appended<TU;TPI;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.Appended<U, PI> appendParIterable<U, PI extends scala.collection.parallel.IterableSplitter<U>>(PI)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/BufferedIterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.BufferedIterator<scala.Tuple2<U, S>> buffered()
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/Tuple2<TU;TS;>;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> collect<B>(scala.PartialFunction<scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/Tuple2<TU;TS;>;TS;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> collect2combiner<S, That>(scala.PartialFunction<scala.Tuple2<U, S>, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/Tuple2<TU;TS;>;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> collectFirst<B>(scala.PartialFunction<scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/GenTraversableOnce<TB;>;Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;Ljava/lang/Object;>;)Z
  // declaration: boolean corresponds<B>(scala.collection.GenTraversableOnce<B>, scala.Function2<scala.Tuple2<U, S>, B, java.lang.Object>)
  ...
  // declaration: int count(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> drop(int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> dropWhile(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>> dup()
  public dup()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.scala$collection$parallel$IterableSplitter$ZippedAll$$$outer ()Lscala/collection/parallel/IterableSplitter;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.dup ()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.that ()Lscala/collection/parallel/SeqSplitter;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.thiselem ()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.thatelem ()Ljava/lang/Object;
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.zipAllParSeq (Lscala/collection/parallel/SeqSplitter;Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/parallel/IterableSplitter$ZippedAll;
    ARETURN
    MAXSTACK = 4
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/Tuple2<Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<scala.Tuple2<U, S>>, scala.collection.Iterator<scala.Tuple2<U, S>>> duplicate()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Z
  // declaration: boolean exists(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> filter(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filter2combiner<U, This>(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> filterNot(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/collection/parallel/Combiner<TU;TThis;>;
  // declaration: scala.collection.parallel.Combiner<U, This> filterNot2combiner<U, This>(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/Option<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.Option<scala.Tuple2<U, S>> find(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Lscala/collection/GenTraversableOnce<TB;>;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> flatMap<B>(scala.Function1<scala.Tuple2<U, S>, scala.collection.GenTraversableOnce<B>>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Lscala/collection/GenTraversableOnce<TS;>;>;Lscala/collection/parallel/Combiner<TS;TThat;>;)Lscala/collection/parallel/Combiner<TS;TThat;>;
  // declaration: scala.collection.parallel.Combiner<S, That> flatmap2combiner<S, That>(scala.Function1<scala.Tuple2<U, S>, scala.collection.GenTraversableOnce<S>>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;)TB;
  // declaration: B foldLeft<B>(B, scala.Function2<B, scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;TB;>;)TB;
  // declaration: B foldRight<B>(B, scala.Function2<scala.Tuple2<U, S>, B, B>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Z
  // declaration: boolean forall(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;TU;>;)V
  // declaration: void foreach<U>(scala.Function1<scala.Tuple2<U, S>, U>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(I)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>>.GroupedIterator<B> grouped<B>(int)
  ...
  public hasNext()Z
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.that ()Lscala/collection/parallel/SeqSplitter;
    INVOKEINTERFACE scala/collection/parallel/SeqSplitter.hasNext ()Z
    IFEQ L1
   L0
    ICONST_1
    GOTO L2
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;TS;>;)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.Mapped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.Mapped<S> map<S>(scala.Function1<scala.Tuple2<U, S>, S>)
  ...
  public synthetic bridge map(Lscala/Function1;)Lscala/collection/Iterator;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.map (Lscala/Function1;)Lscala/collection/parallel/IterableSplitter$Mapped;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // declaration: scala.collection.parallel.Combiner<S, That> map2combiner<S, That>(scala.Function1<scala.Tuple2<U, S>, S>, scala.collection.parallel.Combiner<S, That>)
  ...
  // access flags 0x1
  // signature <U:Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.Taken;>(TU;I)TU;
  // declaration: U newSliceInternal<U extends scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.Taken>(U, int)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.Taken;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.Taken newTaken(int)
  ...
  // access flags 0x1
  // signature ()Lscala/Tuple2<TU;TS;>;
  // declaration: scala.Tuple2<U, S> next()
  public next()Lscala/Tuple2;
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.that ()Lscala/collection/parallel/SeqSplitter;
    INVOKEINTERFACE scala/collection/parallel/SeqSplitter.next ()Ljava/lang/Object;
  ...
  public synthetic bridge next()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.next ()Lscala/Tuple2;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<scala.Tuple2<U, S>>, scala.collection.Iterator<scala.Tuple2<U, S>>> partition(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> partition2combiners<U, This>(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;)TB;
  // declaration: B reduceLeft<B>(scala.Function2<B, scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceLeftOption<B>(scala.Function2<B, scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;TB;>;)TB;
  // declaration: B reduceRight<B>(scala.Function2<scala.Tuple2<U, S>, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceRightOption<B>(scala.Function2<scala.Tuple2<U, S>, B, B>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/List<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.immutable.List<scala.Tuple2<U, S>> reversed()
  ...
  // access flags 0x1001
  public synthetic scala$collection$parallel$IterableSplitter$ZippedAll$$$outer()Lscala/collection/parallel/IterableSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$ZippedAll.$outer : Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/Tuple2<TU;TS;>;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanLeft<B>(B, scala.Function2<B, scala.Tuple2<U, S>, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/Tuple2<TU;TS;>;TB;TB;>;)Lscala/collection/Iterator<TB;>;
  // declaration: scala.collection.Iterator<B> scanRight<B>(B, scala.Function2<scala.Tuple2<U, S>, B, B>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> seq()
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.seq ()Lscala/collection/Iterator;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public signalDelegate()Lscala/collection/generic/Signalling;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$ZippedAll.signalDelegate : Lscala/collection/generic/Signalling;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>> slice(int, int)
  ...
  public synthetic bridge slice(II)Lscala/collection/Iterator;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.slice (II)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(II)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>.GroupedIterator<TB;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>>.GroupedIterator<B> sliding<B>(int, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/Tuple2<Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;>;
  // declaration: scala.Tuple2<scala.collection.Iterator<scala.Tuple2<U, S>>, scala.collection.Iterator<scala.Tuple2<U, S>>> span(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Lscala/collection/parallel/Combiner<TU;TThis;>;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>> span2combiners<U, This>(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>, scala.collection.parallel.Combiner<U, This>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>> split()
  public split()Lscala/collection/Seq;
    ...
    INVOKEINTERFACE scala/collection/parallel/IterableSplitter.appendParIterable (Lscala/collection/parallel/IterableSplitter;)Lscala/collection/parallel/IterableSplitter$Appended;
    GOTO L1
   L0
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.scala$collection$parallel$IterableSplitter$ZippedAll$$$outer ()Lscala/collection/parallel/IterableSplitter;
   ...
   L3
    ...
    ASTORE 5
    ALOAD 5
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$Zipped.split ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 5
    MAXLOCALS = 6
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;>;
  // declaration: scala.collection.Seq<scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>> splitWithSignalling()
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>> take(int)
  ...
  public synthetic bridge take(I)Lscala/collection/Iterator;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.take (I)Lscala/collection/parallel/IterableSplitter;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> takeWhile(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;This:Ljava/lang/Object;>(Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;Lscala/collection/parallel/Combiner<TU;TThis;>;)Lscala/Tuple2<Lscala/collection/parallel/Combiner<TU;TThis;>;Ljava/lang/Object;>;
  // declaration: scala.Tuple2<scala.collection.parallel.Combiner<U, This>, java.lang.Object> takeWhile2combiner<U, This>(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>, scala.collection.parallel.Combiner<U, This>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/SeqSplitter<TS;>;
  // declaration: scala.collection.parallel.SeqSplitter<S> that()
  public that()Lscala/collection/parallel/SeqSplitter;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$ZippedAll.that : Lscala/collection/parallel/SeqSplitter;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()TS;
  // declaration: S thatelem()
  public thatelem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$ZippedAll.thatelem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()TU;
  // declaration: U thiselem()
  public thiselem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/parallel/IterableSplitter$ZippedAll.thiselem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature <Col:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<Lscala/runtime/Nothing$;Lscala/Tuple2<TU;TS;>;TCol;>;)TCol;
  // declaration: Col to<Col>(scala.collection.generic.CanBuildFrom<scala.runtime.Nothing$, scala.Tuple2<U, S>, Col>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/IndexedSeq<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.immutable.IndexedSeq<scala.Tuple2<U, S>> toIndexedSeq()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterable<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterable<scala.Tuple2<U, S>> toIterable()
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> toIterator()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/List<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.immutable.List<scala.Tuple2<U, S>> toList()
  ...
  // access flags 0x1
  // signature <T:Ljava/lang/Object;U:Ljava/lang/Object;>(Lscala/Predef$$less$colon$less<Lscala/Tuple2<TU;TS;>;Lscala/Tuple2<TT;TU;>;>;)Lscala/collection/immutable/Map<TT;TU;>;
  // declaration: scala.collection.immutable.Map<T, U> toMap<T, U>(scala.Predef$$less$colon$less<scala.Tuple2<U, S>, scala.Tuple2<T, U>>)
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Seq<scala.Tuple2<U, S>> toSeq()
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/immutable/Stream<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.immutable.Stream<scala.Tuple2<U, S>> toStream()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Traversable<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Traversable<scala.Tuple2<U, S>> toTraversable()
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/parallel/IterableSplitter$ZippedAll.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/immutable/Vector<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.immutable.Vector<scala.Tuple2<U, S>> toVector()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;)Lscala/collection/Iterator<Lscala/Tuple2<TU;TS;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<U, S>> withFilter(scala.Function1<scala.Tuple2<U, S>, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/Iterator<TB;>;)Lscala/collection/Iterator<Lscala/Tuple2<Lscala/Tuple2<TU;TS;>;TB;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<scala.Tuple2<U, S>, B>> zip<B>(scala.collection.Iterator<B>)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;U:Ljava/lang/Object;R:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;TU;TR;)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.ZippedAll<TU;TR;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.ZippedAll<U, R> zipAllParSeq<S, U, R>(scala.collection.parallel.SeqSplitter<S>, U, R)
  ...
  // access flags 0x1
  // signature <S:Ljava/lang/Object;>(Lscala/collection/parallel/SeqSplitter<TS;>;)Lscala/collection/parallel/IterableSplitter<Lscala/Tuple2<TU;TS;>;>.Zipped<TS;>;
  // declaration: scala.collection.parallel.IterableSplitter<scala.Tuple2<U, S>>.Zipped<S> zipParSeq<S>(scala.collection.parallel.SeqSplitter<S>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/Tuple2<Lscala/Tuple2<TU;TS;>;Ljava/lang/Object;>;>;
  // declaration: scala.collection.Iterator<scala.Tuple2<scala.Tuple2<U, S>, java.lang.Object>> zipWithIndex()
