...
// declaration: scala/collection/parallel/ParIterableLike$$anonfun$$plus$plus$2 extends scala.runtime.AbstractFunction1<scala.collection.parallel.Combiner<U, That>, That> implements scala.Serializable
public final class scala/collection/parallel/ParIterableLike$$anonfun$$plus$plus$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/parallel/ParIterableLike$$anonfun$$plus$plus$2.apply (Lscala/collection/parallel/Combiner;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
