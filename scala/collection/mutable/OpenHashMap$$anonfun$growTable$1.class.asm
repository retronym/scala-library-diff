...
// declaration: scala/collection/mutable/OpenHashMap$$anonfun$growTable$1 extends scala.runtime.AbstractFunction1<scala.collection.mutable.OpenHashMap$OpenEntry<Key, Value>, scala.runtime.BoxedUnit> implements scala.Serializable
public final class scala/collection/mutable/OpenHashMap$$anonfun$growTable$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/mutable/OpenHashMap growTable ()V
  // access flags 0x19
  ...
  public <init>(Lscala/collection/mutable/OpenHashMap;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/mutable/OpenHashMap$$anonfun$growTable$1.$outer : Lscala/collection/mutable/OpenHashMap;
    ALOAD 0
  ...
  public final apply(Lscala/collection/mutable/OpenHashMap$OpenEntry;)V
   ...
   L2
    ALOAD 0
    GETFIELD scala/collection/mutable/OpenHashMap$$anonfun$growTable$1.$outer : Lscala/collection/mutable/OpenHashMap;
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/OpenHashMap.scala$collection$mutable$OpenHashMap$$addEntry (Lscala/collection/mutable/OpenHashMap$OpenEntry;)V
   L0
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 3
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/mutable/OpenHashMap$$anonfun$growTable$1.apply (Lscala/collection/mutable/OpenHashMap$OpenEntry;)V
