...
// declaration: scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1 extends scala.runtime.AbstractFunction1<T, scala.runtime.BoxedUnit> implements scala.Serializable
public final class scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  // access flags 0x12
  private final Lscala/runtime/ObjectRef; curr$1
  ...
  public <init>(Lscala/collection/mutable/UnrolledBuffer$Unrolled;Lscala/runtime/ObjectRef;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1.curr$1 : Lscala/runtime/ObjectRef;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;)V
    ALOAD 0
    GETFIELD scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1.curr$1 : Lscala/runtime/ObjectRef;
    ALOAD 0
    GETFIELD scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1.curr$1 : Lscala/runtime/ObjectRef;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/UnrolledBuffer$Unrolled$$anonfun$insertAll$1.apply (Ljava/lang/Object;)V
