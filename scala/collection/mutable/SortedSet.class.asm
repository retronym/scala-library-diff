...
public abstract interface scala/collection/mutable/SortedSet implements scala/collection/SortedSet scala/collection/mutable/Set  {
  ...
  // access flags 0x401
  // signature ()Lscala/collection/mutable/SortedSet<TA;>;
  // declaration: scala.collection.mutable.SortedSet<A> empty()
  public abstract empty()Lscala/collection/mutable/SortedSet;
}
