...
// declaration: scala/collection/mutable/WrappedArray$$anon$1$$anonfun$apply$2 extends scala.runtime.AbstractFunction1<java.lang.Object, scala.collection.mutable.WrappedArray<T>> implements scala.Serializable
public final class scala/collection/mutable/WrappedArray$$anon$1$$anonfun$apply$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/mutable/WrappedArray$$anon$1 apply ()Lscala/collection/mutable/Builder;
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/WrappedArray$$anon$1$$anonfun$apply$2.apply (Ljava/lang/Object;)Lscala/collection/mutable/WrappedArray;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
