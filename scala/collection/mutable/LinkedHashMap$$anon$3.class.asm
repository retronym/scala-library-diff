...
// declaration: scala/collection/mutable/LinkedHashMap$$anon$3 extends scala.collection.AbstractIterator<B>
public final class scala/collection/mutable/LinkedHashMap$$anon$3 extends scala/collection/AbstractIterator  {

  OUTERCLASS scala/collection/mutable/LinkedHashMap valuesIterator ()Lscala/collection/Iterator;
  // access flags 0x11
