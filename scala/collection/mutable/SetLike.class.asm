...
// access flags 0x601
// signature <A:Ljava/lang/Object;This::Lscala/collection/mutable/SetLike<TA;TThis;>;:Lscala/collection/mutable/Set<TA;>;>Ljava/lang/Object;Lscala/collection/SetLike<TA;TThis;>;Lscala/collection/script/Scriptable<TA;>;Lscala/collection/mutable/Builder<TA;TThis;>;Lscala/collection/generic/Shrinkable<TA;>;Lscala/collection/mutable/Cloneable<Lscala/collection/mutable/Set<TA;>;>;
// declaration: scala/collection/mutable/SetLike<A, This extends scala.collection.mutable.SetLike<A, This>, scala.collection.mutable.Set<A>> extends scala.collection.SetLike<A, This>, scala.collection.script.Scriptable<A>, scala.collection.mutable.Builder<A, This>, scala.collection.generic.Shrinkable<A>, scala.collection.mutable.Cloneable<scala.collection.mutable.Set<A>>
