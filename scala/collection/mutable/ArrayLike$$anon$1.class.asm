...
// access flags 0x31
// signature Lscala/collection/AbstractSeq<Ljava/lang/Object;>;Lscala/collection/IndexedSeq<Ljava/lang/Object;>;
// declaration: scala/collection/mutable/ArrayLike$$anon$1 extends scala.collection.AbstractSeq<java.lang.Object> implements scala.collection.IndexedSeq<java.lang.Object>
public final class scala/collection/mutable/ArrayLike$$anon$1 extends scala/collection/AbstractSeq  implements scala/collection/IndexedSeq  {

  OUTERCLASS scala/collection/mutable/ArrayLike deep ()Lscala/collection/IndexedSeq;
  // access flags 0x11
  public final INNERCLASS scala/collection/mutable/ArrayLike$$anon$1 null null

  // access flags 0x1012
  private final synthetic Lscala/collection/mutable/ArrayLike; $outer

  // access flags 0x1
  // signature (Lscala/collection/mutable/ArrayLike<TA;TRepr;>;)V
  // declaration: void <init>(scala.collection.mutable.ArrayLike<A, Repr>)
  public <init>(Lscala/collection/mutable/ArrayLike;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/mutable/ArrayLike$$anon$1.$outer : Lscala/collection/mutable/ArrayLike;
    ALOAD 0
  ...
  public apply(I)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/mutable/ArrayLike$$anon$1.$outer : Lscala/collection/mutable/ArrayLike;
    ILOAD 1
    INVOKEINTERFACE scala/collection/mutable/ArrayLike.apply (I)Ljava/lang/Object;
    ASTORE 2
    ALOAD 2
    ...
    INVOKEVIRTUAL scala/collection/mutable/WrappedArray.deep ()Lscala/collection/IndexedSeq;
    ASTORE 3
    GOTO L1
   L0
    ALOAD 2
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.apply (I)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge groupBy(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.groupBy (Lscala/Function1;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge isDefinedAt(Ljava/lang/Object;)Z
    ...
    ALOAD 1
    INVOKESTATIC scala/runtime/BoxesRunTime.unboxToInt (Ljava/lang/Object;)I
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.isDefinedAt (I)Z
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public length()I
    ALOAD 0
    GETFIELD scala/collection/mutable/ArrayLike$$anon$1.$outer : Lscala/collection/mutable/ArrayLike;
    INVOKEINTERFACE scala/collection/mutable/ArrayLike.length ()I
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // declaration: scala.collection.IndexedSeq<java.lang.Object> seq()
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.seq ()Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge thisCollection()Lscala/collection/Traversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.thisCollection ()Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toCollection(Ljava/lang/Object;)Lscala/collection/Traversable;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.toCollection (Ljava/lang/Object;)Lscala/collection/IndexedSeq;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge view(II)Lscala/collection/TraversableView;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.view (II)Lscala/collection/SeqView;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge view()Lscala/collection/TraversableView;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayLike$$anon$1.view ()Lscala/collection/SeqView;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
