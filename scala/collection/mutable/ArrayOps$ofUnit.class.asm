...
public final class scala/collection/mutable/ArrayOps$ofUnit implements scala/collection/mutable/ArrayOps  {
  ...
  // access flags 0x12
  private final [Lscala/runtime/BoxedUnit; repr

  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/runtime/BoxedUnit;TB;TB;>;)TB;
  // declaration: B $colon$bslash<B>(B, scala.Function2<scala.runtime.BoxedUnit, B, B>)
  ...
  public $colon$plus(Ljava/lang/Object;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.$colon$plus (Lscala/collection/mutable/ArrayOps;Ljava/lang/Object;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3

  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(TB;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That $colon$plus<B, That>(B, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;)TB;
  // declaration: B $div$colon<B>(B, scala.Function2<B, scala.runtime.BoxedUnit, B>)
  ...
  public $plus$colon(Ljava/lang/Object;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.$plus$colon (Lscala/collection/mutable/ArrayOps;Ljava/lang/Object;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(TB;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That $plus$colon<B, That>(B, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenTraversableOnce<TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That $plus$plus<B, That>(scala.collection.GenTraversableOnce<B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/TraversableOnce<TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That $plus$plus$colon<B, That>(scala.collection.TraversableOnce<B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/Traversable<TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That $plus$plus$colon<B, That>(scala.collection.Traversable<B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  public <init>([Lscala/runtime/BoxedUnit;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/mutable/ArrayOps$ofUnit.repr : [Lscala/runtime/BoxedUnit;
    ALOAD 0
    ...
    ALOAD 0
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.$init$ (Lscala/collection/mutable/ArrayOps;)V
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function0<TB;>;Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;Lscala/Function2<TB;TB;TB;>;)TB;
  // declaration: B aggregate<B>(scala.Function0<B>, scala.Function2<B, scala.runtime.BoxedUnit, B>, scala.Function2<B, B, B>)
  ...
  // access flags 0x1
  public apply(I)V
    GETSTATIC scala/collection/mutable/ArrayOps$ofUnit$.MODULE$ : Lscala/collection/mutable/ArrayOps$ofUnit$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    ILOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.apply$extension ([Lscala/runtime/BoxedUnit;I)V
    RETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/runtime/BoxedUnit;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That collect<B, That>(scala.PartialFunction<scala.runtime.BoxedUnit, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/PartialFunction<Lscala/runtime/BoxedUnit;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> collectFirst<B>(scala.PartialFunction<scala.runtime.BoxedUnit, B>)
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> combinations(int)
  ...
  public copyToArray(Ljava/lang/Object;II)V
    ...
    ILOAD 2
    ILOAD 3
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.copyToArray (Lscala/collection/mutable/ArrayOps;Ljava/lang/Object;II)V
    RETURN
    MAXSTACK = 4
    MAXLOCALS = 4
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/collection/GenSeq<TB;>;Lscala/Function2<Lscala/runtime/BoxedUnit;TB;Ljava/lang/Object;>;)Z
  // declaration: boolean corresponds<B>(scala.collection.GenSeq<B>, scala.Function2<scala.runtime.BoxedUnit, B, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)I
  // declaration: int count(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  public equals(Ljava/lang/Object;)Z
    ...
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.equals$extension ([Lscala/runtime/BoxedUnit;Ljava/lang/Object;)Z
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 2

  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Z
  // declaration: boolean exists(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Lscala/Option<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Option<scala.runtime.BoxedUnit> find(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;Lscala/collection/GenTraversableOnce<TB;>;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That flatMap<B, That>(scala.Function1<scala.runtime.BoxedUnit, scala.collection.GenTraversableOnce<B>>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;Lscala/collection/Traversable<TU;>;>;Lscala/reflect/ClassTag<TU;>;)Ljava/lang/Object;
  // declaration:  flatten<U>(scala.Function1<scala.runtime.BoxedUnit, scala.collection.Traversable<U>>, scala.reflect.ClassTag<U>)
  public flatten(Lscala/Function1;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.flatten (Lscala/collection/mutable/ArrayOps;Lscala/Function1;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;)TB;
  // declaration: B foldLeft<B>(B, scala.Function2<B, scala.runtime.BoxedUnit, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/runtime/BoxedUnit;TB;TB;>;)TB;
  // declaration: B foldRight<B>(B, scala.Function2<scala.runtime.BoxedUnit, B, B>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Z
  // declaration: boolean forall(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;TU;>;)V
  // declaration: void foreach<U>(scala.Function1<scala.runtime.BoxedUnit, U>)
  ...
  // access flags 0x1
  // signature <K:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;TK;>;)Lscala/collection/immutable/Map<TK;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.Map<K, scala.runtime.BoxedUnit[]> groupBy<K>(scala.Function1<scala.runtime.BoxedUnit, K>)
  ...
  public synthetic bridge groupBy(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.groupBy (Lscala/Function1;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> grouped(int)
  ...
  public hashCode()I
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.hashCode$extension ([Lscala/runtime/BoxedUnit;)I
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/Option<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Option<scala.runtime.BoxedUnit> headOption()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;I)I
  // declaration: int indexWhere(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)I
  // declaration: int indexWhere(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> inits()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit> iterator()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;I)I
  // declaration: int lastIndexWhere(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)I
  // declaration: int lastIndexWhere(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature ()Lscala/Option<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Option<scala.runtime.BoxedUnit> lastOption()
  ...
  public length()I
    ...
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.length$extension ([Lscala/runtime/BoxedUnit;)I
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That map<B, That>(scala.Function1<scala.runtime.BoxedUnit, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  public newBuilder()Lscala/collection/mutable/ArrayBuilder$ofUnit;
    GETSTATIC scala/collection/mutable/ArrayOps$ofUnit$.MODULE$ : Lscala/collection/mutable/ArrayOps$ofUnit$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.newBuilder$extension ([Lscala/runtime/BoxedUnit;)Lscala/collection/mutable/ArrayBuilder$ofUnit;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(ITB;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That padTo<B, That>(int, B, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/parallel/mutable/ParArray<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.parallel.mutable.ParArray<scala.runtime.BoxedUnit> par()
  public par()Lscala/collection/parallel/mutable/ParArray;
    ALOAD 0
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.par (Lscala/collection/mutable/ArrayOps;)Lscala/collection/parallel/mutable/ParArray;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge par()Lscala/collection/Parallel;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.par ()Lscala/collection/parallel/mutable/ParArray;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/parallel/Combiner<Lscala/runtime/BoxedUnit;Lscala/collection/parallel/mutable/ParArray<Lscala/runtime/BoxedUnit;>;>;
  // declaration: scala.collection.parallel.Combiner<scala.runtime.BoxedUnit, scala.collection.parallel.mutable.ParArray<scala.runtime.BoxedUnit>> parCombiner()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Lscala/Tuple2<[Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Tuple2<scala.runtime.BoxedUnit[], scala.runtime.BoxedUnit[]> partition(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(ILscala/collection/GenSeq<TB;>;ILscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That patch<B, That>(int, scala.collection.GenSeq<B>, int, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> permutations()
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)I
  // declaration: int prefixLength(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;)TB;
  // declaration: B reduceLeft<B>(scala.Function2<B, scala.runtime.BoxedUnit, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceLeftOption<B>(scala.Function2<B, scala.runtime.BoxedUnit, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<Lscala/runtime/BoxedUnit;TB;TB;>;)TB;
  // declaration: B reduceRight<B>(scala.Function2<scala.runtime.BoxedUnit, B, B>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;>(Lscala/Function2<Lscala/runtime/BoxedUnit;TB;TB;>;)Lscala/Option<TB;>;
  // declaration: scala.Option<B> reduceRightOption<B>(scala.Function2<scala.runtime.BoxedUnit, B, B>)
  ...
  // access flags 0x1
  public repr()[Lscala/runtime/BoxedUnit;
    ALOAD 0
    GETFIELD scala/collection/mutable/ArrayOps$ofUnit.repr : [Lscala/runtime/BoxedUnit;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit> reverseIterator()
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That reverseMap<B, That>(scala.Function1<scala.runtime.BoxedUnit, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/List<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.List<scala.runtime.BoxedUnit> reversed()
  ...
  // access flags 0x1001
  public synthetic scala$collection$mutable$ArrayOps$$super$toArray(Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(TB;Lscala/Function2<TB;TB;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That scan<B, That>(B, scala.Function2<B, B, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(TB;Lscala/Function2<TB;Lscala/runtime/BoxedUnit;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That scanLeft<B, That>(B, scala.Function2<B, scala.runtime.BoxedUnit, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(TB;Lscala/Function2<Lscala/runtime/BoxedUnit;TB;TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That scanRight<B, That>(B, scala.Function2<scala.runtime.BoxedUnit, B, B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;I)I
  // declaration: int segmentLength(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>, int)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/mutable/IndexedSeq<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.mutable.IndexedSeq<scala.runtime.BoxedUnit> seq()
  public seq()Lscala/collection/mutable/IndexedSeq;
    ALOAD 0
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.seq (Lscala/collection/mutable/ArrayOps;)Lscala/collection/mutable/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.seq ()Lscala/collection/mutable/IndexedSeq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (I)Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> sliding(int)
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> sliding(int, int)
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Lscala/Tuple2<[Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Tuple2<scala.runtime.BoxedUnit[], scala.runtime.BoxedUnit[]> span(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature (I)Lscala/Tuple2<[Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.Tuple2<scala.runtime.BoxedUnit[], scala.runtime.BoxedUnit[]> splitAt(int)
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit[]> tails()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/mutable/WrappedArray<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.mutable.WrappedArray<scala.runtime.BoxedUnit> thisCollection()
  public thisCollection()Lscala/collection/mutable/WrappedArray;
    GETSTATIC scala/collection/mutable/ArrayOps$ofUnit$.MODULE$ : Lscala/collection/mutable/ArrayOps$ofUnit$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.thisCollection$extension ([Lscala/runtime/BoxedUnit;)Lscala/collection/mutable/WrappedArray;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature <Col:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<Lscala/runtime/Nothing$;Lscala/runtime/BoxedUnit;TCol;>;)TCol;
  // declaration: Col to<Col>(scala.collection.generic.CanBuildFrom<scala.runtime.Nothing$, scala.runtime.BoxedUnit, Col>)
  ...
  public toArray(Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.toArray (Lscala/collection/mutable/ArrayOps;Lscala/reflect/ClassTag;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // declaration: scala.collection.mutable.WrappedArray<scala.runtime.BoxedUnit> toCollection(scala.runtime.BoxedUnit[])
  public toCollection([Lscala/runtime/BoxedUnit;)Lscala/collection/mutable/WrappedArray;
    GETSTATIC scala/collection/mutable/ArrayOps$ofUnit$.MODULE$ : Lscala/collection/mutable/ArrayOps$ofUnit$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.repr ()[Lscala/runtime/BoxedUnit;
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.toCollection$extension ([Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;)Lscala/collection/mutable/WrappedArray;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/IndexedSeq<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.IndexedSeq<scala.runtime.BoxedUnit> toIndexedSeq()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterable<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterable<scala.runtime.BoxedUnit> toIterable()
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Iterator<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Iterator<scala.runtime.BoxedUnit> toIterator()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/immutable/List<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.List<scala.runtime.BoxedUnit> toList()
  ...
  // access flags 0x1
  // signature <T:Ljava/lang/Object;U:Ljava/lang/Object;>(Lscala/Predef$$less$colon$less<Lscala/runtime/BoxedUnit;Lscala/Tuple2<TT;TU;>;>;)Lscala/collection/immutable/Map<TT;TU;>;
  // declaration: scala.collection.immutable.Map<T, U> toMap<T, U>(scala.Predef$$less$colon$less<scala.runtime.BoxedUnit, scala.Tuple2<T, U>>)
  ...
  public synthetic bridge toMap(Lscala/Predef$$less$colon$less;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.toMap (Lscala/Predef$$less$colon$less;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature ()Lscala/collection/Seq<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Seq<scala.runtime.BoxedUnit> toSeq()
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/immutable/Stream<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.Stream<scala.runtime.BoxedUnit> toStream()
  ...
  // access flags 0x1
  // signature ()Lscala/collection/Traversable<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.Traversable<scala.runtime.BoxedUnit> toTraversable()
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/collection/immutable/Vector<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.immutable.Vector<scala.runtime.BoxedUnit> toVector()
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)[Ljava/lang/Object;
  // declaration: [] transpose<U>(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  public transpose(Lscala/Function1;)[Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.transpose (Lscala/collection/mutable/ArrayOps;Lscala/Function1;)[Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2

  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenSeq<TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That union<B, That>(scala.collection.GenSeq<B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature <T1:Ljava/lang/Object;T2:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;Lscala/Tuple2<TT1;TT2;>;>;Lscala/reflect/ClassTag<TT1;>;Lscala/reflect/ClassTag<TT2;>;)Lscala/Tuple2<Ljava/lang/Object;Ljava/lang/Object;>;
  // declaration: scala.Tuple2<java.lang.Object, java.lang.Object> unzip<T1, T2>(scala.Function1<scala.runtime.BoxedUnit, scala.Tuple2<T1, T2>>, scala.reflect.ClassTag<T1>, scala.reflect.ClassTag<T2>)
  public unzip(Lscala/Function1;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;)Lscala/Tuple2;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    ALOAD 3
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.unzip (Lscala/collection/mutable/ArrayOps;Lscala/Function1;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;)Lscala/Tuple2;
    ARETURN
    MAXSTACK = 4
    MAXLOCALS = 4

  // access flags 0x1
  // signature <T1:Ljava/lang/Object;T2:Ljava/lang/Object;T3:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/BoxedUnit;Lscala/Tuple3<TT1;TT2;TT3;>;>;Lscala/reflect/ClassTag<TT1;>;Lscala/reflect/ClassTag<TT2;>;Lscala/reflect/ClassTag<TT3;>;)Lscala/Tuple3<Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;>;
  // declaration: scala.Tuple3<java.lang.Object, java.lang.Object, java.lang.Object> unzip3<T1, T2, T3>(scala.Function1<scala.runtime.BoxedUnit, scala.Tuple3<T1, T2, T3>>, scala.reflect.ClassTag<T1>, scala.reflect.ClassTag<T2>, scala.reflect.ClassTag<T3>)
  public unzip3(Lscala/Function1;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;)Lscala/Tuple3;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    ALOAD 3
    ALOAD 4
    INVOKESTATIC scala/collection/mutable/ArrayOps$class.unzip3 (Lscala/collection/mutable/ArrayOps;Lscala/Function1;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;Lscala/reflect/ClassTag;)Lscala/Tuple3;
    ARETURN
    MAXSTACK = 5
    MAXLOCALS = 5
  ...
  public update(ILscala/runtime/BoxedUnit;)V
    ...
    ILOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit$.update$extension ([Lscala/runtime/BoxedUnit;ILscala/runtime/BoxedUnit;)V
    RETURN
    MAXSTACK = 4
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;That:Ljava/lang/Object;>(ITB;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;TB;TThat;>;)TThat;
  // declaration: That updated<B, That>(int, B, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], B, That>)
  ...
  // access flags 0x1
  // signature (II)Lscala/collection/mutable/IndexedSeqView<Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.mutable.IndexedSeqView<scala.runtime.BoxedUnit, scala.runtime.BoxedUnit[]> view(int, int)
  ...
  public synthetic bridge view(II)Lscala/collection/TraversableView;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.view (II)Lscala/collection/mutable/IndexedSeqView;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge view()Lscala/collection/TraversableView;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/mutable/ArrayOps$ofUnit.view ()Lscala/collection/mutable/IndexedSeqView;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature (Lscala/Function1<Lscala/runtime/BoxedUnit;Ljava/lang/Object;>;)Lscala/collection/generic/FilterMonadic<Lscala/runtime/BoxedUnit;[Lscala/runtime/BoxedUnit;>;
  // declaration: scala.collection.generic.FilterMonadic<scala.runtime.BoxedUnit, scala.runtime.BoxedUnit[]> withFilter(scala.Function1<scala.runtime.BoxedUnit, java.lang.Object>)
  ...
  // access flags 0x1
  // signature <A1:Ljava/lang/Object;B:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenIterable<TB;>;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;Lscala/Tuple2<TA1;TB;>;TThat;>;)TThat;
  // declaration: That zip<A1, B, That>(scala.collection.GenIterable<B>, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], scala.Tuple2<A1, B>, That>)
  ...
  // access flags 0x1
  // signature <B:Ljava/lang/Object;A1:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/GenIterable<TB;>;TA1;TB;Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;Lscala/Tuple2<TA1;TB;>;TThat;>;)TThat;
  // declaration: That zipAll<B, A1, That>(scala.collection.GenIterable<B>, A1, B, scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], scala.Tuple2<A1, B>, That>)
  ...
  // access flags 0x1
  // signature <A1:Ljava/lang/Object;That:Ljava/lang/Object;>(Lscala/collection/generic/CanBuildFrom<[Lscala/runtime/BoxedUnit;Lscala/Tuple2<TA1;Ljava/lang/Object;>;TThat;>;)TThat;
  // declaration: That zipWithIndex<A1, That>(scala.collection.generic.CanBuildFrom<scala.runtime.BoxedUnit[], scala.Tuple2<A1, java.lang.Object>, That>)
