...
// declaration: scala/collection/mutable/TreeSet$$anonfun$3 extends scala.runtime.AbstractFunction2<A, A, A> implements scala.Serializable
public final class scala/collection/mutable/TreeSet$$anonfun$3 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/mutable/TreeSet;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/mutable/TreeSet$$anonfun$3.$outer : Lscala/collection/mutable/TreeSet;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/mutable/TreeSet$$anonfun$3.$outer : Lscala/collection/mutable/TreeSet;
