...
// access flags 0x601
// signature <A:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/Seq<TA;>;Lscala/collection/IndexedSeqLike<TA;Lscala/collection/IndexedSeq<TA;>;>;
// declaration: scala/collection/IndexedSeq<A> extends scala.collection.Seq<A>, scala.collection.IndexedSeqLike<A, scala.collection.IndexedSeq<A>>
