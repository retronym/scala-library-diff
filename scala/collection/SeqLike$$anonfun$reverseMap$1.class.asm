...
// declaration: scala/collection/SeqLike$$anonfun$reverseMap$1 extends scala.runtime.AbstractFunction1<A, scala.runtime.BoxedUnit> implements scala.Serializable
public final class scala/collection/SeqLike$$anonfun$reverseMap$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/SeqLike;Lscala/runtime/ObjectRef;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/SeqLike$$anonfun$reverseMap$1.xs$2 : Lscala/runtime/ObjectRef;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;)V
    ALOAD 0
    GETFIELD scala/collection/SeqLike$$anonfun$reverseMap$1.xs$2 : Lscala/runtime/ObjectRef;
    ALOAD 0
    GETFIELD scala/collection/SeqLike$$anonfun$reverseMap$1.xs$2 : Lscala/runtime/ObjectRef;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/SeqLike$$anonfun$reverseMap$1.apply (Ljava/lang/Object;)V
