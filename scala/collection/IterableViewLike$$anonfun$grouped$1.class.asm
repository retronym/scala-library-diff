...
// declaration: scala/collection/IterableViewLike$$anonfun$grouped$1 extends scala.runtime.AbstractFunction1<scala.collection.Seq<A>, This> implements scala.Serializable
public final class scala/collection/IterableViewLike$$anonfun$grouped$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/IterableViewLike grouped (I)Lscala/collection/Iterator;
  // access flags 0x601
  ...
  public <init>(Lscala/collection/IterableViewLike;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/IterableViewLike$$anonfun$grouped$1.$outer : Lscala/collection/IterableViewLike;
    ALOAD 0
  ...
  public final apply(Lscala/collection/Seq;)Lscala/collection/IterableView;
    ALOAD 0
    GETFIELD scala/collection/IterableViewLike$$anonfun$grouped$1.$outer : Lscala/collection/IterableViewLike;
    NEW scala/collection/IterableViewLike$$anonfun$grouped$1$$anonfun$apply$1
    DUP
    ALOAD 0
    ALOAD 1
    INVOKESPECIAL scala/collection/IterableViewLike$$anonfun$grouped$1$$anonfun$apply$1.<init> (Lscala/collection/IterableViewLike$$anonfun$grouped$1;Lscala/collection/Seq;)V
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/IterableViewLike$$anonfun$grouped$1.apply (Lscala/collection/Seq;)Lscala/collection/IterableView;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
