...
// declaration: scala/collection/TraversableViewLike$$anonfun$tails$1 extends scala.runtime.AbstractFunction1<scala.collection.Seq<A>, This> implements scala.Serializable
public final class scala/collection/TraversableViewLike$$anonfun$tails$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/TraversableViewLike tails ()Lscala/collection/Iterator;
  // access flags 0x601
  ...
  public <init>(Lscala/collection/TraversableViewLike;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/TraversableViewLike$$anonfun$tails$1.$outer : Lscala/collection/TraversableViewLike;
    ALOAD 0
  ...
  public final apply(Lscala/collection/Seq;)Lscala/collection/TraversableView;
    ALOAD 0
    GETFIELD scala/collection/TraversableViewLike$$anonfun$tails$1.$outer : Lscala/collection/TraversableViewLike;
    NEW scala/collection/TraversableViewLike$$anonfun$tails$1$$anonfun$apply$4
    DUP
    ALOAD 0
    ALOAD 1
    INVOKESPECIAL scala/collection/TraversableViewLike$$anonfun$tails$1$$anonfun$apply$4.<init> (Lscala/collection/TraversableViewLike$$anonfun$tails$1;Lscala/collection/Seq;)V
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/TraversableViewLike$$anonfun$tails$1.apply (Lscala/collection/Seq;)Lscala/collection/TraversableView;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
