...
// access flags 0x601
public abstract interface scala/collection/convert/Wrappers {
  ...
  // access flags 0x401
  public abstract IterableWrapper()Lscala/collection/convert/Wrappers$IterableWrapper$;

  // access flags 0x401
  public abstract IteratorWrapper()Lscala/collection/convert/Wrappers$IteratorWrapper$;

  // access flags 0x401
  public abstract JCollectionWrapper()Lscala/collection/convert/Wrappers$JCollectionWrapper$;

  // access flags 0x401
  public abstract JConcurrentMapWrapper()Lscala/collection/convert/Wrappers$JConcurrentMapWrapper$;

  // access flags 0x401
  public abstract JDictionaryWrapper()Lscala/collection/convert/Wrappers$JDictionaryWrapper$;

  // access flags 0x401
  public abstract JEnumerationWrapper()Lscala/collection/convert/Wrappers$JEnumerationWrapper$;

  // access flags 0x401
  public abstract JIterableWrapper()Lscala/collection/convert/Wrappers$JIterableWrapper$;

  // access flags 0x401
  public abstract JIteratorWrapper()Lscala/collection/convert/Wrappers$JIteratorWrapper$;

  // access flags 0x401
  public abstract JListWrapper()Lscala/collection/convert/Wrappers$JListWrapper$;

  // access flags 0x401
  public abstract JMapWrapper()Lscala/collection/convert/Wrappers$JMapWrapper$;

  // access flags 0x401
  public abstract JPropertiesWrapper()Lscala/collection/convert/Wrappers$JPropertiesWrapper$;

  // access flags 0x401
  public abstract JSetWrapper()Lscala/collection/convert/Wrappers$JSetWrapper$;

  // access flags 0x401
  public abstract MutableBufferWrapper()Lscala/collection/convert/Wrappers$MutableBufferWrapper$;

  // access flags 0x401
  public abstract MutableMapWrapper()Lscala/collection/convert/Wrappers$MutableMapWrapper$;

  // access flags 0x401
  public abstract MutableSeqWrapper()Lscala/collection/convert/Wrappers$MutableSeqWrapper$;

  // access flags 0x401
  public abstract MutableSetWrapper()Lscala/collection/convert/Wrappers$MutableSetWrapper$;

  // access flags 0x401
  public abstract SeqWrapper()Lscala/collection/convert/Wrappers$SeqWrapper$;
}
