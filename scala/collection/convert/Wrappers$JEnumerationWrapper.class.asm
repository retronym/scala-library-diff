...
// access flags 0x21
// signature <A:Ljava/lang/Object;>Lscala/collection/AbstractIterator<TA;>;Lscala/collection/Iterator<TA;>;Lscala/Product;Lscala/Serializable;
// declaration: scala/collection/convert/Wrappers$JEnumerationWrapper<A> extends scala.collection.AbstractIterator<A> implements scala.collection.Iterator<A>, scala.Product, scala.Serializable
