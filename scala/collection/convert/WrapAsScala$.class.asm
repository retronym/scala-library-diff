...
// access flags 0x31
public final class scala/collection/convert/WrapAsScala$ implements scala/collection/convert/WrapAsScala  {


  // access flags 0x19
  public final static Lscala/collection/convert/WrapAsScala$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/collection/convert/WrapAsScala$
    INVOKESPECIAL scala/collection/convert/WrapAsScala$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/collection/convert/WrapAsScala$.MODULE$ : Lscala/collection/convert/WrapAsScala$;
    ALOAD 0
