...
public final class scala/collection/convert/WrapAsJava$ implements scala/collection/convert/WrapAsJava  {
  ...
  // access flags 0x19
  public final static Lscala/collection/convert/WrapAsJava$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/collection/convert/WrapAsJava$
    INVOKESPECIAL scala/collection/convert/WrapAsJava$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/collection/convert/WrapAsJava$.MODULE$ : Lscala/collection/convert/WrapAsJava$;
    ALOAD 0
