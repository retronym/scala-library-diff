...
// declaration: scala/collection/convert/Wrappers$JIterableWrapper<A> extends scala.collection.AbstractIterable<A> implements scala.Product, scala.Serializable
