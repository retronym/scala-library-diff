...
// declaration: scala/collection/IterableLike$$anonfun$grouped$1 extends scala.runtime.AbstractFunction1<scala.collection.Seq<A>, Repr> implements scala.Serializable
public final class scala/collection/IterableLike$$anonfun$grouped$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/IterableLike grouped (I)Lscala/collection/Iterator;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/IterableLike;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/IterableLike$$anonfun$grouped$1.$outer : Lscala/collection/IterableLike;
    ALOAD 0
  ...
  public final apply(Lscala/collection/Seq;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/IterableLike$$anonfun$grouped$1.$outer : Lscala/collection/IterableLike;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/IterableLike$$anonfun$grouped$1.apply (Lscala/collection/Seq;)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
