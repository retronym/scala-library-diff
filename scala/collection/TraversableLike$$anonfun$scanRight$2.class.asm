...
// declaration: scala/collection/TraversableLike$$anonfun$scanRight$2 extends scala.runtime.AbstractFunction1<B, scala.collection.mutable.Builder<B, That>> implements scala.Serializable
public final class scala/collection/TraversableLike$$anonfun$scanRight$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  // access flags 0x11
  public final Lscala/collection/mutable/Builder; b$7
  ...
  public <init>(Lscala/collection/TraversableLike;Lscala/collection/mutable/Builder;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableLike$$anonfun$scanRight$2.b$7 : Lscala/collection/mutable/Builder;
    ALOAD 0
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/TraversableLike$$anonfun$scanRight$2.apply (Ljava/lang/Object;)Lscala/collection/mutable/Builder;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
