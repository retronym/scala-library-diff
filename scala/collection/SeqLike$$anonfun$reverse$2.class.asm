...
// declaration: scala/collection/SeqLike$$anonfun$reverse$2 extends scala.runtime.AbstractFunction1<A, scala.collection.mutable.Builder<A, Repr>> implements scala.Serializable
public final class scala/collection/SeqLike$$anonfun$reverse$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  // access flags 0x11
  public final Lscala/collection/mutable/Builder; b$1
  ...
  public <init>(Lscala/collection/SeqLike;Lscala/collection/mutable/Builder;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/SeqLike$$anonfun$reverse$2.b$1 : Lscala/collection/mutable/Builder;
    ALOAD 0
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/SeqLike$$anonfun$reverse$2.apply (Ljava/lang/Object;)Lscala/collection/mutable/Builder;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
