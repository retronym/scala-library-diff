...
// declaration: scala/collection/immutable/Map$Map2<A, B> extends scala.collection.immutable.AbstractMap<A, B> implements scala.collection.immutable.Map<A, B>, scala.Serializable
public class scala/collection/immutable/Map$Map2 extends scala/collection/immutable/AbstractMap  implements scala/Serializable  {
  ...
  public $minus(Ljava/lang/Object;)Lscala/collection/immutable/Map;
    ALOAD 0
    GETFIELD scala/collection/immutable/Map$Map2.key1 : Ljava/lang/Object;
    ASTORE 2
    ALOAD 1
    ALOAD 2
    IF_ACMPNE L0
   ...
   L1
    ...
    DUP
    ALOAD 0
    GETFIELD scala/collection/immutable/Map$Map2.key2 : Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/immutable/Map$Map2.value2 : Ljava/lang/Object;
   ...
   L8
    ...
    GETFIELD scala/collection/immutable/Map$Map2.key1 : Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/immutable/Map$Map2.value1 : Ljava/lang/Object;
    INVOKESPECIAL scala/collection/immutable/Map$Map1.<init> (Ljava/lang/Object;Ljava/lang/Object;)V
    GOTO L6
   L12
    ALOAD 0
  ...
  public synthetic bridge $minus(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Map$Map2.$minus (Ljava/lang/Object;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public $plus(Lscala/Tuple2;)Lscala/collection/immutable/Map;
    ...
    INVOKEVIRTUAL scala/collection/immutable/Map$Map2.updated (Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  public synthetic bridge $plus(Lscala/Tuple2;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Map$Map2.$plus (Lscala/Tuple2;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (TA;TB;TA;TB;)V
  // declaration: void <init>(A, B, A, B)
  public <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/Map$Map2.key1 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/Map$Map2.value1 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/immutable/Map$Map2.key2 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/immutable/Map$Map2.value2 : Ljava/lang/Object;
    ALOAD 0
