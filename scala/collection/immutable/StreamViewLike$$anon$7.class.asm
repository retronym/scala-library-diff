...
// access flags 0x31
// signature Lscala/collection/immutable/StreamViewLike<TA;TColl;TThis;>.AbstractTransformed<TA;>;Lscala/collection/immutable/StreamViewLike<TA;TColl;TThis;>.DroppedWhile;
// declaration: scala/collection/immutable/StreamViewLike$$anon$7 extends scala.collection.immutable.StreamViewLike<A, Coll, This>.AbstractTransformed<A> implements scala.collection.immutable.StreamViewLike<A, Coll, This>.DroppedWhile
public final class scala/collection/immutable/StreamViewLike$$anon$7 extends scala/collection/immutable/StreamViewLike$AbstractTransformed  implements scala/collection/immutable/StreamViewLike$DroppedWhile  {

  OUTERCLASS scala/collection/immutable/StreamViewLike newDroppedWhile (Lscala/Function1;)Lscala/collection/immutable/StreamViewLike$Transformed;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/immutable/StreamViewLike;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$7.$outer : Lscala/collection/immutable/StreamViewLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$7.pred : Lscala/Function1;
    ALOAD 0
    ALOAD 1
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/immutable/StreamViewLike$$anon$7.apply (I)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public pred()Lscala/Function1;
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$7.pred : Lscala/Function1;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic scala$collection$IterableViewLike$DroppedWhile$$$outer()Lscala/collection/IterableViewLike;
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$7.$outer : Lscala/collection/immutable/StreamViewLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public start()I
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$7.bitmap$0 : Z
    IFEQ L0
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$7.start : I
    GOTO L1
   L0
    ALOAD 0
    INVOKESPECIAL scala/collection/immutable/StreamViewLike$$anon$7.start$lzycompute ()I
   L1
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  private start$lzycompute()I
   ...
   L0
    ...
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$7.start : I
    ALOAD 0
    ICONST_1
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$7.bitmap$0 : Z
   L3
