...
// declaration: scala/collection/immutable/NumericRange$Inclusive<T> extends scala.collection.immutable.NumericRange<T>
public class scala/collection/immutable/NumericRange$Inclusive extends scala/collection/immutable/NumericRange  {
  ...
  public <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Lscala/math/Integral;)V
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/immutable/NumericRange$Inclusive.num : Lscala/math/Integral;
    ALOAD 0
    ALOAD 1
    ALOAD 2
    ALOAD 3
  ...
  // access flags 0x1
  // signature (TT;TT;TT;)Lscala/collection/immutable/NumericRange$Inclusive<TT;>;
  // declaration: scala.collection.immutable.NumericRange$Inclusive<T> copy(T, T, T)
  public copy(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/immutable/NumericRange$Inclusive;
    GETSTATIC scala/collection/immutable/NumericRange$.MODULE$ : Lscala/collection/immutable/NumericRange$;
    ALOAD 1
    ALOAD 2
    ALOAD 3
    ALOAD 0
    GETFIELD scala/collection/immutable/NumericRange$Inclusive.num : Lscala/math/Integral;
  ...
  public synthetic bridge copy(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/immutable/NumericRange;
    ...
    ALOAD 2
    ALOAD 3
    INVOKEVIRTUAL scala/collection/immutable/NumericRange$Inclusive.copy (Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/immutable/NumericRange$Inclusive;
    ARETURN
    MAXSTACK = 4
    MAXLOCALS = 4

  // access flags 0x1
  // signature ()Lscala/collection/immutable/NumericRange$Exclusive<TT;>;
  // declaration: scala.collection.immutable.NumericRange$Exclusive<T> exclusive()
  public exclusive()Lscala/collection/immutable/NumericRange$Exclusive;
    GETSTATIC scala/collection/immutable/NumericRange$.MODULE$ : Lscala/collection/immutable/NumericRange$;
    ALOAD 0
