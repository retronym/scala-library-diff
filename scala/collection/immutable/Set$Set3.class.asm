...
// declaration: scala/collection/immutable/Set$Set3<A> extends scala.collection.AbstractSet<A> implements scala.collection.immutable.Set<A>, scala.Serializable
public class scala/collection/immutable/Set$Set3 extends scala/collection/AbstractSet  implements scala/collection/immutable/Set scala/Serializable  {
  ...
  // access flags 0x19
  public final static J serialVersionUID = -3590273538119220064
  ...
  public $minus(Ljava/lang/Object;)Lscala/collection/immutable/Set;
    ALOAD 0
    GETFIELD scala/collection/immutable/Set$Set3.elem1 : Ljava/lang/Object;
    ASTORE 2
    ALOAD 1
    ALOAD 2
    IF_ACMPNE L0
   ...
   L1
    ...
    DUP
    ALOAD 0
    GETFIELD scala/collection/immutable/Set$Set3.elem2 : Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/immutable/Set$Set3.elem3 : Ljava/lang/Object;
    INVOKESPECIAL scala/collection/immutable/Set$Set2.<init> (Ljava/lang/Object;Ljava/lang/Object;)V
    GOTO L6
   L5
    ALOAD 0
    GETFIELD scala/collection/immutable/Set$Set3.elem2 : Ljava/lang/Object;
  ...
  public synthetic bridge $minus(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.$minus (Ljava/lang/Object;)Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public $plus(Ljava/lang/Object;)Lscala/collection/immutable/Set;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.contains (Ljava/lang/Object;)Z
    IFEQ L0
    ALOAD 0
    GOTO L1
   L0
    NEW scala/collection/immutable/Set$Set4
    DUP
    ALOAD 0
    GETFIELD scala/collection/immutable/Set$Set3.elem1 : Ljava/lang/Object;
    ALOAD 0
    ...
    GETFIELD scala/collection/immutable/Set$Set3.elem3 : Ljava/lang/Object;
    ALOAD 1
    INVOKESPECIAL scala/collection/immutable/Set$Set4.<init> (Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
   L1
    ARETURN
    MAXSTACK = 6
    MAXLOCALS = 2
  ...
  public synthetic bridge $plus(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.$plus (Ljava/lang/Object;)Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (TA;TA;TA;)V
  // declaration: void <init>(A, A, A)
  public <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/Set$Set3.elem1 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/Set$Set3.elem2 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/immutable/Set$Set3.elem3 : Ljava/lang/Object;
    ALOAD 0
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.apply (Ljava/lang/Object;)Z
  ...
  public synthetic bridge diff(Lscala/collection/GenSet;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.diff (Lscala/collection/GenSet;)Lscala/collection/Set;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge empty()Lscala/collection/Set;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.empty ()Lscala/collection/GenSet;
  ...
  public synthetic bridge groupBy(Lscala/Function1;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.groupBy (Lscala/Function1;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge repr()Lscala/collection/generic/Subtractable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.repr ()Ljava/lang/Object;
  ...
  public synthetic bridge seq()Lscala/collection/TraversableOnce;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.seq ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge thisCollection()Lscala/collection/Traversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.thisCollection ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toCollection(Ljava/lang/Object;)Lscala/collection/Traversable;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.toCollection (Ljava/lang/Object;)Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge toIterable()Lscala/collection/GenIterable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.toIterable ()Lscala/collection/Iterable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSeq()Lscala/collection/GenSeq;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.toSeq ()Lscala/collection/Seq;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toSet()Lscala/collection/GenSet;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.toSet ()Lscala/collection/immutable/Set;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge toTraversable()Lscala/collection/GenTraversable;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.toTraversable ()Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge union(Lscala/collection/GenSet;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.union (Lscala/collection/GenSet;)Lscala/collection/Set;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge view(II)Lscala/collection/TraversableView;
    ...
    ILOAD 1
    ILOAD 2
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.view (II)Lscala/collection/IterableView;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge view()Lscala/collection/TraversableView;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/immutable/Set$Set3.view ()Lscala/collection/IterableView;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
