...
// declaration: scala/collection/immutable/Stream$$anonfun$scala$collection$immutable$Stream$$loop$5$1 extends scala.runtime.AbstractFunction0<B> implements scala.Serializable
public final class scala/collection/immutable/Stream$$anonfun$scala$collection$immutable$Stream$$loop$5$1 extends scala/runtime/AbstractFunction0  implements scala/Serializable  {
  ...
  public <init>(Lscala/collection/immutable/Stream;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/Stream$$anonfun$scala$collection$immutable$Stream$$loop$5$1.elem$1 : Ljava/lang/Object;
    ALOAD 0
