...
// access flags 0x31
// signature Lscala/runtime/AbstractFunction2<TS;TS;TS;>;Lscala/Serializable;
// declaration: scala/collection/immutable/IntMap$$anonfun$unionWith$1 extends scala.runtime.AbstractFunction2<S, S, S> implements scala.Serializable
public final class scala/collection/immutable/IntMap$$anonfun$unionWith$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {
  ...
  // access flags 0x12
  private final Lscala/collection/immutable/IntMap$Tip; x6$1
  ...
  public <init>(Lscala/collection/immutable/IntMap;Lscala/Function3;Lscala/collection/immutable/IntMap$Tip;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/IntMap$$anonfun$unionWith$1.f$1 : Lscala/Function3;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/immutable/IntMap$$anonfun$unionWith$1.x6$1 : Lscala/collection/immutable/IntMap$Tip;
    ALOAD 0
  ...
  // access flags 0x11
  // signature (TS;TS;)TS;
  // declaration: S apply(S, S)
  public final apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/immutable/IntMap$$anonfun$unionWith$1.f$1 : Lscala/Function3;
    ALOAD 0
    GETFIELD scala/collection/immutable/IntMap$$anonfun$unionWith$1.x6$1 : Lscala/collection/immutable/IntMap$Tip;
