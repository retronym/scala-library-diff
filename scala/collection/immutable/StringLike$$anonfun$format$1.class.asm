...
// declaration: scala/collection/immutable/StringLike$$anonfun$format$1 extends scala.runtime.AbstractFunction1<java.lang.Object, java.lang.Object> implements scala.Serializable
public final class scala/collection/immutable/StringLike$$anonfun$format$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/immutable/StringLike format (Lscala/collection/Seq;)Ljava/lang/String;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/immutable/StringLike;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/StringLike$$anonfun$format$1.$outer : Lscala/collection/immutable/StringLike;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/immutable/StringLike$$anonfun$format$1.$outer : Lscala/collection/immutable/StringLike;
    ALOAD 1
