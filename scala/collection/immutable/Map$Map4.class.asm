...
// declaration: scala/collection/immutable/Map$Map4<A, B> extends scala.collection.immutable.AbstractMap<A, B> implements scala.collection.immutable.Map<A, B>, scala.Serializable
public class scala/collection/immutable/Map$Map4 extends scala/collection/immutable/AbstractMap  implements scala/Serializable  {
  ...
  // signature TA;
  // declaration: A
  private final Ljava/lang/Object; key4
  ...
  // signature TB;
  // declaration: B
  private final Ljava/lang/Object; value4
  ...
  public synthetic bridge $minus(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Map$Map4.$minus (Ljava/lang/Object;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public $plus(Lscala/Tuple2;)Lscala/collection/immutable/Map;
    ...
    INVOKEVIRTUAL scala/collection/immutable/Map$Map4.updated (Ljava/lang/Object;Ljava/lang/Object;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  public synthetic bridge $plus(Lscala/Tuple2;)Lscala/collection/GenMap;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/immutable/Map$Map4.$plus (Lscala/Tuple2;)Lscala/collection/immutable/Map;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature (TA;TB;TA;TB;TA;TB;TA;TB;)V
  // declaration: void <init>(A, B, A, B, A, B, A, B)
  public <init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/Map$Map4.key1 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/Map$Map4.value1 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/collection/immutable/Map$Map4.key2 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 4
    PUTFIELD scala/collection/immutable/Map$Map4.value2 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 5
    PUTFIELD scala/collection/immutable/Map$Map4.key3 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 6
    PUTFIELD scala/collection/immutable/Map$Map4.value3 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 7
    PUTFIELD scala/collection/immutable/Map$Map4.key4 : Ljava/lang/Object;
    ALOAD 0
    ALOAD 8
    PUTFIELD scala/collection/immutable/Map$Map4.value4 : Ljava/lang/Object;
    ALOAD 0
