...
// declaration: scala/collection/immutable/RedBlackTree$BlackTree<A, B> extends scala.collection.immutable.RedBlackTree$Tree<A, B>
public final class scala/collection/immutable/RedBlackTree$BlackTree extends scala/collection/immutable/RedBlackTree$Tree  {
