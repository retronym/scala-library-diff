...
// access flags 0x31
// signature Lscala/collection/immutable/StreamViewLike<TA;TColl;TThis;>.AbstractTransformed<TA;>;Lscala/collection/immutable/StreamViewLike<TA;TColl;TThis;>.Filtered;
// declaration: scala/collection/immutable/StreamViewLike$$anon$5 extends scala.collection.immutable.StreamViewLike<A, Coll, This>.AbstractTransformed<A> implements scala.collection.immutable.StreamViewLike<A, Coll, This>.Filtered
public final class scala/collection/immutable/StreamViewLike$$anon$5 extends scala/collection/immutable/StreamViewLike$AbstractTransformed  implements scala/collection/immutable/StreamViewLike$Filtered  {

  OUTERCLASS scala/collection/immutable/StreamViewLike newFiltered (Lscala/Function1;)Lscala/collection/immutable/StreamViewLike$Transformed;
  // access flags 0x601
  ...
  public <init>(Lscala/collection/immutable/StreamViewLike;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$5.$outer : Lscala/collection/immutable/StreamViewLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$5.pred : Lscala/Function1;
    ALOAD 0
    ALOAD 1
  ...
  public synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/immutable/StreamViewLike$$anon$5.apply (I)Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public index()[I
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$5.bitmap$0 : Z
    IFEQ L0
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$5.index : [I
    GOTO L1
   L0
    ALOAD 0
    INVOKESPECIAL scala/collection/immutable/StreamViewLike$$anon$5.index$lzycompute ()[I
   L1
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  private index$lzycompute()[I
   ...
   L0
    ...
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$5.index : [I
    ALOAD 0
    ICONST_1
    PUTFIELD scala/collection/immutable/StreamViewLike$$anon$5.bitmap$0 : Z
   L3
  ...
  public pred()Lscala/Function1;
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$5.pred : Lscala/Function1;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic scala$collection$IterableViewLike$Filtered$$$outer()Lscala/collection/IterableViewLike;
    ALOAD 0
    GETFIELD scala/collection/immutable/StreamViewLike$$anon$5.$outer : Lscala/collection/immutable/StreamViewLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
