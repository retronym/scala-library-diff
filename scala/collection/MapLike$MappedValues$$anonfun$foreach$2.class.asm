...
// declaration: scala/collection/MapLike$MappedValues$$anonfun$foreach$2 extends scala.runtime.AbstractFunction1<scala.Tuple2<A, B>, java.lang.Object> implements scala.Serializable
public final class scala/collection/MapLike$MappedValues$$anonfun$foreach$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/MapLike$MappedValues$$anonfun$foreach$2.apply (Lscala/Tuple2;)Z
