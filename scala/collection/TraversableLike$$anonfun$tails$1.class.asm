...
// declaration: scala/collection/TraversableLike$$anonfun$tails$1 extends scala.runtime.AbstractFunction1<scala.collection.Traversable<A>, scala.collection.Traversable<A>> implements scala.Serializable
public final class scala/collection/TraversableLike$$anonfun$tails$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/TraversableLike tails ()Lscala/collection/Iterator;
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    ALOAD 1
    CHECKCAST scala/collection/Traversable
    INVOKEVIRTUAL scala/collection/TraversableLike$$anonfun$tails$1.apply (Lscala/collection/Traversable;)Lscala/collection/Traversable;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
