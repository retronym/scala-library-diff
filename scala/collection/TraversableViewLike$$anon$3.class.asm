...
// access flags 0x31
// signature Lscala/collection/TraversableViewLike<TA;TColl;TThis;>.AbstractTransformed<TB;>;Lscala/collection/TraversableViewLike<TA;TColl;TThis;>.Mapped<TB;>;
// declaration: scala/collection/TraversableViewLike$$anon$3 extends scala.collection.TraversableViewLike<A, Coll, This>.AbstractTransformed<B> implements scala.collection.TraversableViewLike<A, Coll, This>.Mapped<B>
public final class scala/collection/TraversableViewLike$$anon$3 extends scala/collection/TraversableViewLike$AbstractTransformed  implements scala/collection/TraversableViewLike$Mapped  {

  OUTERCLASS scala/collection/TraversableViewLike newMapped (Lscala/Function1;)Lscala/collection/TraversableViewLike$Transformed;
  // access flags 0x601
  ...
  public <init>(Lscala/collection/TraversableViewLike;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/TraversableViewLike$$anon$3.$outer : Lscala/collection/TraversableViewLike;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableViewLike$$anon$3.mapping : Lscala/Function1;
    ALOAD 0
    ALOAD 1
  ...
  public mapping()Lscala/Function1;
    ALOAD 0
    GETFIELD scala/collection/TraversableViewLike$$anon$3.mapping : Lscala/Function1;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic scala$collection$TraversableViewLike$Mapped$$$outer()Lscala/collection/TraversableViewLike;
    ALOAD 0
    GETFIELD scala/collection/TraversableViewLike$$anon$3.$outer : Lscala/collection/TraversableViewLike;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
