...
// access flags 0x21
// signature <A:Ljava/lang/Object;>Ljava/lang/Object;Lscala/collection/mutable/Builder<TA;Lscala/runtime/Nothing$;>;
// declaration: scala/collection/TraversableView$NoBuilder<A> implements scala.collection.mutable.Builder<A, scala.runtime.Nothing$>
public class scala/collection/TraversableView$NoBuilder implements scala/collection/mutable/Builder  {
  ...
  // access flags 0x1
  // signature (TA;)Lscala/collection/TraversableView$NoBuilder<TA;>;
  // declaration: scala.collection.TraversableView$NoBuilder<A> $plus$eq(A)
  public $plus$eq(Ljava/lang/Object;)Lscala/collection/TraversableView$NoBuilder;
    ALOAD 0
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 2
  ...
  public synthetic bridge $plus$eq(Ljava/lang/Object;)Lscala/collection/generic/Growable;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/TraversableView$NoBuilder.$plus$eq (Ljava/lang/Object;)Lscala/collection/TraversableView$NoBuilder;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <NewTo:Ljava/lang/Object;>(Lscala/Function1<Lscala/runtime/Nothing$;TNewTo;>;)Lscala/collection/mutable/Builder<TA;TNewTo;>;
  // declaration: scala.collection.mutable.Builder<A, NewTo> mapResult<NewTo>(scala.Function1<scala.runtime.Nothing$, NewTo>)
  ...
  // access flags 0x1
  public result()Lscala/runtime/Nothing$;
    NEW java/lang/UnsupportedOperationException
    DUP
    LDC "TraversableView.Builder.result"
  ...
  public synthetic bridge result()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/TraversableView$NoBuilder.result ()Lscala/runtime/Nothing$;
    ATHROW
    MAXSTACK = 1
    MAXLOCALS = 1
