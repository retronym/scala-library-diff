...
// declaration: scala/collection/TraversableOnce$$anonfun$sum$1 extends scala.runtime.AbstractFunction2<B, B, B> implements scala.Serializable
public final class scala/collection/TraversableOnce$$anonfun$sum$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {

  OUTERCLASS scala/collection/TraversableOnce sum (Lscala/math/Numeric;)Ljava/lang/Object;
  // access flags 0x11
  public final INNERCLASS scala/collection/TraversableOnce$$anonfun$sum$1 null null

  // access flags 0x12
  private final Lscala/math/Numeric; num$1
  ...
  public <init>(Lscala/collection/TraversableOnce;Lscala/math/Numeric;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableOnce$$anonfun$sum$1.num$1 : Lscala/math/Numeric;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/TraversableOnce$$anonfun$sum$1.num$1 : Lscala/math/Numeric;
    ALOAD 1
    ALOAD 2
