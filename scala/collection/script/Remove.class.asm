...
// declaration: scala/collection/script/Remove<A> implements scala.collection.script.Message<A>, scala.Product, scala.Serializable
public class scala/collection/script/Remove implements scala/collection/script/Message scala/Product scala/Serializable  {
  ...
  public <init>(Lscala/collection/script/Location;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/script/Remove.location : Lscala/collection/script/Location;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/script/Remove.elem : Ljava/lang/Object;
    ALOAD 0
  ...
  public static apply(Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Remove;
    GETSTATIC scala/collection/script/Remove$.MODULE$ : Lscala/collection/script/Remove$;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/script/Remove$.apply (Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Remove;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <A:Ljava/lang/Object;>(Lscala/collection/script/Location;TA;)Lscala/collection/script/Remove<TA;>;
  // declaration: scala.collection.script.Remove<A> copy<A>(scala.collection.script.Location, A)
  public copy(Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Remove;
  ...
  public elem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/script/Remove.elem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public equals(Ljava/lang/Object;)Z
   ...
   L8
    ...
    ALOAD 6
    ALOAD 0
    INVOKEVIRTUAL scala/collection/script/Remove.canEqual (Ljava/lang/Object;)Z
    IFEQ L6
    ICONST_1
    GOTO L12
   L6
  ...
  public location()Lscala/collection/script/Location;
    ALOAD 0
    GETFIELD scala/collection/script/Remove.location : Lscala/collection/script/Location;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public static unapply(Lscala/collection/script/Remove;)Lscala/Option;
    GETSTATIC scala/collection/script/Remove$.MODULE$ : Lscala/collection/script/Remove$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/script/Remove$.unapply (Lscala/collection/script/Remove;)Lscala/Option;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 1
}
