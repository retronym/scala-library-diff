...
// declaration: scala/collection/script/Update<A> implements scala.collection.script.Message<A>, scala.Product, scala.Serializable
public class scala/collection/script/Update implements scala/collection/script/Message scala/Product scala/Serializable  {
  ...
  public <init>(Lscala/collection/script/Location;Ljava/lang/Object;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/collection/script/Update.location : Lscala/collection/script/Location;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/script/Update.elem : Ljava/lang/Object;
    ALOAD 0
  ...
  public static apply(Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Update;
    GETSTATIC scala/collection/script/Update$.MODULE$ : Lscala/collection/script/Update$;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/collection/script/Update$.apply (Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Update;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  // access flags 0x1
  // signature <A:Ljava/lang/Object;>(Lscala/collection/script/Location;TA;)Lscala/collection/script/Update<TA;>;
  // declaration: scala.collection.script.Update<A> copy<A>(scala.collection.script.Location, A)
  public copy(Lscala/collection/script/Location;Ljava/lang/Object;)Lscala/collection/script/Update;
  ...
  public elem()Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/script/Update.elem : Ljava/lang/Object;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public equals(Ljava/lang/Object;)Z
   ...
   L8
    ...
    ALOAD 6
    ALOAD 0
    INVOKEVIRTUAL scala/collection/script/Update.canEqual (Ljava/lang/Object;)Z
    IFEQ L6
    ICONST_1
    GOTO L12
   L6
  ...
  public location()Lscala/collection/script/Location;
    ALOAD 0
    GETFIELD scala/collection/script/Update.location : Lscala/collection/script/Location;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public static unapply(Lscala/collection/script/Update;)Lscala/Option;
    GETSTATIC scala/collection/script/Update$.MODULE$ : Lscala/collection/script/Update$;
    ALOAD 0
    INVOKEVIRTUAL scala/collection/script/Update$.unapply (Lscala/collection/script/Update;)Lscala/Option;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 1
}
