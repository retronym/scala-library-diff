...
public final class scala/collection/script/NoLo$ extends scala/collection/script/Location  implements scala/Product scala/Serializable  {
  ...
  // access flags 0x19
  public final static Lscala/collection/script/NoLo$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/collection/script/NoLo$
    INVOKESPECIAL scala/collection/script/NoLo$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/collection/script/NoLo$.MODULE$ : Lscala/collection/script/NoLo$;
    ALOAD 0
  ...
  public canEqual(Ljava/lang/Object;)Z
    ALOAD 1
    INSTANCEOF scala/collection/script/NoLo$
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 2
