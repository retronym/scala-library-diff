...
// declaration: scala/collection/generic/IsTraversableOnce$$anon$1$$anonfun$1 extends scala.runtime.AbstractFunction1<java.lang.String, java.lang.String> implements scala.Serializable
public final class scala/collection/generic/IsTraversableOnce$$anon$1$$anonfun$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/collection/generic/IsTraversableOnce$$anon$1 <init> ()V
  // access flags 0x19
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/collection/generic/IsTraversableOnce$$anon$1$$anonfun$1.apply (Ljava/lang/String;)Ljava/lang/String;
