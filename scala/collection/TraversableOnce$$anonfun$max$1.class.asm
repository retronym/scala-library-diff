...
// declaration: scala/collection/TraversableOnce$$anonfun$max$1 extends scala.runtime.AbstractFunction2<A, A, A> implements scala.Serializable
public final class scala/collection/TraversableOnce$$anonfun$max$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {

  OUTERCLASS scala/collection/TraversableOnce max (Lscala/math/Ordering;)Ljava/lang/Object;
  // access flags 0x11
  ...
  public <init>(Lscala/collection/TraversableOnce;Lscala/math/Ordering;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/collection/TraversableOnce$$anonfun$max$1.cmp$2 : Lscala/math/Ordering;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    GETFIELD scala/collection/TraversableOnce$$anonfun$max$1.cmp$2 : Lscala/math/Ordering;
    ALOAD 1
    ALOAD 2
