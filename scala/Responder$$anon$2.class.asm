...
// declaration: scala/Responder$$anon$2 extends scala.Responder<B>
public final class scala/Responder$$anon$2 extends scala/Responder  {

  OUTERCLASS scala/Responder flatMap (Lscala/Function1;)Lscala/Responder;
  // access flags 0x11
  ...
  public <init>(Lscala/Responder;Lscala/Function1;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/Responder$$anon$2.$outer : Lscala/Responder;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/Responder$$anon$2.f$1 : Lscala/Function1;
    ALOAD 0
  ...
  public respond(Lscala/Function1;)V
    ALOAD 0
    GETFIELD scala/Responder$$anon$2.$outer : Lscala/Responder;
    NEW scala/Responder$$anon$2$$anonfun$respond$2
    DUP
    ALOAD 0
    ALOAD 1
    INVOKESPECIAL scala/Responder$$anon$2$$anonfun$respond$2.<init> (Lscala/Responder$$anon$2;Lscala/Function1;)V
