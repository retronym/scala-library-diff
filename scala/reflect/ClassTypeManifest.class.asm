...
// declaration: scala/reflect/ClassTypeManifest<T> implements scala.reflect.ClassTag<T>
public class scala/reflect/ClassTypeManifest implements scala/reflect/ClassTag  {


  // access flags 0x12
  // signature Lscala/Option<Lscala/reflect/OptManifest<*>;>;
  // declaration: scala.Option<scala.reflect.OptManifest<?>>
  ...
  // access flags 0x1
  // signature (Lscala/Option<Lscala/reflect/OptManifest<*>;>;Ljava/lang/Class<*>;Lscala/collection/immutable/List<Lscala/reflect/OptManifest<*>;>;)V
  // declaration: void <init>(scala.Option<scala.reflect.OptManifest<?>>, java.lang.Class<?>, scala.collection.immutable.List<scala.reflect.OptManifest<?>>)
  public <init>(Lscala/Option;Ljava/lang/Class;Lscala/collection/immutable/List;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/reflect/ClassTypeManifest.prefix : Lscala/Option;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/reflect/ClassTypeManifest.runtimeClass : Ljava/lang/Class;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/reflect/ClassTypeManifest.typeArguments : Lscala/collection/immutable/List;
    ALOAD 0
  ...
  public runtimeClass()Ljava/lang/Class;
    ALOAD 0
    GETFIELD scala/reflect/ClassTypeManifest.runtimeClass : Ljava/lang/Class;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public toString()Ljava/lang/String;
    ...
    ALOAD 0
    GETFIELD scala/reflect/ClassTypeManifest.prefix : Lscala/Option;
   ...
   L1
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    ALOAD 0
    INVOKEVIRTUAL scala/reflect/ClassTypeManifest.runtimeClass ()Ljava/lang/Class;
   ...
   L3
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    ALOAD 0
    INVOKEVIRTUAL scala/reflect/ClassTypeManifest.argString ()Ljava/lang/String;
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.toString ()Ljava/lang/String;
    ARETURN
    MAXSTACK = 3
  ...
  public typeArguments()Lscala/collection/immutable/List;
    ALOAD 0
    GETFIELD scala/reflect/ClassTypeManifest.typeArguments : Lscala/collection/immutable/List;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
