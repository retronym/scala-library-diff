...
public final class scala/reflect/ClassManifestDeprecatedApis$$anonfun$subargs$1 extends scala/runtime/AbstractFunction2  implements scala/Serializable  {
  ...
  OUTERCLASS scala/reflect/ClassManifestDeprecatedApis$class subargs (Lscala/reflect/ClassTag;Lscala/collection/immutable/List;Lscala/collection/immutable/List;)Z
  // access flags 0x11
