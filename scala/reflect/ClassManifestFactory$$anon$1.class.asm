...
// declaration: scala/reflect/ClassManifestFactory$$anon$1 implements scala.reflect.ClassTag<T>
public final class scala/reflect/ClassManifestFactory$$anon$1 implements scala/reflect/ClassTag  {
  ...
  // access flags 0x12
  private final Lscala/reflect/OptManifest; prefix$1
  ...
  // access flags 0x1
  public <init>(Lscala/reflect/OptManifest;Ljava/lang/String;Ljava/lang/Class;Lscala/collection/Seq;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/reflect/ClassManifestFactory$$anon$1.prefix$1 : Lscala/reflect/OptManifest;
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/reflect/ClassManifestFactory$$anon$1.name$1 : Ljava/lang/String;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/reflect/ClassManifestFactory$$anon$1.clazz$1 : Ljava/lang/Class;
    ALOAD 0
    ...
    PUTFIELD scala/reflect/ClassManifestFactory$$anon$1.typeArguments : Lscala/collection/immutable/List;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 5
  ...
  public runtimeClass()Ljava/lang/Class;
    ALOAD 0
    GETFIELD scala/reflect/ClassManifestFactory$$anon$1.clazz$1 : Ljava/lang/Class;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public toString()Ljava/lang/String;
    ...
    ALOAD 0
    GETFIELD scala/reflect/ClassManifestFactory$$anon$1.prefix$1 : Lscala/reflect/OptManifest;
    INVOKEVIRTUAL java/lang/Object.toString ()Ljava/lang/String;
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    LDC "#"
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    ALOAD 0
    GETFIELD scala/reflect/ClassManifestFactory$$anon$1.name$1 : Ljava/lang/String;
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
    ALOAD 0
    INVOKEVIRTUAL scala/reflect/ClassManifestFactory$$anon$1.argString ()Ljava/lang/String;
    INVOKEVIRTUAL scala/collection/mutable/StringBuilder.append (Ljava/lang/Object;)Lscala/collection/mutable/StringBuilder;
  ...
  public typeArguments()Lscala/collection/immutable/List;
    ALOAD 0
    GETFIELD scala/reflect/ClassManifestFactory$$anon$1.typeArguments : Lscala/collection/immutable/List;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
