...
// declaration: scala/reflect/ManifestFactory$$anon$2 extends scala.reflect.ManifestFactory$PhantomManifest<java.lang.Object>
public final class scala/reflect/ManifestFactory$$anon$2 extends scala/reflect/ManifestFactory$PhantomManifest  {
  ...
  public synthetic bridge newArray(I)Ljava/lang/Object;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/reflect/ManifestFactory$$anon$2.newArray (I)[Ljava/lang/Object;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
