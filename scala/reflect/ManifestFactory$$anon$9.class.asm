...
// declaration: scala/reflect/ManifestFactory$$anon$9 extends scala.reflect.AnyValManifest<java.lang.Object>
public final class scala/reflect/ManifestFactory$$anon$9 extends scala/reflect/AnyValManifest  {
  ...
  public synthetic bridge newArray(I)Ljava/lang/Object;
    ALOAD 0
    ILOAD 1
    INVOKEVIRTUAL scala/reflect/ManifestFactory$$anon$9.newArray (I)[I
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  // declaration: java.lang.Class<java.lang.Integer> runtimeClass()
