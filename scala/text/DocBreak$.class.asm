...
public final class scala/text/DocBreak$ extends scala/text/Document  implements scala/Product scala/Serializable  {
  ...
  // access flags 0x19
  public final static Lscala/text/DocBreak$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/text/DocBreak$
    INVOKESPECIAL scala/text/DocBreak$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  private <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/text/DocBreak$.MODULE$ : Lscala/text/DocBreak$;
    ALOAD 0
  ...
  public canEqual(Ljava/lang/Object;)Z
    ALOAD 1
    INSTANCEOF scala/text/DocBreak$
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 2
