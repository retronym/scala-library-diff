...
// declaration: scala/Tuple2$mcCD$sp extends scala.Tuple2<java.lang.Object, java.lang.Object>
public class scala/Tuple2$mcCD$sp extends scala/Tuple2  {
  ...
  public <init>(CD)V
    ALOAD 0
    ILOAD 1
    PUTFIELD scala/Tuple2$mcCD$sp._1$mcC$sp : C
    ALOAD 0
    DLOAD 2
    PUTFIELD scala/Tuple2$mcCD$sp._2$mcD$sp : D
    ALOAD 0
    ACONST_NULL
    ACONST_NULL
  ...
  public _1()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp._1$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge _1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp._1 ()C
  ...
  public _1$mcC$sp()C
    ALOAD 0
    GETFIELD scala/Tuple2$mcCD$sp._1$mcC$sp : C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public _2()D
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp._2$mcD$sp ()D
    DRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  public synthetic bridge _2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp._2 ()D
  ...
  public _2$mcD$sp()D
    ALOAD 0
    GETFIELD scala/Tuple2$mcCD$sp._2$mcD$sp : D
    DRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  public copy$default$1()C
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp.copy$default$1$mcC$sp ()C
    IRETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$1()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp.copy$default$1 ()C
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToCharacter (C)Ljava/lang/Character;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public copy$default$2()D
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp.copy$default$2$mcD$sp ()D
    DRETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  public synthetic bridge copy$default$2()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp.copy$default$2 ()D
    INVOKESTATIC scala/runtime/BoxesRunTime.boxToDouble (D)Ljava/lang/Double;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 1
  ...
  public swap()Lscala/Tuple2;
    ALOAD 0
    INVOKEVIRTUAL scala/Tuple2$mcCD$sp.swap$mcCD$sp ()Lscala/Tuple2;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
