...
// declaration: scala/Enumeration$ValueSet$$anonfun$iterator$1 extends scala.runtime.AbstractFunction1<java.lang.Object, scala.Enumeration$Value> implements scala.Serializable
public final class scala/Enumeration$ValueSet$$anonfun$iterator$1 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {

  OUTERCLASS scala/Enumeration$ValueSet iterator ()Lscala/collection/Iterator;
  // access flags 0x401
  ...
  public <init>(Lscala/Enumeration$ValueSet;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/Enumeration$ValueSet$$anonfun$iterator$1.$outer : Lscala/Enumeration$ValueSet;
    ALOAD 0
  ...
  public final apply(I)Lscala/Enumeration$Value;
    ALOAD 0
    GETFIELD scala/Enumeration$ValueSet$$anonfun$iterator$1.$outer : Lscala/Enumeration$ValueSet;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/Enumeration$ValueSet$$anonfun$iterator$1.apply (I)Lscala/Enumeration$Value;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
