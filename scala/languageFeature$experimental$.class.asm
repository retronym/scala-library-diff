...
// access flags 0x21
public class scala/languageFeature$experimental$ {
  ...
  // access flags 0x19
  public final static Lscala/languageFeature$experimental$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/languageFeature$experimental$
    INVOKESPECIAL scala/languageFeature$experimental$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/languageFeature$experimental$.MODULE$ : Lscala/languageFeature$experimental$;
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
