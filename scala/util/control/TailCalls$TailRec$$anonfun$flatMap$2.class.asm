...
// access flags 0x31
// signature Lscala/runtime/AbstractFunction1<Ljava/lang/Object;Lscala/util/control/TailCalls$TailRec<TB;>;>;Lscala/Serializable;
// declaration: scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2 extends scala.runtime.AbstractFunction1<java.lang.Object, scala.util.control.TailCalls$TailRec<B>> implements scala.Serializable
public final class scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  // access flags 0x12
  private final Lscala/util/control/TailCalls$Cont; x5$1

  // access flags 0x1
  // signature (Lscala/util/control/TailCalls$TailRec<TA;>;)V
  // declaration: void <init>(scala.util.control.TailCalls$TailRec<A>)
  public <init>(Lscala/util/control/TailCalls$TailRec;Lscala/Function1;Lscala/util/control/TailCalls$Cont;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2.f$2 : Lscala/Function1;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2.x5$1 : Lscala/util/control/TailCalls$Cont;
    ALOAD 0
  ...
  // access flags 0x11
  // signature (Ljava/lang/Object;)Lscala/util/control/TailCalls$TailRec<TB;>;
  // declaration: scala.util.control.TailCalls$TailRec<B> apply(java.lang.Object)
  public final apply(Ljava/lang/Object;)Lscala/util/control/TailCalls$TailRec;
    ALOAD 0
    GETFIELD scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2.x5$1 : Lscala/util/control/TailCalls$Cont;
    ...
    ALOAD 0
    GETFIELD scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2.f$2 : Lscala/Function1;
    ASTORE 4
    ASTORE 7
    ALOAD 7
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/util/control/TailCalls$TailRec$$anonfun$flatMap$2.apply (Ljava/lang/Object;)Lscala/util/control/TailCalls$TailRec;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
