...
// declaration: scala/util/control/TailCalls$TailRec$$anonfun$resume$2 extends scala.runtime.AbstractFunction1<java.lang.Object, scala.util.control.TailCalls$TailRec<A>> implements scala.Serializable
public final class scala/util/control/TailCalls$TailRec$$anonfun$resume$2 extends scala/runtime/AbstractFunction1  implements scala/Serializable  {
  ...
  public <init>(Lscala/util/control/TailCalls$TailRec;Lscala/util/control/TailCalls$Cont;Lscala/util/control/TailCalls$Cont;)V
    ALOAD 0
    ALOAD 2
    PUTFIELD scala/util/control/TailCalls$TailRec$$anonfun$resume$2.x4$1 : Lscala/util/control/TailCalls$Cont;
    ALOAD 0
    ALOAD 3
    PUTFIELD scala/util/control/TailCalls$TailRec$$anonfun$resume$2.x4$2 : Lscala/util/control/TailCalls$Cont;
    ALOAD 0
  ...
  public final apply(Ljava/lang/Object;)Lscala/util/control/TailCalls$TailRec;
    ALOAD 0
    GETFIELD scala/util/control/TailCalls$TailRec$$anonfun$resume$2.x4$1 : Lscala/util/control/TailCalls$Cont;
    ...
    ALOAD 0
    GETFIELD scala/util/control/TailCalls$TailRec$$anonfun$resume$2.x4$2 : Lscala/util/control/TailCalls$Cont;
    INVOKEVIRTUAL scala/util/control/TailCalls$Cont.f ()Lscala/Function1;
    ASTORE 4
    ASTORE 7
    ALOAD 7
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ALOAD 0
    ALOAD 1
    INVOKEVIRTUAL scala/util/control/TailCalls$TailRec$$anonfun$resume$2.apply (Ljava/lang/Object;)Lscala/util/control/TailCalls$TailRec;
    ARETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
