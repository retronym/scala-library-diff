...
// declaration: scala/util/hashing/MurmurHash3$$anon$2 implements scala.util.hashing.Hashing<scala.collection.TraversableOnce<java.lang.Object>>
public final class scala/util/hashing/MurmurHash3$$anon$2 implements scala/util/hashing/Hashing  {

  OUTERCLASS scala/util/hashing/MurmurHash3$ orderedHashing ()Lscala/util/hashing/Hashing;
  // access flags 0x19
  ...
  public hash(Lscala/collection/TraversableOnce;)I
    ...
    ALOAD 1
    INVOKEVIRTUAL scala/util/hashing/MurmurHash3$.orderedHash (Lscala/collection/TraversableOnce;)I
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public synthetic bridge hash(Ljava/lang/Object;)I
    ...
    INVOKEVIRTUAL scala/util/hashing/MurmurHash3$$anon$2.hash (Lscala/collection/TraversableOnce;)I
    IRETURN
    MAXSTACK = 2
    MAXLOCALS = 2
}
