...
// access flags 0x31
public final class scala/util/matching/Regex$Match$$anonfun$starts$1 extends scala/runtime/AbstractFunction1$mcII$sp  implements scala/Serializable  {

  OUTERCLASS scala/util/matching/Regex$Match starts ()[I
  // access flags 0x9
  ...
  public <init>(Lscala/util/matching/Regex$Match;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/util/matching/Regex$Match$$anonfun$starts$1.$outer : Lscala/util/matching/Regex$Match;
    ALOAD 0
  ...
  public final apply(I)I
    ALOAD 0
    GETFIELD scala/util/matching/Regex$Match$$anonfun$starts$1.$outer : Lscala/util/matching/Regex$Match;
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/util/matching/Regex$Match$$anonfun$starts$1.apply (I)I
