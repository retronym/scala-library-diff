...
// access flags 0x31
public final class scala/util/MurmurHash$$anonfun$2 extends scala/runtime/AbstractFunction1$mcII$sp  implements scala/Serializable  {

  OUTERCLASS scala/util/MurmurHash$ null
  // access flags 0x11
  ...
  public final synthetic bridge apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    INVOKEVIRTUAL scala/util/MurmurHash$$anonfun$2.apply (I)I
