...
// access flags 0x21
public class scala/math/Ordering$Byte$ implements scala/math/Ordering$ByteOrdering  {
  ...
  public static <clinit>()V
    NEW scala/math/Ordering$Byte$
    INVOKESPECIAL scala/math/Ordering$Byte$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/math/Ordering$Byte$.MODULE$ : Lscala/math/Ordering$Byte$;
    ALOAD 0
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    INVOKESTATIC scala/runtime/BoxesRunTime.unboxToByte (Ljava/lang/Object;)B
    INVOKEVIRTUAL scala/math/Ordering$Byte$.compare (BB)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/math/Ordering$Byte$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/math/Ordering$Byte$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
