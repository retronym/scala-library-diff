...
public final class scala/math/BigDecimal$$anonfun$isValidByte$1 extends scala/runtime/AbstractFunction0$mcV$sp  implements scala/Serializable  {
  ...
  OUTERCLASS scala/math/BigDecimal isValidByte ()Z
  // access flags 0x11
  ...
  public <init>(Lscala/math/BigDecimal;)V
   ...
   L0
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/math/BigDecimal$$anonfun$isValidByte$1.$outer : Lscala/math/BigDecimal;
    ALOAD 0
  ...
  public final apply()V
    ALOAD 0
    GETFIELD scala/math/BigDecimal$$anonfun$isValidByte$1.$outer : Lscala/math/BigDecimal;
    INVOKEVIRTUAL scala/math/BigDecimal.toByteExact ()B
    POP
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public final synthetic bridge apply()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/math/BigDecimal$$anonfun$isValidByte$1.apply ()V
