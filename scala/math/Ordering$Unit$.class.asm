...
// access flags 0x21
public class scala/math/Ordering$Unit$ implements scala/math/Ordering$UnitOrdering  {
  ...
  public static <clinit>()V
    NEW scala/math/Ordering$Unit$
    INVOKESPECIAL scala/math/Ordering$Unit$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/math/Ordering$Unit$.MODULE$ : Lscala/math/Ordering$Unit$;
    ALOAD 0
    ...
    ALOAD 0
    INVOKESTATIC scala/math/Ordering$UnitOrdering$class.$init$ (Lscala/math/Ordering$UnitOrdering;)V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  public compare(Lscala/runtime/BoxedUnit;Lscala/runtime/BoxedUnit;)I
    ALOAD 0
    ALOAD 1
    ALOAD 2
    INVOKESTATIC scala/math/Ordering$UnitOrdering$class.compare (Lscala/math/Ordering$UnitOrdering;Lscala/runtime/BoxedUnit;Lscala/runtime/BoxedUnit;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    CHECKCAST scala/runtime/BoxedUnit
    INVOKEVIRTUAL scala/math/Ordering$Unit$.compare (Lscala/runtime/BoxedUnit;Lscala/runtime/BoxedUnit;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TU;Lscala/runtime/BoxedUnit;>;)Lscala/math/Ordering<TU;>;
  // declaration: scala.math.Ordering<U> on<U>(scala.Function1<U, scala.runtime.BoxedUnit>)
  ...
  private readResolve()Ljava/lang/Object;
    GETSTATIC scala/math/Ordering$Unit$.MODULE$ : Lscala/math/Ordering$Unit$;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/math/Ordering<Lscala/runtime/BoxedUnit;>;
  // declaration: scala.math.Ordering<scala.runtime.BoxedUnit> reverse()
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/math/Ordering$Unit$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/math/Ordering$Unit$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
