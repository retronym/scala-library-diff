...
// access flags 0x31
// signature Ljava/lang/Object;Lscala/math/Ordering$OptionOrdering<TT;>;
// declaration: scala/math/Ordering$$anon$3 implements scala.math.Ordering$OptionOrdering<T>
public final class scala/math/Ordering$$anon$3 implements scala/math/Ordering$OptionOrdering  {
  ...
  // declaration: scala.math.Ordering<T>
  private final Lscala/math/Ordering; optionOrdering
  ...
  public <init>(Lscala/math/Ordering;)V
    ...
    ALOAD 0
    INVOKESTATIC scala/math/Ordering$OptionOrdering$class.$init$ (Lscala/math/Ordering$OptionOrdering;)V
    ALOAD 0
    ALOAD 1
    PUTFIELD scala/math/Ordering$$anon$3.optionOrdering : Lscala/math/Ordering;
    RETURN
    MAXSTACK = 2
    MAXLOCALS = 2
  ...
  public compare(Lscala/Option;Lscala/Option;)I
    ALOAD 0
    ALOAD 1
    ALOAD 2
    INVOKESTATIC scala/math/Ordering$OptionOrdering$class.compare (Lscala/math/Ordering$OptionOrdering;Lscala/Option;Lscala/Option;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    CHECKCAST scala/Option
    INVOKEVIRTUAL scala/math/Ordering$$anon$3.compare (Lscala/Option;Lscala/Option;)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  // access flags 0x1
  // signature <U:Ljava/lang/Object;>(Lscala/Function1<TU;Lscala/Option<TT;>;>;)Lscala/math/Ordering<TU;>;
  // declaration: scala.math.Ordering<U> on<U>(scala.Function1<U, scala.Option<T>>)
  ...
  public optionOrdering()Lscala/math/Ordering;
    ALOAD 0
    GETFIELD scala/math/Ordering$$anon$3.optionOrdering : Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1

  // access flags 0x1
  // signature ()Lscala/math/Ordering<Lscala/Option<TT;>;>;
  // declaration: scala.math.Ordering<scala.Option<T>> reverse()
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/math/Ordering$$anon$3.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/math/Ordering$$anon$3.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
