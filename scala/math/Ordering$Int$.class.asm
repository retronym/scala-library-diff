...
// access flags 0x21
public class scala/math/Ordering$Int$ implements scala/math/Ordering$IntOrdering  {
  ...
  // access flags 0x19
  public final static Lscala/math/Ordering$Int$; MODULE$

  // access flags 0x9
  public static <clinit>()V
    NEW scala/math/Ordering$Int$
    INVOKESPECIAL scala/math/Ordering$Int$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/math/Ordering$Int$.MODULE$ : Lscala/math/Ordering$Int$;
    ALOAD 0
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    INVOKESTATIC scala/runtime/BoxesRunTime.unboxToInt (Ljava/lang/Object;)I
    INVOKEVIRTUAL scala/math/Ordering$Int$.compare (II)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/math/Ordering$Int$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/math/Ordering$Int$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
