...
public abstract interface scala/math/Ordering implements java/util/Comparator scala/math/PartialOrdering  {
  ...
  public abstract max(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

  // access flags 0x401
  // signature (TT;TT;)TT;
  // declaration: T min(T, T)
  public abstract min(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

  // access flags 0x401
  // signature (TT;)Lscala/math/Ordering<TT;>.Ops;
  // declaration: scala.math.Ordering<T>.Ops mkOrderingOps(T)
  public abstract mkOrderingOps(Ljava/lang/Object;)Lscala/math/Ordering$Ops;
  ...
  public abstract on(Lscala/Function1;)Lscala/math/Ordering;

  // access flags 0x401
  // signature ()Lscala/math/Ordering<TT;>;
  // declaration: scala.math.Ordering<T> reverse()
  public abstract reverse()Lscala/math/Ordering;

  // access flags 0x401
  // signature (TT;TT;)Lscala/Some<Ljava/lang/Object;>;
  // declaration: scala.Some<java.lang.Object> tryCompare(T, T)
  public abstract tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
}
