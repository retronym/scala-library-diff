...
public class scala/math/Ordering$Short$ implements scala/math/Ordering$ShortOrdering  {
  ...
  public static <clinit>()V
    NEW scala/math/Ordering$Short$
    INVOKESPECIAL scala/math/Ordering$Short$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/math/Ordering$Short$.MODULE$ : Lscala/math/Ordering$Short$;
    ALOAD 0
  ...
  public synthetic bridge compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    ALOAD 2
    INVOKESTATIC scala/runtime/BoxesRunTime.unboxToShort (Ljava/lang/Object;)S
    INVOKEVIRTUAL scala/math/Ordering$Short$.compare (SS)I
    IRETURN
    MAXSTACK = 3
    MAXLOCALS = 3
  ...
  public synthetic bridge reverse()Lscala/math/PartialOrdering;
    ALOAD 0
    INVOKEVIRTUAL scala/math/Ordering$Short$.reverse ()Lscala/math/Ordering;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge tryCompare(Ljava/lang/Object;Ljava/lang/Object;)Lscala/Option;
    ...
    ALOAD 1
    ALOAD 2
    INVOKEVIRTUAL scala/math/Ordering$Short$.tryCompare (Ljava/lang/Object;Ljava/lang/Object;)Lscala/Some;
    ARETURN
    MAXSTACK = 3
    MAXLOCALS = 3
}
