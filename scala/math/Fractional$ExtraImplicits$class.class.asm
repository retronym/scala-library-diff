...
// access flags 0x421
public abstract class scala/math/Fractional$ExtraImplicits$class {
  ...
  // access flags 0x9
  public static infixFractionalOps(Lscala/math/Fractional$ExtraImplicits;Ljava/lang/Object;Lscala/math/Fractional;)Lscala/math/Fractional$FractionalOps;
