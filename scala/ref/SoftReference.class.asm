...
// declaration: scala/ref/SoftReference<T> implements scala.ref.ReferenceWrapper<T>
public class scala/ref/SoftReference implements scala/ref/ReferenceWrapper  {


  // access flags 0x12
  // signature Ljava/lang/ref/SoftReference<+TT;>;
  // declaration: java.lang.ref.SoftReference<? extends T>
  private final Ljava/lang/ref/SoftReference; underlying
  ...
  public <init>(Ljava/lang/Object;Lscala/ref/ReferenceQueue;)V
    ...
    ALOAD 0
    NEW scala/ref/SoftReferenceWithWrapper
    DUP
    ALOAD 1
    ALOAD 2
    ALOAD 0
    INVOKESPECIAL scala/ref/SoftReferenceWithWrapper.<init> (Ljava/lang/Object;Lscala/ref/ReferenceQueue;Lscala/ref/SoftReference;)V
    PUTFIELD scala/ref/SoftReference.underlying : Ljava/lang/ref/SoftReference;
    RETURN
    MAXSTACK = 6
    MAXLOCALS = 3
  ...
  public <init>(Ljava/lang/Object;)V
    ...
    ALOAD 1
    ACONST_NULL
    INVOKESPECIAL scala/ref/SoftReference.<init> (Ljava/lang/Object;Lscala/ref/ReferenceQueue;)V
    RETURN
    MAXSTACK = 3
    MAXLOCALS = 2
  ...
  public synthetic bridge self()Ljava/lang/Object;
    ALOAD 0
    INVOKEVIRTUAL scala/ref/SoftReference.self ()Ljava/lang/ref/Reference;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  // access flags 0x1
  // signature ()Ljava/lang/ref/SoftReference<+TT;>;
  // declaration: java.lang.ref.SoftReference<? extends T> underlying()
  public underlying()Ljava/lang/ref/SoftReference;
    ALOAD 0
    GETFIELD scala/ref/SoftReference.underlying : Ljava/lang/ref/SoftReference;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public synthetic bridge underlying()Ljava/lang/ref/Reference;
    ALOAD 0
    INVOKEVIRTUAL scala/ref/SoftReference.underlying ()Ljava/lang/ref/SoftReference;
    ARETURN
    MAXSTACK = 1
    MAXLOCALS = 1
}
