...
public class scala/Predef$StringAdd$ {
  ...
  // access flags 0x19
  public final static Lscala/Predef$StringAdd$; MODULE$
  ...
  public static <clinit>()V
    ...
    INVOKESPECIAL scala/Predef$StringAdd$.<init> ()V
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 0
  ...
  public <init>()V
    ...
    ALOAD 0
    PUTSTATIC scala/Predef$StringAdd$.MODULE$ : Lscala/Predef$StringAdd$;
    RETURN
    MAXSTACK = 1
    MAXLOCALS = 1
  ...
  public final equals$extension(Ljava/lang/Object;Ljava/lang/Object;)Z
    ALOAD 2
    INSTANCEOF scala/Predef$StringAdd
    IFEQ L0
    ICONST_1
    ISTORE 3
    GOTO L1
   ...
   L3
    ALOAD 2
    CHECKCAST scala/Predef$StringAdd
